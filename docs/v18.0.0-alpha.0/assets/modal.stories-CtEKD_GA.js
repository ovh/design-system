import{Y as u,Z as b}from"./index-DB8q6ij-.js";import{x as t}from"./lit-html-D-ZEPr28.js";import{o as m}from"./unsafe-html-HR6uCwaW.js";import{o as P,C as s}from"./control-C1r2wu67.js";const Z=()=>{const o=document.querySelector("#storybook-root");o&&(o.innerHTML="")},B=o=>(Z(),o());var p=Object.freeze,I=Object.defineProperty,e=(o,F)=>p(I(o,"raw",{value:p(F||o.slice())})),g,y,C,S,O,v,x;const J={title:"ODS Components/Modal",component:"ods-modal",decorators:[B]},n={render:o=>t(g||(g=e([`
...
<style>
  ...
  \`
}`,...(z=(j=c.parameters)==null?void 0:j.docs)==null?void 0:z.source}}};const K=["Demo","Overview","Default","CustomCSS","NotDismissible","Color","Actions"],oo=Object.freeze(Object.defineProperty({__proto__:null,Actions:c,Color:i,CustomCSS:d,Default:l,Demo:n,NotDismissible:r,Overview:a,__namedExportsOrder:K,default:J},Symbol.toStringTag,{value:"Module"}));export{c as A,d as C,l as D,oo as M,r as N,a as O,i as a};
