import{x as t}from"./lit-html-D-ZEPr28.js";import{t as I,b as A,u as H}from"./index-DryTTbHl.js";import{o as G,C as n}from"./control-C1r2wu67.js";const Y={title:"ODS Components/Link",component:"ods-link"},o={render:e=>t`
    <ods-link
      class="my-link-demo"
      color="${e.color}"
      download="${e.download}"
  ...
  `,argTypes:G({color:{table:{category:n.design,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"select",options:I},customCssLink:{table:{category:n.design,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text",description:'Set a custom style properties on the link. Example: "color: green; font-size: 32px;"'},customCssIcon:{table:{category:n.design,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text",description:'Set a custom style properties on the icon. Example: "width: 2rem; height: 2rem;"'},download:{table:{category:n.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},href:{table:{category:n.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},icon:{table:{category:n.general,type:{summary:"string"}},control:"select",options:A,description:"See the whole list [here](/?path=/docs/ods-components-icon--documentation#name)"},isDisabled:{table:{category:n.general,defaultValue:{summary:"false"},type:{summary:"boolean"}},control:"boolean"},label:{table:{category:n.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},referrerpolicy:{table:{category:n.accessibility,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},rel:{table:{category:n.accessibility,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},target:{table:{category:n.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"}}),args:{color:H.primary,isDisabled:!1,label:"my label"}},r={tags:["isHidden"],parameters:{layout:"centered"},render:()=>t`
...
<style>
  ...
  `};var m,u,p;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: args => html\`
    <ods-link
      class="my-link-demo"
      color="\${args.color}"
...
}`,...(p=(u=o.parameters)==null?void 0:u.docs)==null?void 0:p.source}}};var y,g,h;r.parameters={...r.parameters,docs:{...(y=r.parameters)==null?void 0:y.docs,source:{originalSource:`{
  tags: ['isHidden'],
  parameters: {
    layout: 'centered'
  },
...
<ods-link href="https://www.ovhcloud.com/" label="Link"></ods-link>
  \`
}`,...(h=(g=r.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};var b,k,f;s.parameters={...s.parameters,docs:{...(b=s.parameters)==null?void 0:b.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-link href="https://www.ovhcloud.com/" label="Default Link"></ods-link>
  \`
...
<ods-link href="https://www.ovhcloud.com/" label="Icon Link" icon="arrow-right"></ods-link>
  \`
}`,...(v=(T=i.parameters)==null?void 0:T.docs)==null?void 0:v.source}}};var R,D,N;c.parameters={...c.parameters,docs:{...(R=c.parameters)==null?void 0:R.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
  <div style="display: flex; flex-direction: column;">
<ods-link href="https://www.ovhcloud.com/" target="_blank" label="Blank target"></ods-link>
...
<ods-link href="https://www.ovhcloud.com/" target="_top" label="Top target"></ods-link>
  ...
  \`
}`,...(N=(D=c.parameters)==null?void 0:D.docs)==null?void 0:N.source}}};var $,V,E;d.parameters={...d.parameters,docs:{...($=d.parameters)==null?void 0:$.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-link class="my-link" href="https://www.ovhcloud.com/" label="Content"></ods-link>
...
<style>
  ...
  \`
}`,...(E=(V=d.parameters)==null?void 0:V.docs)==null?void 0:E.source}}};const F=["Demo","Overview","Default","Color","Disabled","Icon","Target","CustomCSSLink"],M=Object.freeze(Object.defineProperty({__proto__:null,Color:a,CustomCSSLink:d,Default:s,Demo:o,Disabled:l,Icon:i,Overview:r,Target:c,__namedExportsOrder:F,default:Y},Symbol.toStringTag,{value:"Module"}));export{d as C,s as D,i as I,M as L,r as O,c as T,a,l as b};
