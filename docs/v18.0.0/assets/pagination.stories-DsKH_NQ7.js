import{x as t}from"./lit-html-D-ZEPr28.js";import{C as a,o as M}from"./control-C1r2wu67.js";import{z as Y,A as B}from"./index-DryTTbHl.js";const F={title:"ODS Components/Pagination",component:"ods-pagination"},q={defaultCurrentPage:{table:{category:a.general,defaultValue:{summary:4},type:{summary:"number"}},control:"number"},isDisabled:{table:{category:a.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},labelTooltipPrevious:{table:{category:a.general,defaultValue:{summary:"Previous label"},type:{summary:"string"}},control:"text"},labelTooltipNext:{table:{category:a.general,defaultValue:{summary:"Next label"},type:{summary:"string"}},control:"text"}},J={defaultItemsPerPage:{table:{category:a.general,defaultValue:{summary:Y.option_10},type:{summary:"number"}},control:"select",options:B},totalItems:{table:{category:a.general,defaultValue:{summary:60},type:{summary:"number"}},control:"number"},beforeTotalItems:{table:{category:a.slot,defaultValue:{summary:"of "},type:{summary:"string"}},control:"text"},afterTotalItems:{table:{category:a.slot,defaultValue:{summary:" results"},type:{summary:"string"}},control:"text"}},K={totalPages:{table:{category:a.general,defaultValue:{summary:9},type:{summary:"number"}},control:"number"}},o={render:e=>t`
    <ods-pagination
  ...
  `,argTypes:M({...q,...K}),args:{defaultCurrentPage:4,isDisabled:!1,labelTooltipPrevious:"Previous label",labelTooltipNext:"Next label",totalPages:9}},s={render:e=>t`
    <ods-pagination
      default-current-page="${e.defaultCurrentPage}"
  ...
  `,argTypes:M({...q,...J}),args:{defaultCurrentPage:4,defaultItemsPerPage:Y.option_10,isDisabled:!1,labelTooltipPrevious:"Previous label",labelTooltipNext:"Next label",totalItems:60,beforeTotalItems:"of ",afterTotalItems:" results"}},r={tags:["isHidden"],parameters:{layout:"centered"},render:()=>t`
    <ods-pagination
  ...
  render: () => html\`
    <ods-pagination default-current-page="4" total-pages="7"></ods-pagination>
  \`
}`,...(N=($=n.parameters)==null?void 0:$.docs)==null?void 0:N.source}}};var D,S,h;l.parameters={...l.parameters,docs:{...(D=l.parameters)==null?void 0:D.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
    <ods-pagination default-current-page="3" total-pages="21"></ods-pagination>
  \`
}`,...(h=(S=l.parameters)==null?void 0:S.docs)==null?void 0:h.source}}};var C,O,_;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
    <ods-pagination default-current-page="3" total-pages="21" is-disabled></ods-pagination>
  \`
  ...
  \`
}`,...(A=(G=p.parameters)==null?void 0:G.docs)==null?void 0:A.source}}};var V,W,E;d.parameters={...d.parameters,docs:{...(V=d.parameters)==null?void 0:V.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
    <ods-pagination default-current-page="3" total-items="100"></ods-pagination>
  \`
}`,...(E=(W=d.parameters)==null?void 0:W.docs)==null?void 0:E.source}}};var L,R,j;u.parameters={...u.parameters,docs:{...(L=u.parameters)==null?void 0:L.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
    <ods-pagination
      default-current-page="3"
  ...
  \`
}`,...(z=(w=g.parameters)==null?void 0:w.docs)==null?void 0:z.source}}};const Q=["Demo","TotalItems","Overview","Default","DefaultLargeAmountOfPages","Disabled","WithTooltips","WithTotalItems","WithTotalItemsWithLabels","CustomCSS"],ee=Object.freeze(Object.defineProperty({__proto__:null,CustomCSS:g,Default:n,DefaultLargeAmountOfPages:l,Demo:o,Disabled:i,Overview:r,TotalItems:s,WithTooltips:p,WithTotalItems:d,WithTotalItemsWithLabels:u,__namedExportsOrder:Q,default:F},Symbol.toStringTag,{value:"Module"}));export{l as D,r as O,ee as P,p as W,n as a,i as b,d as c,u as d};
