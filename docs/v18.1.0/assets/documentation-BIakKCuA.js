import{j as e}from"./jsx-runtime-vK1CujOl.js";import{u as a}from"./index-CB7mz5IJ.js";import{M as l,C as c}from"./index-Bd2Jnm8T.js";import{M as o,O as d}from"./message.stories--rVtq4it.js";import{B as h}from"./Banner-D69sr9PT.js";import{I as m,A as g,B as u}from"./IdentityCard-DJgK2WbX.js";import{H as s}from"./Heading-oJ6nNH90.js";import{S as i}from"./StorybookLink-D-3rjE8q.js";import"./iframe-Lgv0C8F1.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-B_J8iUie.js";import"./index-DX_4BEHg.js";import"./index-DrFu-skq.js";import"./index-BNPjhb5w.js";import"./lit-html-D-ZEPr28.js";import"./unsafe-html-HR6uCwaW.js";import"./controls-DpsgTNdU.js";import"./index-CONup0N6.js";function r(t){const n={code:"code",em:"em",img:"img",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{of:o,name:"Documentation"}),`
`,e.jsx(h,{of:o}),`
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:["A ",e.jsx(n.code,{children:"cross"})," icon ",e.jsx(i,{kind:"ODS Components/Button",label:"Button",story:"Documentation"}),", which is a close button to dismiss the ",e.jsx(n.strong,{children:"Message"})]}),`
`]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["A click on the ",e.jsx(n.code,{children:"close"})," icon ",e.jsx(i,{kind:"ODS Components/Button",label:"Button",story:"Documentation"})," will dismiss the ",e.jsx(n.strong,{children:"Message"}),"."]}),`
...
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"close"})," icon ",e.jsx(i,{kind:"ODS Components/Button",label:"Button",story:"Documentation"})," is focusable and can be triggered with the ",e.jsx(n.code,{children:"Enter"}),"/",e.jsx(n.code,{children:"Space"})," key."]})]})}function U(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}export{U as default};
