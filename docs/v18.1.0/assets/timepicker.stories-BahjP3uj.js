import{x as s}from"./lit-html-D-ZEPr28.js";import{o as U,C as r}from"./controls-DpsgTNdU.js";const M={component:"ods-timepicker",title:"ODS Components/Form elements/Timepicker"},t={render:e=>s`
  ...
  `,argTypes:U({ariaLabel:{table:{category:r.accessibility,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},ariaLabelledby:{table:{category:r.accessibility,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},customCss:{table:{category:r.design,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text",description:'Set a custom style properties. Example: "width: 300px;"'},hasError:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isDisabled:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isReadonly:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},timezones:{table:{category:r.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:{type:"boolean"},description:'Toggle this to demo the "all" preset. To fine-tune the list of timezones, check the prop documentation.'},withSeconds:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"}}),args:{hasError:!1,isDisabled:!1,isReadonly:!1,timezones:!1,withSeconds:!1}},a={decorators:[e=>s`<div style="height: 230px;">${e()}</div>`],tags:["isHidden"],render:()=>s`
  ...
  `},n={tags:["isHidden"],parameters:{layout:"centered"},render:()=>s`
...
<ods-timepicker is-readonly></ods-timepicker>
  `},d={decorators:[e=>s`<div style="height: 230px;">${e()}</div>`],tags:["isHidden"],render:()=>s`
<ods-timepicker timezones="all"></ods-timepicker>
  `},c={decorators:[e=>s`<div style="height: 150px;">${e()}</div>`],tags:["isHidden"],render:()=>s`
...
<ods-timepicker value="12:00" timezones="all" current-timezone="UTC+2"></ods-timepicker>
  \`
}`,...(O=(C=n.parameters)==null?void 0:C.docs)==null?void 0:O.source}}};var T,S,x;o.parameters={...o.parameters,docs:{...(T=o.parameters)==null?void 0:T.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-timepicker></ods-timepicker>
  \`
}`,...(x=(S=o.parameters)==null?void 0:S.docs)==null?void 0:x.source}}};var R,z,$;i.parameters={...i.parameters,docs:{...(R=i.parameters)==null?void 0:R.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-timepicker is-disabled></ods-timepicker>
  \`
