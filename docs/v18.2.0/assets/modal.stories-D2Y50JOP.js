import{$ as u,a0 as b}from"./index-CnlqR0TT.js";import{x as t}from"./lit-html-D-ZEPr28.js";import{o as m}from"./unsafe-html-HR6uCwaW.js";import{o as P,C as s}from"./controls-DpsgTNdU.js";const B=()=>{const o=document.querySelector("#storybook-root");o&&(o.innerHTML="")},I=o=>(B(),o());var p=Object.freeze,J=Object.defineProperty,e=(o,F)=>p(J(o,"raw",{value:p(F||o.slice())})),g,y,C,S,O,v,x;const K={title:"ODS Components/Modal",component:"ods-modal",decorators:[I]},n={render:o=>t(g||(g=e([`
...
<style>
  ...
  \`
}`,...(H=(k=r.parameters)==null?void 0:k.docs)==null?void 0:H.source}}};var V,Y,$;i.parameters={...i.parameters,docs:{...(V=i.parameters)==null?void 0:V.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-button class="button-color" label="Trigger Modal">
</ods-button>
...
<\/script>
  \`
}`,...($=(Y=i.parameters)==null?void 0:Y.docs)==null?void 0:$.source}}};var G,j,z;c.parameters={...c.parameters,docs:{...(G=c.parameters)==null?void 0:G.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-button class="button-actions" label="Trigger Modal">
</ods-button>
...
<style>
  ...
  \`
}`,...(z=(j=c.parameters)==null?void 0:j.docs)==null?void 0:z.source}}};const Q=["Demo","Overview","Default","CustomCSS","NotDismissible","Color","Actions"],oo=Object.freeze(Object.defineProperty({__proto__:null,Actions:c,Color:i,CustomCSS:d,Default:l,Demo:n,NotDismissible:r,Overview:a,__namedExportsOrder:Q,default:K},Symbol.toStringTag,{value:"Module"}));export{c as A,d as C,l as D,oo as M,r as N,a as O,i as a};
