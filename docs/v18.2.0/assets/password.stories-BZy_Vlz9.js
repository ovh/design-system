import{x as a}from"./lit-html-D-ZEPr28.js";import{o as U,C as s}from"./controls-DpsgTNdU.js";var y=Object.freeze,W=Object.defineProperty,X=(e,Q)=>y(W(e,"raw",{value:y(Q||e.slice())})),g;const Z={title:"ODS Components/Form elements/Password",component:"ods-password"},r={render:e=>a`
...
<ods-password placeholder="Placeholder">
  ...
  `},m={tags:["isHidden"],render:()=>a(g||(g=X([`
...
<ods-password is-disabled>
  ...
  \`
}`,...(_=(T=t.parameters)==null?void 0:T.docs)==null?void 0:_.source}}};var P,S,x;d.parameters={...d.parameters,docs:{...(P=d.parameters)==null?void 0:P.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-password has-error>
</ods-password>
  \`
}`,...(x=(S=d.parameters)==null?void 0:S.docs)==null?void 0:x.source}}};var H,V,$;l.parameters={...l.parameters,docs:{...(H=l.parameters)==null?void 0:H.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-password is-clearable value="value">
</ods-password>
...
<ods-password is-readonly value="Readonly">
  ...
  \`
}`,...(F=(Y=p.parameters)==null?void 0:Y.docs)==null?void 0:F.source}}};var j,z,B;c.parameters={...c.parameters,docs:{...(j=c.parameters)==null?void 0:j.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-password placeholder="Placeholder">
</ods-password>
  \`
}`,...(B=(z=c.parameters)==null?void 0:z.docs)==null?void 0:B.source}}};var I,k,M;m.parameters={...m.parameters,docs:{...(I=m.parameters)==null?void 0:I.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-password id="my-password-pattern" pattern="\\\\d*">
</ods-password>
...
<\/script>
  \`
}`,...(M=(k=m.parameters)==null?void 0:k.docs)==null?void 0:M.source}}};var q,J,K;u.parameters={...u.parameters,docs:{...(q=u.parameters)==null?void 0:q.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-password class="my-password">
</ods-password>
<style>
  ...
  \`
}`,...(K=(J=u.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};const ee=["Demo","Overview","Default","Disabled","Error","Clearable","Loading","Readonly","Placeholder","Pattern","CustomCSS"],re=Object.freeze(Object.defineProperty({__proto__:null,Clearable:l,CustomCSS:u,Default:o,Demo:r,Disabled:t,Error:d,Loading:i,Overview:n,Pattern:m,Placeholder:c,Readonly:p,__namedExportsOrder:ee,default:Z},Symbol.toStringTag,{value:"Module"}));export{u as C,o as D,d as E,i as L,n as O,re as P,p as R,l as a,t as b,m as c,c as d};
