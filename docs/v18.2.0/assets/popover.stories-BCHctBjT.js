import{G as p,H as l}from"./index-CnlqR0TT.js";import{x as o}from"./lit-html-D-ZEPr28.js";import{o as R}from"./unsafe-html-HR6uCwaW.js";import{o as M,C as d}from"./controls-DpsgTNdU.js";const D={title:"ODS Components/Popover",component:"ods-popover",parameters:{layout:"centered"},decorators:[t=>o`<div style="padding-top: 50px; display: inline-flex; align-content: center;">${t()}</div>`]},e={render:t=>o`
...
<ods-popover position="${t.position}"
  ...
  `,argTypes:M({content:{table:{category:d.slot,defaultValue:{summary:"ø"}},control:"text"},position:{table:{category:d.general,defaultValue:{summary:p.top},type:{summary:l}},control:{type:"select"},options:l},withArrow:{table:{category:d.design,defaultValue:{summary:!1}},control:{type:"boolean"}}}),args:{content:'<div><p>Some text content</p><input type="text" /><button>Action</button>',position:p.bottom,withArrow:!0}},n={tags:["isHidden"],render:()=>o`
...
<ods-popover trigger-id="trigger-overview">
  ...
  \`
}`,...(T=(x=i.parameters)==null?void 0:x.docs)==null?void 0:T.source}}};var _,A,C;a.parameters={...a.parameters,docs:{...(_=a.parameters)==null?void 0:_.docs,source:{originalSource:`{
  tags: ['isHidden'],
...
<div style="display: flex;">
  ...
  \`
}`,...(C=(A=a.parameters)==null?void 0:A.docs)==null?void 0:C.source}}};const H=["Demo","ArrowTip","CustomCSS","Default","Overview","Menu"],$=Object.freeze(Object.defineProperty({__proto__:null,ArrowTip:n,CustomCSS:r,Default:s,Demo:e,Menu:a,Overview:i,__namedExportsOrder:H,default:D},Symbol.toStringTag,{value:"Module"}));export{n as A,r as C,s as D,a as M,i as O,$ as P};
