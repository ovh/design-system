import{G as p,H as d}from"./index-CnlqR0TT.js";import{x as t}from"./lit-html-D-ZEPr28.js";import{o as L}from"./unsafe-html-HR6uCwaW.js";import{o as C,C as a}from"./controls-DpsgTNdU.js";const I={title:"ODS Components/Tooltip",component:"ods-tooltip",parameters:{layout:"centered"},decorators:[o=>t`<div style="padding-top: 50px; display: inline-flex; align-items: center;">${o()}</div>`]},e={render:o=>t`
...
<style>
  ...
  \`
}`,...(f=(b=i.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};const A=["Demo","Overview","Default","ArrowTip","CustomCSS"],N=Object.freeze(Object.defineProperty({__proto__:null,ArrowTip:s,CustomCSS:i,Default:n,Demo:e,Overview:r,__namedExportsOrder:A,default:I},Symbol.toStringTag,{value:"Module"}));export{s as A,i as C,n as D,r as O,N as T};
