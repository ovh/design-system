import{x as e}from"./lit-html-D-ZEPr28.js";import{o as I}from"./unsafe-html-HR6uCwaW.js";import{o as w,C as F}from"./controls-DpsgTNdU.js";var n=Object.freeze,j=Object.defineProperty,A=(r,c)=>n(j(r,"raw",{value:n(c||r.slice())})),i;const R={title:"ODS Components/Breadcrumb",component:"ods-breadcrumb",decorators:[r=>(setTimeout(()=>{document.querySelectorAll("ods-breadcrumb-item").forEach(c=>{c.removeAttribute("href")})},0),r())]},d={render:r=>e`
<ods-breadcrumb>
  ${I(r.items)}
</ods-breadcrumb>
