...
<ods-icon name="home"></ods-icon>
  \`
}`,...(x=(v=a.parameters)==null?void 0:v.docs)==null?void 0:x.source}}};var k,C,N;t.parameters={...t.parameters,docs:{...(k=t.parameters)==null?void 0:k.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-icon name="home"></ods-icon>
<ods-icon name="plus"></ods-icon>
  \`
}`,...(N=(C=t.parameters)==null?void 0:C.docs)==null?void 0:N.source}}};const I=["Demo","All","Overview","Default","Name"],z=Object.freeze(Object.defineProperty({__proto__:null,All:r,Default:a,Demo:o,Name:t,Overview:n,__namedExportsOrder:I,default:R},Symbol.toStringTag,{value:"Module"}));export{a as D,z as I,t as N,n as O};
