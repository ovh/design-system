import{T as e,U as m,b as H,V as g,W as u}from"./index-LQAjXuKp.js";import{x as a}from"./lit-html-D-ZEPr28.js";import{o as V,C as t}from"./controls-DpsgTNdU.js";const x={title:"ODS Components/Tag",component:"ods-tag"},o={render:s=>a`
...
<ods-tag label="LG tag" size="\${ODS_TAG_SIZE.lg}"></ods-tag>
  \`
}`,...(N=(M=i.parameters)==null?void 0:M.docs)==null?void 0:N.source}}};const Z=["Demo","Overview","Default","Color","CustomCSS","IsDisabled","Size"],k=Object.freeze(Object.defineProperty({__proto__:null,Color:l,CustomCSS:d,Default:r,Demo:o,IsDisabled:c,Overview:n,Size:i,__namedExportsOrder:Z,default:x},Symbol.toStringTag,{value:"Module"}));export{d as C,r as D,c as I,n as O,i as S,k as T,l as a};
