import{x as r}from"./lit-html-D-ZEPr28.js";import{o as V,C as d}from"./controls-DpsgTNdU.js";const R={title:"ODS Components/Progress Bar",component:"ods-progress-bar"},e={render:m=>r`
    <ods-progress-bar
...
<ods-progress-bar value="50"></ods-progress-bar>
  \`
}`,...(_=(H=t.parameters)==null?void 0:H.docs)==null?void 0:_.source}}};const E=["Demo","CustomCSS","Overview","Default","Max","Value"],$=Object.freeze(Object.defineProperty({__proto__:null,CustomCSS:s,Default:o,Demo:e,Max:n,Overview:a,Value:t,__namedExportsOrder:E,default:R},Symbol.toStringTag,{value:"Module"}));export{s as C,o as D,n as M,a as O,$ as P,t as V};
