import{x as e}from"./lit-html-D-ZEPr28.js";import{o as G}from"./unsafe-html-HR6uCwaW.js";import{o as M,C as N}from"./controls-DpsgTNdU.js";var c=Object.freeze,V=Object.defineProperty,t=(n,k)=>c(V(n,"raw",{value:c(k||n.slice())})),i,u,T,m,v,f;const Y={title:"ODS Components/Tabs",component:"ods-tabs"},s={render:n=>e`
<ods-tabs>
  ${G(n.content)}
</ods-tabs>
  `,argTypes:M({content:{table:{category:N.slot,defaultValue:{summary:"ø"}},control:"text",description:"Add `is-selected` or `is-disabled` on `ods-tab` to see the state change"}}),args:{content:"<ods-tab>Tab 1</ods-tab><ods-tab>Tab 2</ods-tab><ods-tab>Tab 3</ods-tab>"}},a={tags:["isHidden"],render:()=>e(i||(i=t([`
...
<\/script>
  \`
}`,...(P=(z=l.parameters)==null?void 0:z.docs)==null?void 0:P.source}}};const F=["Demo","CustomCSS","Default","Disabled","Overflow","Overview","Selected"],K=Object.freeze(Object.defineProperty({__proto__:null,CustomCSS:a,Default:d,Demo:s,Disabled:b,Overflow:o,Overview:r,Selected:l,__namedExportsOrder:F,default:Y},Symbol.toStringTag,{value:"Module"}));export{a as C,d as D,r as O,l as S,K as T,b as a,o as b};
