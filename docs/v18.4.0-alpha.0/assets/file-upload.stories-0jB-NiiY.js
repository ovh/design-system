import{x as a}from"./lit-html-D-ZEPr28.js";import{o as oe,C as l}from"./controls-D697y8_r.js";var F=Object.freeze,te=Object.defineProperty,i=(e,se)=>F(te(e,"raw",{value:F(se||e.slice())})),g,U,x,y,b,v,L,E,h,C;const ne={title:"ODS Components/Form elements/File Upload",component:"ods-file-upload"},d={render:e=>a(g||(g=i([`
...
<\/script>
  `])))},u={tags:["isHidden"],parameters:{layout:"centered"},decorators:[e=>a`<div style="text-align: center;">${e()}</div>`],render:()=>a(h||(h=i([`
...
<\/script>
  `])))},m={tags:["isHidden"],render:()=>a(C||(C=i([`
...
<\/script>
  \`
}`,...($=(V=t.parameters)==null?void 0:V.docs)==null?void 0:$.source}}};var D,j,H;n.parameters={...n.parameters,docs:{...(D=n.parameters)==null?void 0:D.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-file-upload id="default-file-upload"></ods-file-upload>
<script>
...
<\/script>
  \`
}`,...(de=(ie=m.parameters)==null?void 0:ie.docs)==null?void 0:de.source}}};const re=["Demo","Accept","CustomCSS","CustomLabels","Default","Disabled","InverseFileList","MaxFile","MaxSize","Overview","Progress"],fe=Object.freeze(Object.defineProperty({__proto__:null,Accept:s,CustomCSS:o,CustomLabels:t,Default:n,Demo:d,Disabled:r,InverseFileList:p,MaxFile:c,MaxSize:f,Overview:u,Progress:m,__namedExportsOrder:re,default:ne},Symbol.toStringTag,{value:"Module"}));export{s as A,o as C,n as D,fe as F,p as I,c as M,u as O,m as P,r as a,t as b,f as c};
