import{x as c,y as g,z as u,A as p}from"./index-D19O3a7h.js";import{x as e}from"./lit-html-D-ZEPr28.js";import{o as Y}from"./unsafe-html-HR6uCwaW.js";import{o as k,C as a}from"./controls-D697y8_r.js";const j={title:"ODS Components/Message",component:"ods-message"},n={render:s=>e`
...
<ods-message color="warning">Warning Message</ods-message>
  \`
}`,...(A=(E=t.parameters)==null?void 0:E.docs)==null?void 0:A.source}}};var x,T,R;i.parameters={...i.parameters,docs:{...(x=i.parameters)==null?void 0:x.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-message is-dismissible="false">Default Message</ods-message>
  \`
}`,...(R=(T=i.parameters)==null?void 0:T.docs)==null?void 0:R.source}}};var V,h,G;m.parameters={...m.parameters,docs:{...(V=m.parameters)==null?void 0:V.docs,source:{originalSource:`{
  tags: ['isHidden'],
  decorators: [story => html\`<div style="display: flex; flex-direction: column; gap: 8px;">\${story()}</div>\`],
  render: () => html\`
<ods-message variant="default">Default variant Message</ods-message>
...
<style>
  ...
  \`
}`,...(w=(I=d.parameters)==null?void 0:I.docs)==null?void 0:w.source}}};const z=["Demo","Overview","Default","Color","NotDismissible","Variant","CustomCSS","Multiline"],B=Object.freeze(Object.defineProperty({__proto__:null,Color:t,CustomCSS:l,Default:r,Demo:n,Multiline:d,NotDismissible:i,Overview:o,Variant:m,__namedExportsOrder:z,default:j},Symbol.toStringTag,{value:"Module"}));export{l as C,r as D,B as M,i as N,o as O,m as V,t as a,d as b};
