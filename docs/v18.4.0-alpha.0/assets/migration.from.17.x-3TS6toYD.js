import{j as e}from"./jsx-runtime-Cz3huCOb.js";import{u as a}from"./index-BRdWgBGF.js";import{O as n}from"./index-BYszAjkJ.js";import{M as d,d as r}from"./index-C7ZQW9Xo.js";import{D as l}from"./datepicker.stories-Bk4zNUQ8.js";import{H as t}from"./Heading-BWgLZzFp.js";import"./iframe-O-MMI8BM.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-B_J8iUie.js";import"./index-DX_4BEHg.js";import"./index-DrFu-skq.js";import"./index-D19O3a7h.js";import"./lit-html-D-ZEPr28.js";import"./validityState-ExJ3RVbh.js";import"./controls-D697y8_r.js";function o(i){const s={code:"code",p:"p",...a(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{of:l,name:"Migration From 17.x"}),`
`,e.jsx(t,{label:"Datepicker - migrate from v17 to v18",level:1}),`
...
`,e.jsxs(s.p,{children:[e.jsx(s.code,{children:"clearable"})," ",e.jsx(n,{color:"information",label:"Updated",size:"sm"})]}),`
...
`,e.jsxs(s.p,{children:[e.jsx(s.code,{children:"isLoading"})," ",e.jsx(n,{color:"success",label:"New",size:"sm"})]}),`
`,e.jsx(s.p,{children:"New attribute (optional)."}),`
...
`,e.jsxs(s.p,{children:[e.jsx(s.code,{children:"maxDate"})," ",e.jsx(n,{color:"information",label:"Updated",size:"sm"})]}),`
`,e.jsx(s.p,{children:"Has been updated."}),`
`,e.jsxs(s.p,{children:["You can use the new ",e.jsx(s.code,{children:"max"})," attribute to obtain the same behavior."]}),`
`,e.jsxs(s.p,{children:[e.jsx(s.code,{children:"minDate"})," ",e.jsx(n,{color:"information",label:"Updated",size:"sm"})]}),`
`,e.jsx(s.p,{children:"Has been updated."}),`
`,e.jsxs(s.p,{children:["You can use the new ",e.jsx(s.code,{children:"min"})," attribute to obtain the same behavior."]}),`
`,e.jsxs(s.p,{children:[e.jsx(s.code,{children:"showSiblingsMonthDays"})," ",e.jsx(n,{color:"critical",label:"Removed",size:"sm"})]}),`
`,e.jsx(s.p,{children:"Has been removed."}),`
...
`,dark:"true",language:"html"})]})}function Y(i={}){const{wrapper:s}={...a(),...i.components};return s?e.jsx(s,{...i,children:e.jsx(o,{...i})}):o(i)}export{Y as default};
