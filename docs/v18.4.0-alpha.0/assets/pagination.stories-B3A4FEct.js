import{B,C as q}from"./index-D19O3a7h.js";import{x as t}from"./lit-html-D-ZEPr28.js";import{C as a,o as M}from"./controls-D697y8_r.js";const F={title:"ODS Components/Pagination",component:"ods-pagination"},Y={defaultCurrentPage:{table:{category:a.general,defaultValue:{summary:4},type:{summary:"number"}},control:"number"},isDisabled:{table:{category:a.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},labelTooltipPrevious:{table:{category:a.general,defaultValue:{summary:"Previous label"},type:{summary:"string"}},control:"text"},labelTooltipNext:{table:{category:a.general,defaultValue:{summary:"Next label"},type:{summary:"string"}},control:"text"}},J={defaultItemsPerPage:{table:{category:a.general,defaultValue:{summary:B.option_10},type:{summary:"number"}},control:"select",options:q},totalItems:{table:{category:a.general,defaultValue:{summary:60},type:{summary:"number"}},control:"number"},beforeTotalItems:{table:{category:a.slot,defaultValue:{summary:"of "},type:{summary:"string"}},control:"text"},afterTotalItems:{table:{category:a.slot,defaultValue:{summary:" results"},type:{summary:"string"}},control:"text"}},K={totalPages:{table:{category:a.general,defaultValue:{summary:9},type:{summary:"number"}},control:"number"}},o={render:e=>t`
    <ods-pagination
  ...
  `,argTypes:M({...Y,...K}),args:{defaultCurrentPage:4,isDisabled:!1,labelTooltipPrevious:"Previous label",labelTooltipNext:"Next label",totalPages:9}},s={render:e=>t`
    <ods-pagination
      default-current-page="${e.defaultCurrentPage}"
  ...
  `,argTypes:M({...Y,...J}),args:{defaultCurrentPage:4,defaultItemsPerPage:B.option_10,isDisabled:!1,labelTooltipPrevious:"Previous label",labelTooltipNext:"Next label",totalItems:60,beforeTotalItems:"of ",afterTotalItems:" results"}},r={tags:["isHidden"],parameters:{layout:"centered"},render:()=>t`
    <ods-pagination
  ...
  render: () => html\`
    <ods-pagination default-current-page="4" total-pages="7"></ods-pagination>
  \`
}`,...(N=($=n.parameters)==null?void 0:$.docs)==null?void 0:N.source}}};var D,S,C;l.parameters={...l.parameters,docs:{...(D=l.parameters)==null?void 0:D.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
    <ods-pagination default-current-page="3" total-pages="21"></ods-pagination>
  \`
}`,...(C=(S=l.parameters)==null?void 0:S.docs)==null?void 0:C.source}}};var h,O,_;i.parameters={...i.parameters,docs:{...(h=i.parameters)==null?void 0:h.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
    <ods-pagination default-current-page="3" total-pages="21" is-disabled></ods-pagination>
  \`
