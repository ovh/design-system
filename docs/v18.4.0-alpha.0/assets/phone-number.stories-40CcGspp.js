import{D as h,E as g}from"./index-D19O3a7h.js";import{x as r,T as le}from"./lit-html-D-ZEPr28.js";import{V as se}from"./validityState-ExJ3RVbh.js";import{o as de,C as n}from"./controls-D697y8_r.js";var f=Object.freeze,ie=Object.defineProperty,ue=(e,te)=>f(ie(e,"raw",{value:f(te||e.slice())})),O;const me={title:"ODS Components/Form elements/Phone Number",component:"ods-phone-number"},a={render:e=>r`
...
<ods-phone-number countries="all"
  ...
  `},p={tags:["isHidden"],render:()=>r(O||(O=ue([`
...
<ods-phone-number countries="all"
  ...
  \`
}`,...(q=(G=d.parameters)==null?void 0:G.docs)==null?void 0:q.source}}};var P,I,w;i.parameters={...i.parameters,docs:{...(P=i.parameters)==null?void 0:P.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
    <ods-phone-number has-error></ods-phone-number>
    <br /><br />
  ...
  \`
}`,...(w=(I=i.parameters)==null?void 0:I.docs)==null?void 0:w.source}}};var F,U,M;u.parameters={...u.parameters,docs:{...(F=u.parameters)==null?void 0:F.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
    <ods-phone-number is-loading></ods-phone-number>
    <br /><br />
...
\${ValidityStateTemplate('phone-number', '#phone-number-validity-state-demo')}
  \`
}`,...(oe=(ae=y.parameters)==null?void 0:ae.docs)==null?void 0:oe.source}}};const ce=["Demo","Clearable","CustomCSS","Overview","Default","Disabled","Error","Loading","Locale","ISOCode","Pattern","Readonly","ValidityState"],ge=Object.freeze(Object.defineProperty({__proto__:null,Clearable:o,CustomCSS:s,Default:l,Demo:a,Disabled:d,Error:i,ISOCode:c,Loading:u,Locale:m,Overview:t,Pattern:p,Readonly:b,ValidityState:y,__namedExportsOrder:ce,default:me},Symbol.toStringTag,{value:"Module"}));export{s as C,l as D,i as E,c as I,u as L,t as O,ge as P,b as R,y as V,o as a,d as b,m as c,p as d};
