import{x as i}from"./lit-html-D-ZEPr28.js";var a=Object.freeze,l=Object.defineProperty,d=(e,t)=>a(l(e,"raw",{value:a(t||e.slice())})),o;function s(e){return e.replace(/<ods-table\b[^<]*(?:(?!<\/ods-table>)<[^<]*)*<\/ods-table>/gi,"").replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,"")}function c(e,t){const n=`validity-state-table-${Date.now()}`;return i(o||(o=d([`
    <ods-table size="sm">
      <table id="`,`"
