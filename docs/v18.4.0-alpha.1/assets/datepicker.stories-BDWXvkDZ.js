import{p as O,q as be,r as ke}from"./index-CveiHl7W.js";import{x as a,T as f}from"./lit-html-D-ZEPr28.js";import{V as ue}from"./validityState-ExJ3RVbh.js";import{o as fe,C as r}from"./controls-D697y8_r.js";var D=Object.freeze,Oe=Object.defineProperty,k=(e,ge)=>D(Oe(e,"raw",{value:D(ge||e.slice())})),C,R,S,h,L;const De={title:"ODS Components/Form elements/Datepicker",component:"ods-datepicker",decorators:[e=>a`<div style="height: 320px;">${e()}</div>`]},t={render:e=>a`
    ...
    `,argTypes:fe({ariaLabel:{table:{category:r.accessibility,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},ariaLabelledby:{table:{category:r.accessibility,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},format:{table:{category:r.general,defaultValue:{summary:"dd/mm/yyyy"},type:{summary:"string"}},control:"text"},hasError:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isClearable:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isDisabled:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isLoading:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isReadonly:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isRequired:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},locale:{table:{category:r.general,defaultValue:{summary:be.en},type:{summary:"OdsDatepickerLocale"}},control:{type:"select"},options:ke},max:{table:{category:r.general,defaultValue:{summary:"ø"},type:{summary:"Date"}},control:"date"},min:{table:{category:r.general,defaultValue:{summary:"ø"},type:{summary:"Date"}},control:"date"},placeholder:{table:{category:r.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},validityState:{table:{category:r.validation,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean",description:"Toggle this to see the component validityState"}}),args:{hasError:!1,isClearable:!1,isDisabled:!1,isLoading:!1,isReadonly:!1,isRequired:!1,validityState:!1}},n={tags:["isHidden"],render:()=>a`
...
\${ValidityStateTemplate('datepicker', '#datepicker-validity-state-demo')}
  \`
}`,...(ye=(pe=b.parameters)==null?void 0:pe.docs)==null?void 0:ye.source}}};const Ce=["Demo","Clearable","DatesDisabled","DaysOfWeekDisabled","Overview","Default","Disabled","Error","Format","Loading","Locale","Placeholder","Readonly","ValidityState"],Te=Object.freeze(Object.defineProperty({__proto__:null,Clearable:n,DatesDisabled:s,DaysOfWeekDisabled:d,Default:i,Demo:t,Disabled:l,Error:c,Format:m,Loading:p,Locale:y,Overview:o,Placeholder:u,Readonly:g,ValidityState:b,__namedExportsOrder:Ce,default:De},Symbol.toStringTag,{value:"Module"}));export{n as C,Te as D,c as E,m as F,p as L,o as O,u as P,g as R,b as V,i as a,s as b,d as c,l as d,y as e};
