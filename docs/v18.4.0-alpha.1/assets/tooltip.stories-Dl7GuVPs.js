import{H as l,I as p}from"./index-CveiHl7W.js";import{x as t}from"./lit-html-D-ZEPr28.js";import{o as P}from"./unsafe-html-HR6uCwaW.js";import{o as D,C as d}from"./controls-D697y8_r.js";var c=Object.freeze,H=Object.defineProperty,N=(o,E)=>c(H(o,"raw",{value:c(E||o.slice())})),m;const R={title:"ODS Components/Tooltip",component:"ods-tooltip",parameters:{layout:"centered"},decorators:[o=>t`<div style="padding-top: 50px; display: inline-flex; align-items: center;">${o()}</div>`]},e={render:o=>t`
...
<\/script>
  \`
}`,...(v=(A=a.parameters)==null?void 0:A.docs)==null?void 0:v.source}}};const V=["Demo","Overview","Default","ArrowTip","CustomCSS","FixedContext"],F=Object.freeze(Object.defineProperty({__proto__:null,ArrowTip:s,CustomCSS:i,Default:r,Demo:e,FixedContext:a,Overview:n,__namedExportsOrder:V,default:R},Symbol.toStringTag,{value:"Module"}));export{s as A,i as C,r as D,a as F,n as O,F as T};
