import{x as e}from"./lit-html-D-ZEPr28.js";import{V as ae}from"./validityState-ExJ3RVbh.js";import{o as se,C as s}from"./controls-D697y8_r.js";const ne={title:"ODS Components/Form elements/Checkbox",component:"ods-checkbox"},n={render:a=>e`
    <ods-checkbox
    ...
    </style>`,argTypes:se({ariaLabel:{table:{category:s.accessibility,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},ariaLabelledby:{table:{category:s.accessibility,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},customCss:{table:{category:s.design,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text",description:'Set a custom style properties. Example: "background-color: red; border-color: red;"'},hasError:{table:{category:s.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isDisabled:{table:{category:s.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isIndeterminate:{table:{category:s.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isRequired:{control:"boolean",table:{category:s.general,defaultValue:{summary:"false"},type:{summary:"boolean"}}},validityState:{table:{category:s.validation,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean",description:"Toggle this to see the component validityState"}}),args:{hasError:!1,isDisabled:!1,isIndeterminate:!1,isRequired:!1,validityState:!1}},r={tags:["isHidden"],render:()=>e`
...
${ae("checkbox","#checkbox-validity-state-demo")}
  `};var h,g,x;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: arg => {
    return html\`
    <ods-checkbox
...
}`,...(x=(g=n.parameters)==null?void 0:g.docs)==null?void 0:x.source}}};var k,f,C;r.parameters={...r.parameters,docs:{...(k=r.parameters)==null?void 0:k.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
  <div style="display: inline-flex; justify-content: center; align-items: center; gap: 5px;">
    <ods-checkbox input-id="alignment" value="alignment"></ods-checkbox>
...
<style>
  ...
  \`
}`,...(v=(O=o.parameters)==null?void 0:O.docs)==null?void 0:v.source}}};var T,H,R;t.parameters={...t.parameters,docs:{...(T=t.parameters)==null?void 0:T.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-checkbox is-checked></ods-checkbox>
  \`
}`,...(R=(H=t.parameters)==null?void 0:H.docs)==null?void 0:R.source}}};var E,V,D;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-checkbox has-error></ods-checkbox>
  \`
}`,...(D=(V=c.parameters)==null?void 0:V.docs)==null?void 0:D.source}}};var $,L,A;d.parameters={...d.parameters,docs:{...($=d.parameters)==null?void 0:$.docs,source:{originalSource:`{
  tags: ['isHidden'],
  parameters: {
    layout: 'centered'
  },
...
\${ValidityStateTemplate('checkbox', '#checkbox-validity-state-demo')}
  \`
}`,...(ee=(Z=p.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};const re=["Demo","Alignment","CustomCSS","Checked","Error","Overview","Default","Disabled","DisabledChecked","DisabledIndeterminate","InputId","Indeterminate","ValidityState"],de=Object.freeze(Object.defineProperty({__proto__:null,Alignment:r,Checked:t,CustomCSS:o,Default:i,Demo:n,Disabled:l,DisabledChecked:m,DisabledIndeterminate:b,Error:c,Indeterminate:y,InputId:u,Overview:d,ValidityState:p,__namedExportsOrder:re,default:ne},Symbol.toStringTag,{value:"Module"}));export{r as A,de as C,i as D,c as E,u as I,d as O,p as V,o as a,t as b,l as c,m as d,b as e,y as f};
