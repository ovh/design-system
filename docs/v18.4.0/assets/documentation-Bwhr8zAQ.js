import{j as e}from"./jsx-runtime-Cz980c3e.js";import{u as a}from"./index-C2TcKet0.js";import{M as l,C as c}from"./index-Nkgk7YEz.js";import{T as o,O as d}from"./textarea.stories-Mq-KjDrL.js";import{B as m}from"./Banner-DJBI_cBG.js";import{I as x,A as p,B as h}from"./IdentityCard-C7PlZNnd.js";import{H as s}from"./Heading-DYcKlEuJ.js";import{S as r}from"./StorybookLink-CNJXR0hy.js";import"./iframe-COPR_OVU.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-B_J8iUie.js";import"./index-DX_4BEHg.js";import"./index-DrFu-skq.js";import"./lit-html-D-ZEPr28.js";import"./validityState-ExJ3RVbh.js";import"./controls-D697y8_r.js";import"./index-CveiHl7W.js";import"./index-BvZXb4_Z.js";function i(t){const n={code:"code",em:"em",img:"img",li:"li",ol:"ol",p:"p",span:"span",strong:"strong",...a(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{of:o,name:"Documentation"}),`
`,e.jsx(m,{of:o}),`
...
`,e.jsxs(x,{aliases:["Text Box"],atomicType:p.atom,figmaLink:"https://www.figma.com/design/9jDDTcR4a9jPRFcdjawAlf/ODS---UI-Kit?node-id=53-11147",githubUrl:"https://github.com/ovh/design-system/tree/master/packages/ods/src/components/textarea",name:"Textarea",relatedComponents:[{name:"Tag"}],children:[e.jsxs(n.p,{children:["The ",e.jsx(n.strong,{children:"Textarea"})," component is used to capture and display multi-line text input from users."]}),e.jsx(n.p,{children:"It is typically used in forms where users need to provide detailed information, comments, or descriptions."})]}),`
...
`,e.jsx(h,{donts:["- Use Textarea for shorter text",e.jsxs(n.span,{children:["- Use a placeholder as replacement for a ",e.jsx(r,{kind:"ODS Components/Form elements/Form Field",label:"Form Field",story:"Documentation"})," label"]})],dos:["- Use Textarea for a text longer than a single line",e.jsxs(n.span,{children:["- Use a ",e.jsx(r,{kind:"ODS Components/Form elements/Form Field",label:"Form Field",story:"Documentation"})," label (and/or an helper) to clearly inform what information the user should type"]})]}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"Tab"})," allows to focus on ",e.jsx(n.strong,{children:"Textarea"}),"."]})]})}function I(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{I as default};
