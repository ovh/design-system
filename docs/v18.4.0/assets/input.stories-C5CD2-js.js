import{_ as Oe,$ as C}from"./index-CveiHl7W.js";import{T as t,x as a}from"./lit-html-D-ZEPr28.js";import{V as fe}from"./validityState-ExJ3RVbh.js";import{o as Ce,C as n}from"./controls-D697y8_r.js";/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ve=e=>e??t;var v=Object.freeze,Te=Object.defineProperty,Re=(e,he)=>v(Te(e,"raw",{value:v(he||e.slice())})),T;const Se={title:"ODS Components/Form elements/Input",component:"ods-input"},r={render:e=>a`
...
<ods-input placeholder="Placeholder">
  ...
  `},b={tags:["isHidden"],render:()=>a(T||(T=Re([`
...
${fe("input","#input-validity-state-demo")}
  `};var R,S,V;r.parameters={...r.parameters,docs:{...(R=r.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: arg => {
    return html\`
    <ods-input class="my-input"
...
}`,...(V=(S=r.parameters)==null?void 0:S.docs)==null?void 0:V.source}}};var E,L,_;s.parameters={...s.parameters,docs:{...(E=s.parameters)==null?void 0:E.docs,source:{originalSource:`{
  tags: ['isHidden'],
  parameters: {
    layout: 'centered'
  },
...
<ods-input is-masked>
  ...
  \`
}`,...(z=(j=m.parameters)==null?void 0:j.docs)==null?void 0:z.source}}};var B,J,K;p.parameters={...p.parameters,docs:{...(B=p.parameters)==null?void 0:B.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-input is-readonly value="Readonly">
</ods-input>
  \`
}`,...(K=(J=p.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};var Q,W,X;c.parameters={...c.parameters,docs:{...(Q=c.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-input type="search" value="search type">
</ods-input>
...
\${ValidityStateTemplate('input', '#input-validity-state-demo')}
  \`
}`,...(be=(ge=O.parameters)==null?void 0:ge.docs)==null?void 0:be.source}}};const Ve=["Demo","Overview","Default","Disabled","Error","Clearable","Loading","Masked","Readonly","Search","StepAny","Placeholder","Pattern","CustomCSS","Datalist","ValidityState"],xe=Object.freeze(Object.defineProperty({__proto__:null,Clearable:d,CustomCSS:f,Datalist:h,Default:o,Demo:r,Disabled:l,Error:i,Loading:u,Masked:m,Overview:s,Pattern:b,Placeholder:g,Readonly:p,Search:c,StepAny:y,ValidityState:O,__namedExportsOrder:Ve,default:Se},Symbol.toStringTag,{value:"Module"}));export{f as C,o as D,i as E,xe as I,u as L,m as M,s as O,b as P,p as R,c as S,O as V,d as a,l as b,g as c,y as d,h as e};
