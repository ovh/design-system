import{E as F,F as q}from"./index-CveiHl7W.js";import{x as t}from"./lit-html-D-ZEPr28.js";import{C as a,o as M}from"./controls-D697y8_r.js";const B={title:"ODS Components/Pagination",component:"ods-pagination"},Y={defaultCurrentPage:{table:{category:a.general,defaultValue:{summary:4},type:{summary:"number"}},control:"number"},isDisabled:{table:{category:a.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},labelTooltipPrevious:{table:{category:a.general,defaultValue:{summary:"Previous label"},type:{summary:"string"}},control:"text"},labelTooltipNext:{table:{category:a.general,defaultValue:{summary:"Next label"},type:{summary:"string"}},control:"text"}},J={defaultItemsPerPage:{table:{category:a.general,defaultValue:{summary:F.option_10},type:{summary:"number"}},control:"select",options:q},totalItems:{table:{category:a.general,defaultValue:{summary:60},type:{summary:"number"}},control:"number"},beforeTotalItems:{table:{category:a.slot,defaultValue:{summary:"of "},type:{summary:"string"}},control:"text"},afterTotalItems:{table:{category:a.slot,defaultValue:{summary:" results"},type:{summary:"string"}},control:"text"}},K={totalPages:{table:{category:a.general,defaultValue:{summary:9},type:{summary:"number"}},control:"number"}},o={render:e=>t`
    <ods-pagination
  ...
  `,argTypes:M({...Y,...J}),args:{defaultCurrentPage:4,defaultItemsPerPage:F.option_10,isDisabled:!1,labelTooltipPrevious:"Previous label",labelTooltipNext:"Next label",totalItems:60,beforeTotalItems:"of ",afterTotalItems:" results"}},r={tags:["isHidden"],parameters:{layout:"centered"},render:()=>t`
    <ods-pagination
