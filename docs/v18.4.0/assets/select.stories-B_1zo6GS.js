import{x as o}from"./lit-html-D-ZEPr28.js";import{V as h}from"./validityState-ExJ3RVbh.js";import{o as de,C as n}from"./controls-D697y8_r.js";var y=Object.freeze,ue=Object.defineProperty,pe=(e,ce)=>y(ue(e,"raw",{value:y(ce||e.slice())})),b,S;const me={title:"ODS Components/Form elements/Select",component:"ods-select",decorators:[e=>o`<div style="min-height: 200px;">${e()}</div>`]},t={render:e=>o`
...
\${ValidityStateTemplate('select', '#select-validity-state-demo')}
  \`
}`,...(re=(le=f.parameters)==null?void 0:le.docs)==null?void 0:re.source}}};const ge=["Demo","DemoMultiple","CustomCSS","CustomRenderer","CustomRendererMultiple","Overview","Default","Multiple","Optgroup","Disabled","DisabledOption","DisabledGroupOfOptions","Readonly","ValidityState"],ye=Object.freeze(Object.defineProperty({__proto__:null,CustomCSS:s,CustomRenderer:i,CustomRendererMultiple:l,Default:d,Demo:t,DemoMultiple:a,Disabled:u,DisabledGroupOfOptions:g,DisabledOption:m,Multiple:p,Optgroup:c,Overview:r,Readonly:v,ValidityState:f,__namedExportsOrder:ge,default:me},Symbol.toStringTag,{value:"Module"}));export{s as C,d as D,p as M,r as O,v as R,ye as S,f as V,c as a,u as b,m as c,g as d,i as e,l as f};
