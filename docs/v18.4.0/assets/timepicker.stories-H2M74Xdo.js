import{x as t}from"./lit-html-D-ZEPr28.js";import{V as B}from"./validityState-ExJ3RVbh.js";import{o as I,C as r}from"./controls-D697y8_r.js";const J={component:"ods-timepicker",title:"ODS Components/Form elements/Timepicker"},a={render:e=>t`
...
${B("timepicker","#timepicker-validity-state-demo")}
  ...
  \`
}`,...(f=(h=s.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};var T,S,O;n.parameters={...n.parameters,docs:{...(T=n.parameters)==null?void 0:T.docs,source:{originalSource:`{
  tags: ['isHidden'],
  parameters: {
    layout: 'centered'
  },
...
<ods-timepicker value="12:00" timezones="all" current-timezone="UTC+2"></ods-timepicker>
  \`
}`,...(O=(S=n.parameters)==null?void 0:S.docs)==null?void 0:O.source}}};var C,R,v;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-timepicker></ods-timepicker>
  \`
...
\${ValidityStateTemplate('timepicker', '#timepicker-validity-state-demo')}
  \`
}`,...(P=(M=u.parameters)==null?void 0:M.docs)==null?void 0:P.source}}};const K=["Demo","CustomCSS","Overview","Default","Disabled","Error","Readonly","Timezones","TimezonesCustom","WithSeconds","ValidityState"],ee=Object.freeze(Object.defineProperty({__proto__:null,CustomCSS:s,Default:i,Demo:a,Disabled:o,Error:l,Overview:n,Readonly:d,Timezones:m,TimezonesCustom:c,ValidityState:u,WithSeconds:p,__namedExportsOrder:K,default:J},Symbol.toStringTag,{value:"Module"}));export{s as C,i as D,l as E,n as O,d as R,ee as T,u as V,p as W,o as a,m as b,c};
