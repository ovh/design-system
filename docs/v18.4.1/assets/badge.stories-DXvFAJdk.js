import{O as e,a as b,b as z,c,d as i}from"./index-Dqa08QUn.js";import{x as a,o as T,C as s}from"./controls-DX883vx3.js";const M={title:"ODS Components/Badge",component:"ods-badge"},n={render:o=>a`
...
<ods-badge color="\${ODS_BADGE_COLOR.warning}" label="Warning"></ods-badge>
  \`
}`,...($=(A=t.parameters)==null?void 0:A.docs)==null?void 0:$.source}}};var G,f,B;l.parameters={...l.parameters,docs:{...(G=l.parameters)==null?void 0:G.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-badge class="my-badge" label="My badge"></ods-badge>
<style>
  ...
  \`
}`,...(B=(f=l.parameters)==null?void 0:f.docs)==null?void 0:B.source}}};var R,L,h;g.parameters={...g.parameters,docs:{...(R=g.parameters)==null?void 0:R.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
...
<ods-badge label="LG badge" size="\${ODS_BADGE_SIZE.lg}"></ods-badge>
  \`
}`,...(h=(L=g.parameters)==null?void 0:L.docs)==null?void 0:h.source}}};const N=["Demo","Overview","Default","Color","CustomCSS","Size"],x=Object.freeze(Object.defineProperty({__proto__:null,Color:t,CustomCSS:l,Default:r,Demo:n,Overview:d,Size:g,__namedExportsOrder:N,default:M},Symbol.toStringTag,{value:"Module"}));export{x as B,l as C,r as D,d as O,g as S,t as a};
