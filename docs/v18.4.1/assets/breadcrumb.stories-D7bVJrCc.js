import{x as e,o as x,C as I}from"./controls-DX883vx3.js";import{o as F}from"./unsafe-html-VJzuFJfF.js";var n=Object.freeze,j=Object.defineProperty,A=(r,c)=>n(j(r,"raw",{value:n(r.slice())})),i;const R={title:"ODS Components/Breadcrumb",component:"ods-breadcrumb",decorators:[r=>(setTimeout(()=>{document.querySelectorAll("ods-breadcrumb-item").forEach(c=>{c.removeAttribute("href")})},0),r())]},d={render:r=>e`
<ods-breadcrumb>
  ${F(r.items)}
</ods-breadcrumb>
  `,argTypes:x({items:{table:{category:I.slot,defaultValue:{summary:"ø"}},control:"text",description:"Set the <ods-breadcrumb-item> list"}}),args:{items:`<ods-breadcrumb-item href="#" icon="home">
</ods-breadcrumb-item>
...
<ods-breadcrumb>
  ...
  \`
}`,...(B=(E=t.parameters)==null?void 0:E.docs)==null?void 0:B.source}}};var P,D,w;o.parameters={...o.parameters,docs:{...(P=o.parameters)==null?void 0:P.docs,source:{originalSource:`{
  tags: ['isHidden'],
  parameters: {
    layout: 'centered'
  },
...
<ods-breadcrumb>
  ...
  \`
}`,...(w=(D=o.parameters)==null?void 0:D.docs)==null?void 0:w.source}}};const q=["Demo","ClickedItem","Collapsed","CustomCSS","CustomItem","Default","Overview"],M=Object.freeze(Object.defineProperty({__proto__:null,ClickedItem:m,Collapsed:a,CustomCSS:b,CustomItem:s,Default:t,Demo:d,Overview:o,__namedExportsOrder:q,default:R},Symbol.toStringTag,{value:"Module"}));export{M as B,b as C,t as D,o as O,a,m as b,s as c};
