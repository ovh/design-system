...
`,e.jsxs(n.p,{children:["Each ",e.jsx(n.strong,{children:"Range"})," thumb can be focused using ",e.jsx(n.code,{children:"Tabulation"}),", using ",e.jsx(n.code,{children:"Up"})," and ",e.jsx(n.code,{children:"Right"})," arrows increases its value, ",e.jsx(n.code,{children:"Down"})," and ",e.jsx(n.code,{children:"Left"})," keys decreases it."]})]})}function U(a={}){const{wrapper:n}={...l(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(o,{...a})}):o(a)}export{U as default};
