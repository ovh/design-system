import{j as e,M as r,C as c}from"./index-Rx6QkXSv.js";import{u as a}from"./index-DPrOAYpY.js";import{C as i,O as d}from"./checkbox.stories-BRa4Yq_O.js";import{B as h}from"./Banner-BpmhCXha.js";import{I as m,A as x,B as p}from"./IdentityCard-DzjZaQKX.js";import{H as s}from"./Heading-2XnXa8MH.js";import{S as o}from"./StorybookLink-YE2HEeNv.js";import"./iframe-HwRW2g_s.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DX_4BEHg.js";import"./index-DrFu-skq.js";import"./controls-DX883vx3.js";import"./validityState-BuENXwQ9.js";import"./index-Dqa08QUn.js";import"./index-BJiUJsri.js";function l(t){const n={code:"code",em:"em",img:"img",li:"li",ol:"ol",p:"p",span:"span",strong:"strong",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{of:i,name:"Documentation"}),`
`,e.jsx(h,{of:i}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Text"})," - Use this ",e.jsx(o,{kind:"ODS Components/Text",label:"Text",story:"Documentation"})," label to describe what the ",e.jsx(o,{kind:"ODS Components/Form elements/Radio",label:"Radio",story:"Documentation"})," is for."]}),`
`]}),`
...
`,e.jsx(p,{donts:[e.jsxs(n.span,{children:["- Avoid using Checkbox if only one item in list can be selected, prefer using ",e.jsx(o,{kind:"ODS Components/Form elements/Radio",label:"Radio",story:"Documentation"})," instead"]}),"- Truncate Checkbox label text with an ellipsis"],dos:["- Always use clear and concise labels for Checkbox","- Long labels may wrap to a second line, and this is preferable to truncation"]}),`
`,e.jsx(s,{label:"Placement",level:2}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.strong,{children:"Checkbox"})," can be autonomous, as it can be labelled in a starting/ending ",e.jsx(o,{kind:"ODS Components/Text",label:"Text",story:"Documentation"}),"."]}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Checkbox"})," can be focus through tabulation, and toggled using ",e.jsx(n.code,{children:"Space"})," and ",e.jsx(n.code,{children:"Enter"})," keys."]})]})}function R(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(l,{...t})}):l(t)}export{R as default};
