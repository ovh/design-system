import{x as t,o as W,C as n}from"./controls-DX883vx3.js";import{w as j,b as B,x as p,y as g,z as q}from"./index-Dqa08QUn.js";const J={title:"ODS Components/Link",component:"ods-link"},o={render:e=>t`
    <ods-link
      class="my-link-demo"
      color="${e.color}"
      download="${e.download}"
  ...
  `,argTypes:W({color:{table:{category:n.design,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"select",options:j},customCssLink:{table:{category:n.design,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text",description:'Set a custom style properties on the link. Example: "color: green; font-size: 32px;"'},customCssIcon:{table:{category:n.design,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text",description:'Set a custom style properties on the icon. Example: "width: 2rem; height: 2rem;"'},download:{table:{category:n.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},href:{table:{category:n.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},icon:{table:{category:n.general,type:{summary:"string"}},control:"select",options:B,description:"See the whole list [here](/?path=/docs/ods-components-icon--documentation#name)"},iconAlignment:{table:{category:n.general,defaultValue:{summary:p.right},type:{summary:g}},control:{type:"select"},options:g},isDisabled:{table:{category:n.general,defaultValue:{summary:"false"},type:{summary:"boolean"}},control:"boolean"},label:{table:{category:n.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},referrerpolicy:{table:{category:n.accessibility,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},rel:{table:{category:n.accessibility,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},target:{table:{category:n.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"}}),args:{color:q.primary,iconAlignment:p.right,isDisabled:!1,label:"my label"}},r={tags:["isHidden"],parameters:{layout:"centered"},render:()=>t`
...
<ods-link href="https://www.ovhcloud.com/" color="primary" label="Primary Color"></ods-link>
  \`
}`,...(S=(N=a.parameters)==null?void 0:N.docs)==null?void 0:S.source}}};var I,x,T;l.parameters={...l.parameters,docs:{...(I=l.parameters)==null?void 0:I.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-link href="https://www.ovhcloud.com/" is-disabled="false" label="Not Disabled"></ods-link>
<ods-link href="https://www.ovhcloud.com/" is-disabled label="Disabled"></ods-link>  \`
}`,...(T=(x=l.parameters)==null?void 0:x.docs)==null?void 0:T.source}}};var v,D,R;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
...
<style>
  ...
  \`
}`,...(P=(z=u.parameters)==null?void 0:z.docs)==null?void 0:P.source}}};const Q=["Demo","Overview","Default","Color","Disabled","WithLeftIcon","WithRightIcon","IconOnly","Target","CustomCSSLink"],Z=Object.freeze(Object.defineProperty({__proto__:null,Color:a,CustomCSSLink:u,Default:s,Demo:o,Disabled:l,IconOnly:d,Overview:r,Target:m,WithLeftIcon:i,WithRightIcon:c,__namedExportsOrder:Q,default:J},Symbol.toStringTag,{value:"Module"}));export{u as C,s as D,d as I,Z as L,r as O,m as T,i as W,a,l as b,c};
