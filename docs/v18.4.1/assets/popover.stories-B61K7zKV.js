import{H as l,I as u}from"./index-Dqa08QUn.js";import{x as t,o as V,C as p}from"./controls-DX883vx3.js";import{o as B}from"./unsafe-html-VJzuFJfF.js";var c=Object.freeze,N=Object.defineProperty,L=(o,Y)=>c(N(o,"raw",{value:c(o.slice())})),g;const $={title:"ODS Components/Popover",component:"ods-popover",parameters:{layout:"centered"},decorators:[o=>t`<div style="padding-top: 50px; display: inline-flex; align-content: center;">${o()}</div>`]},e={render:o=>t`
...
<ods-popover trigger-id="trigger-default">
  ...
  `},d={tags:["isHidden"],render:()=>t(g||(g=L([`
...
<ods-popover trigger-id="trigger-overview">
  ...
  \`
}`,...(H=(M=a.parameters)==null?void 0:M.docs)==null?void 0:H.source}}};var R,I,D;i.parameters={...i.parameters,docs:{...(R=i.parameters)==null?void 0:R.docs,source:{originalSource:`{
  tags: ['isHidden'],
...
<div style="display: flex;">
  ...
  \`
}`,...(D=(I=i.parameters)==null?void 0:I.docs)==null?void 0:D.source}}};const j=["Demo","ArrowTip","CustomCSS","Default","FixedContext","Overview","Menu"],z=Object.freeze(Object.defineProperty({__proto__:null,ArrowTip:n,CustomCSS:r,Default:s,Demo:e,FixedContext:d,Menu:i,Overview:a,__namedExportsOrder:j,default:$},Symbol.toStringTag,{value:"Module"}));export{n as A,r as C,s as D,d as F,i as M,a as O,z as P};
