import{x as a,o as J,C as t}from"./controls-DX883vx3.js";import{V as k}from"./validityState-BuENXwQ9.js";const K={title:"ODS Components/Form elements/Quantity",component:"ods-quantity"},n={render:e=>a`
...
\${ValidityStateTemplate('quantity', '#quantity-validity-state-demo')}
  \`
}`,...(P=(z=c.parameters)==null?void 0:z.docs)==null?void 0:P.source}}};const U=["Demo","Overview","Default","Disabled","Error","Readonly","Min","Max","Step","CustomCSS","ValidityState"],Z=Object.freeze(Object.defineProperty({__proto__:null,CustomCSS:y,Default:s,Demo:n,Disabled:o,Error:i,Max:d,Min:u,Overview:r,Readonly:l,Step:m,ValidityState:c,__namedExportsOrder:U,default:K},Symbol.toStringTag,{value:"Module"}));export{y as C,s as D,i as E,d as M,r as O,Z as Q,l as R,m as S,c as V,o as a,u as b};
