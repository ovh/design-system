import{x as a,o as ve,C as n}from"./controls-DX883vx3.js";import{V as Se}from"./validityState-BuENXwQ9.js";var D=Object.freeze,De=Object.defineProperty,r=(e,S)=>D(De(e,"raw",{value:D(e.slice())})),O,C,h,T,V,R;const Oe={component:"ods-range",title:"ODS Components/Form elements/Range",decorators:[e=>a`<div style="padding-top: 50px; display: flex; flex-direction: column; align-items: start;">${e()}</div>`]},t={render:e=>a`
    <ods-range
      class="my-range-demo"
...
${Se("range","#range-validity-state-demo")}
...
\${ValidityStateTemplate('range', '#range-validity-state-demo')}
  \`
}`,...(fe=(be=v.parameters)==null?void 0:be.docs)==null?void 0:fe.source}}};const Ce=["Demo","DemoDual","CustomCSS","Default","DefaultDual","Disabled","DisabledDual","Error","ErrorDual","Max","Min","Overview","Step","StepDual","ValidityState"],Ve=Object.freeze(Object.defineProperty({__proto__:null,CustomCSS:o,Default:l,DefaultDual:d,Demo:t,DemoDual:s,Disabled:i,DisabledDual:u,Error:m,ErrorDual:c,Max:g,Min:y,Overview:p,Step:b,StepDual:f,ValidityState:v,__namedExportsOrder:Ce,default:Oe},Symbol.toStringTag,{value:"Module"}));export{o as C,l as D,m as E,g as M,p as O,Ve as R,b as S,v as V,d as a,i as b,u as c,c as d,y as e,f};
