import{H as l,I as p}from"./index-Dqa08QUn.js";import{x as t,o as E,C as d}from"./controls-DX883vx3.js";import{o as P}from"./unsafe-html-VJzuFJfF.js";var c=Object.freeze,D=Object.defineProperty,H=(o,V)=>c(D(o,"raw",{value:c(o.slice())})),m;const N={title:"ODS Components/Tooltip",component:"ods-tooltip",parameters:{layout:"centered"},decorators:[o=>t`<div style="padding-top: 50px; display: inline-flex; align-items: center;">${o()}</div>`]},e={render:o=>t`
...
<ods-tooltip position="${o.position}"
  ...
  `,argTypes:E({content:{table:{category:d.slot,defaultValue:{summary:"ø"}},control:"text"},position:{table:{category:d.general,defaultValue:{summary:l.top},type:{summary:p}},control:{type:"select"},options:p},withArrow:{table:{category:d.design,defaultValue:{summary:!1}},control:{type:"boolean"}}}),args:{content:"Tooltip content",position:l.top,withArrow:!0}},n={tags:["isHidden"],parameters:{layout:"centered"},render:()=>t`
<ods-text preset="paragraph">Lorem ipsum &nbsp;</ods-text>
...
<style>
  ...
  `},a={tags:["isHidden"],render:()=>t(m||(m=H([`
...
<ods-tooltip trigger-id="trigger-5"
  ...
  \`
}`,...(f=(h=s.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};var L,C,I;i.parameters={...i.parameters,docs:{...(L=i.parameters)==null?void 0:L.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-text preset="paragraph">Lorem ipsum &nbsp;</ods-text>
<ods-icon id="trigger-3"
...
<style>
  ...
  \`
}`,...(I=(C=i.parameters)==null?void 0:C.docs)==null?void 0:I.source}}};var q,A,v;a.parameters={...a.parameters,docs:{...(q=a.parameters)==null?void 0:q.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-button id="modal-button"
            label="Open Modal">
...
<\/script>
  \`
}`,...(v=(A=a.parameters)==null?void 0:A.docs)==null?void 0:v.source}}};const R=["Demo","Overview","Default","ArrowTip","CustomCSS","FixedContext"],B=Object.freeze(Object.defineProperty({__proto__:null,ArrowTip:s,CustomCSS:i,Default:r,Demo:e,FixedContext:a,Overview:n,__namedExportsOrder:R,default:N},Symbol.toStringTag,{value:"Module"}));export{s as A,i as C,r as D,a as F,n as O,B as T};
