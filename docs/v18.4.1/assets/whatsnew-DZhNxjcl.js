import{j as e,M as c,d as o}from"./index-Rx6QkXSv.js";import{u as t}from"./index-DPrOAYpY.js";import{a as r}from"./index-BJiUJsri.js";import{H as s}from"./Heading-2XnXa8MH.js";import{S as l}from"./StorybookLink-YE2HEeNv.js";import"./iframe-HwRW2g_s.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DX_4BEHg.js";import"./index-DrFu-skq.js";import"./index-Dqa08QUn.js";function d(i){const n={blockquote:"blockquote",code:"code",li:"li",p:"p",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"OVHcloud Design System/What's new?/What's new"}),`
...
`,e.jsxs(n.p,{children:["We did integrate ",e.jsx(r,{href:"https://testing-library.com/docs/react-testing-library/intro",label:"react-testing-library",target:"_blank"}),`
...
`,e.jsxs(n.p,{children:["This version is focused on implementing ",e.jsx(r,{href:"https://developer.mozilla.org/en-US/docs/Web/API/ValidityState",label:"ValidityState",target:"_blank"})," to our form elements."]}),`
...
`,e.jsxs(n.p,{children:["Though you can of course use a lib on top of that if you want to. We've validated forms using native code (vanilla and React), ",e.jsx(r,{href:"https://formik.org",label:"Formik",target:"_blank"})," and ",e.jsx(r,{href:"https://react-hook-form.com",label:"React Hook Form",target:"_blank"})," on our tests and playgrounds."]}),`
...
`,e.jsxs(n.p,{children:["As it is a major version, you'll have to follow the ",e.jsx(l,{label:"migration guide 17.x to 18.x",title:"OVHcloud Design System/What's new?/Migration guide/17.x to 18.x"})]}),`
...
of the web-component shadow DOM, thanks to the `,e.jsx(r,{href:"https://developer.mozilla.org/en-US/docs/Web/CSS/::part",label:"part selector",target:"_blank"}),"."]}),`
...
`,e.jsx(o,{code:'<a class="my-link" ...>...</a>',dark:"true",language:"html"}),`
...
`,e.jsx(l,{kind:"ODS Components/Form elements/File Upload",label:"See Documentation",story:"Documentation"}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Timepicker"})}),`
`,e.jsx(l,{kind:"ODS Components/Form elements/Timepicker",label:"See Documentation",story:"Documentation"}),`
`,e.jsx(s,{label:"Component changes:",level:3}),`
`,e.jsxs(n.p,{children:["Please check the ",e.jsx(l,{label:"migration guide",title:"OVHcloud Design System/What's new?/Migration guide/17.x to 18.x"})," regarding all the component changes."]}),`
...
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Table"})}),`
`,e.jsx(l,{kind:"ODS Components/Table",label:"See Documentation",story:"Documentation"}),`
`,e.jsx(s,{label:"Documentation improvements:",level:3}),`
...
`,e.jsxs(n.p,{children:["As it is a major version, you'll have to follow the ",e.jsx(l,{label:"migration guide 16.x to 17.x",title:"OVHcloud Design System/What's new?/Migration guide/16.x to 17.x"})]}),`
`,e.jsx(s,{label:"Project changes:",level:3}),`
...
`]}),`
`,e.jsx(o,{code:'"ods-components": "17.0.0"',dark:"true",language:"text"}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["the updated ",e.jsx(l,{label:"Get Started documentation",title:"OVHcloud Design System/Get Started"})]}),`
`,e.jsxs(n.li,{children:["the 16.x to 17.x ",e.jsx(l,{label:"Migration guide",title:"OVHcloud Design System/What's new?/Migration guide/16.x to 17.x"})]}),`
`]}),`
`,e.jsx(s,{label:"Documentation improvements:",level:3}),`
...
`,e.jsx(l,{kind:"ODS Components/Medium",label:"See Documentation",story:"Documentation"}),`
`,e.jsx(s,{label:"Bug fixes:",level:3}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Phone number"})}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsx(s,{label:"New component:",level:3}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Datepicker"})}),`
`,e.jsx(l,{kind:"ODS Components/Form elements/Datepicker",label:"See Documentation",story:"Documentation"}),`
`,e.jsx(s,{label:"Component changes:",level:3}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Clipboard"})}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsx(s,{label:"New component:",level:3}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Phone Number"})}),`
`,e.jsx(l,{kind:"ODS Components/Form elements/Phone Number",label:"See Documentation",story:"Documentation"}),`
`,e.jsx(s,{label:"Component changes:",level:3}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Input"})}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsxs(n.p,{children:["As it is a major version, you'll have to follow the ",e.jsx(l,{label:"migration guide 15.x to 16.x",title:"OVHcloud Design System/What's new?/Migration guide/15.x to 16.x"})]}),`
...
`,e.jsx(s,{label:"New component:",level:3}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Clipboard"})}),`
`,e.jsx(l,{kind:"ODS Components/Clipboard",label:"See Documentation",story:"Documentation"}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Menu"})}),`
`,e.jsx(n.p,{children:"See documentation using version selector"}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Modal"})}),`
`,e.jsx(l,{kind:"ODS Components/Modal",label:"See Documentation",story:"Documentation"}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Search Bar"})}),`
`,e.jsx(n.p,{children:"See documentation using version selector"}),`
...
`,e.jsxs(n.p,{children:["As it is a major version, you have to do the ",e.jsx(l,{label:"migration guide 14.x to 15.x",title:"OVHcloud Design System/What's new?/Migration guide/14.x to 15.x"})]}),`
`,e.jsx(s,{label:"Project changes:",level:3}),`
...
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Form Field"})}),`
`,e.jsx(l,{kind:"ODS Components/Form elements/Form Field",label:"See Documentation",story:"Documentation"}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Switch"})}),`
`,e.jsx(l,{kind:"ODS Components/Form elements/Switch",label:"See Documentation",story:"Documentation"}),`
`,e.jsx(s,{label:"Features changes:",level:3}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Pagination"})}),`
...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["For more information, check our documentation ",e.jsx(l,{kind:"ODS Components/Pagination",label:"See Documentation",story:"Documentation"})]}),`
`]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
...
`,e.jsxs(n.p,{children:["As it is a major version, you have to do the ",e.jsx(l,{label:"migration guide 13.x to 14.x",title:"OVHcloud Design System/What's new?/Migration guide/13.x to 14.x"})]}),`
`,e.jsx(s,{label:"New features:",level:3}),`
`,e.jsx(n.p,{children:"We added the following components:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Progress Bar"}),": ",e.jsx(l,{kind:"ODS Components/Progress Bar",label:"See Documentation",story:"Documentation"})]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Popover"}),": ",e.jsx(l,{kind:"ODS Components/Popover",label:"See Documentation",story:"Documentation"})]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Tooltip"}),": ",e.jsx(l,{kind:"ODS Components/Tooltip",label:"See Documentation",story:"Documentation"})]}),`
`]}),`
`,e.jsx(n.p,{children:"Components version 2:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Input V2"}),": ",e.jsx(l,{kind:"ODS Components/Form elements/Input",label:"See Documentation",story:"Documentation"})]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Select V2"}),": it is now connected to our CDK and keyboard navigation has been added ",e.jsx(l,{kind:"ODS Components/Form elements/Select",label:"See Documentation",story:"Documentation"})]}),`
`]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Quantity"})," component accepts four digits in the input field:"]}),`
`,e.jsx(l,{kind:"ODS Components/Form elements/Quantity",label:"See Documentation",story:"Documentation"}),`
...
`,e.jsxs(n.p,{children:["As it is a major version, you have to do the ",e.jsx(l,{label:"migration guide 12.x to 13.x",title:"OVHcloud Design System/What's new?/Migration guide/12.x to 13.x"})]}),`
`,e.jsx(s,{label:"New features:",level:3}),`
`,e.jsx(n.p,{children:"We added the following components:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Breadcrumb: ",e.jsx(l,{kind:"ODS Components/Breadcrumb",label:"See Documentation",story:"Documentation"})]}),`
`,e.jsx(n.li,{children:"Collapsible: See Documentation using version selector"}),`
`,e.jsxs(n.li,{children:["Pagination: ",e.jsx(l,{kind:"ODS Components/Pagination",label:"See Documentation",story:"Documentation"})]}),`
`,e.jsxs(n.li,{children:["Spinner: ",e.jsx(l,{kind:"ODS Components/Spinner",label:"See Documentation",story:"Documentation"})]}),`
`]}),`
...
`,e.jsx(l,{kind:"ODS Components/Tabs",label:"See Documentation",story:"Documentation"}),`
...
For more details about assets, see `,e.jsx(l,{label:"Installation",title:"OVHcloud Design System/Get Started"}),` page.
...
`,e.jsxs(n.p,{children:["Before importing any component you now have to setup ods, for more details see ",e.jsx(l,{label:"migration guide 10.x to 11.x",title:"OVHcloud Design System/What's new?/Migration guide/10.x to 11.x"})]}),`
...
`,e.jsxs(n.p,{children:["As it is a major version, you have to do the ",e.jsx(l,{label:"migration guide 10.x to 11.x",title:"OVHcloud Design System/What's new?/Migration guide/10.x to 11.x"})]}),`
...
`,e.jsx(l,{kind:"ODS Components/Form elements/Select",label:"See Documentation",story:"Documentation"}),`
...
You can read the updated `,e.jsx(l,{label:"Getting Started",title:"OVHcloud Design System/Get Started"}),`
...
`,e.jsxs(n.p,{children:["As it is a major version, you have to do the ",e.jsx(l,{label:"migration guide 9.x to 10.x",title:"OVHcloud Design System/What's new?/Migration guide/9.x to 10.x"})]}),`
...
`]})]})}function f(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(d,{...i})}):d(i)}export{f as default};
