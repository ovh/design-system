import{j as e,M as d,C as h}from"./index-aSJOi-xY.js";import{u as l}from"./index-D_oymSD0.js";import{A as r,O as p}from"./accordion.stories-DK-tdzon.js";import{B as x}from"./Banner-DfBQCKAd.js";import{I as m,A as j,B as g}from"./IdentityCard-bFWvbFx8.js";import{H as t}from"./Heading-fUBW5LMg.js";import{S as o,O as s,a as i}from"./StorybookLink-CdkDDCl2.js";import"./iframe-Cjn0x15a.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DX_4BEHg.js";import"./index-DrFu-skq.js";import"./controls-DX883vx3.js";import"./unsafe-html-VJzuFJfF.js";import"./index-B1WyGMUD.js";import"./index-DduIf26o.js";function c(a){const n={code:"code",em:"em",img:"img",li:"li",ol:"ol",p:"p",span:"span",strong:"strong",ul:"ul",...l(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{of:r,name:"Documentation"}),`
`,e.jsx(x,{of:r}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Icon"}),': A "down/up" chevron ',e.jsx(o,{kind:s.icon,label:"Icon",story:i.documentation})," is used to indicate the “expand/collapse” action, though the entire header area is clickable (always visible)."]}),`
...
`,e.jsxs(n.p,{children:["The header part can be navigated through tabulation, with the same behavior as a ",e.jsx(o,{kind:s.button,label:"Button",story:i.documentation}),"."]}),`
...
`,e.jsxs(n.p,{children:["For screen readers, the user can know easily that the ",e.jsx(n.strong,{children:"Accordion"})," is opened or not, and therefore the inner content is readable or not."]})]})}function B(a={}){const{wrapper:n}={...l(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(c,{...a})}):c(a)}export{B as default};
