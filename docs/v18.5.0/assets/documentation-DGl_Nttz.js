import{j as n,M as d,C as h}from"./index-aSJOi-xY.js";import{u as c}from"./index-D_oymSD0.js";import{B as a,O as m}from"./button.stories-BEoRT4Zj.js";import{B as u}from"./Banner-DfBQCKAd.js";import{I as p,A as x,B as j}from"./IdentityCard-bFWvbFx8.js";import{H as t}from"./Heading-fUBW5LMg.js";import{S as i,O as o,a as r}from"./StorybookLink-CdkDDCl2.js";import"./iframe-Cjn0x15a.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DX_4BEHg.js";import"./index-DrFu-skq.js";import"./index-B1WyGMUD.js";import"./controls-DX883vx3.js";import"./index-DduIf26o.js";function l(s){const e={code:"code",em:"em",img:"img",li:"li",p:"p",span:"span",strong:"strong",ul:"ul",...c(),...s.components};return n.jsxs(n.Fragment,{children:[n.jsx(d,{of:a,name:"Documentation"}),`
`,n.jsx(u,{of:a}),`
`,n.jsx(e.p,{children:n.jsxs(e.em,{children:["A ",n.jsx(e.strong,{children:"Button"})," component aims to initiate an action. Its ",n.jsx(i,{kind:o.text,label:"Text",story:r.documentation})," indicates the related intent, its aspect describes the importance and influence level."]})}),`
...
`,n.jsxs(e.p,{children:[n.jsx(e.strong,{children:"Buttons"})," don't usually redirect to an external page. For that, see ",n.jsx(i,{kind:o.link,label:"Link",story:r.documentation}),"."]}),`
`,n.jsx(t,{label:"Dos & Don'ts",level:3}),`
`,n.jsx(j,{donts:[n.jsxs(e.span,{children:["- Use Buttons as ",n.jsx(i,{kind:o.link,label:"Link",story:r.documentation})," (using the ghost variant), prefer using the ",n.jsx(i,{kind:o.link,label:"Link",story:r.documentation})," component"]}),"- Put two identical Buttons side by side","- Use success/error variants for other needs than validation/cancel"],dos:["- Group a main with a secondary Button for page actions","- At least one primary Button must be present per page in order to present the main action"]}),`
...
`,n.jsxs(e.p,{children:["An ",n.jsx(i,{kind:o.icon,label:"Icon",story:r.documentation})," can be displayed on the left or right of the ",n.jsx(e.strong,{children:"Button"})," label content."]}),`
...
`,n.jsxs(e.p,{children:["When focusing the ",n.jsx(e.strong,{children:"Button"}),", pressing ",n.jsx(e.code,{children:"Enter"})," or ",n.jsx(e.code,{children:"Space"})," keys will trigger it."]})]})}function L(s={}){const{wrapper:e}={...c(),...s.components};return e?n.jsx(e,{...s,children:n.jsx(l,{...s})}):l(s)}export{L as default};
