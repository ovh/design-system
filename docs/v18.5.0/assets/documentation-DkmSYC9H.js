import{j as e,M as d,C as m}from"./index-aSJOi-xY.js";import{u as c}from"./index-D_oymSD0.js";import{B as o,O as h}from"./badge.stories-Yk7_okAa.js";import{B as u}from"./Banner-DfBQCKAd.js";import{I as x,A as j,B as p}from"./IdentityCard-bFWvbFx8.js";import{H as s}from"./Heading-fUBW5LMg.js";import{S as i,O as r,a}from"./StorybookLink-CdkDDCl2.js";import"./iframe-Cjn0x15a.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DX_4BEHg.js";import"./index-DrFu-skq.js";import"./index-B1WyGMUD.js";import"./controls-DX883vx3.js";import"./index-DduIf26o.js";function l(t){const n={a:"a",em:"em",img:"img",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...c(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{of:o,name:"Documentation"}),`
`,e.jsx(u,{of:o}),`
...
`,e.jsxs(n.li,{children:[e.jsx(i,{kind:r.icon,label:"Icon",story:a.documentation})," - (optional)"]}),`
...
`,e.jsx(p,{donts:["- Avoid using icon-only Badges."],dos:["- The label must be short and clear."]}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Badges"})," are read by screen readers as regular ",e.jsx(i,{kind:r.text,label:"Text",story:a.documentation}),"."]})]})}function L(t={}){const{wrapper:n}={...c(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(l,{...t})}):l(t)}export{L as default};
