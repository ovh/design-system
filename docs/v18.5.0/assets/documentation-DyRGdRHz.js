import{j as e,M as c,C as h}from"./index-aSJOi-xY.js";import{u as d}from"./index-D_oymSD0.js";import{M as l,O as m}from"./modal.stories-DhOG6ipg.js";import{B as x}from"./Banner-DfBQCKAd.js";import{I as p,A as g,B as u}from"./IdentityCard-bFWvbFx8.js";import{H as s}from"./Heading-fUBW5LMg.js";import{S as i,O as o,a as r}from"./StorybookLink-CdkDDCl2.js";import"./iframe-Cjn0x15a.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DX_4BEHg.js";import"./index-DrFu-skq.js";import"./index-B1WyGMUD.js";import"./controls-DX883vx3.js";import"./unsafe-html-VJzuFJfF.js";import"./index-DduIf26o.js";function a(t){const n={code:"code",em:"em",img:"img",li:"li",ol:"ol",p:"p",span:"span",strong:"strong",ul:"ul",...d(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{of:l,name:"Documentation"}),`
`,e.jsx(x,{of:l}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Content"})," container, filled with ",e.jsx(i,{kind:o.text,label:"Text",story:r.documentation})," or other read-only content, depending on the usage"]}),`
...
`,e.jsx(u,{donts:["- Trigger a Modal as a result of a first Modal actions","- Use a Modal if the informational content is very long within a Modal: consider alternatives if that is your case",e.jsxs(n.span,{children:["- Use a Modal only to notify users about a successful completion of their actions: use ",e.jsx(i,{kind:o.message,label:"Message",story:r.documentation})," component"]})],dos:["- Use a Modal to display information the user needs to respond to","- Use a Modal to ask a confirmation from the user before proceeding","- Use Modals sparingly since they are disruptive and stop users in their current task",e.jsxs(n.span,{children:["- Handle closing the Modal when the cancel action ",e.jsx(i,{kind:o.button,label:"Button",story:r.documentation})," is clicked"]}),"- Use scrolling only when it is absolutely needed"]}),`
...
`,e.jsxs(n.p,{children:["When necessary, depending on the viewport height and the ",e.jsx(n.strong,{children:"Modal"})," content, the user can scroll vertically with the header and the action ",e.jsx(i,{kind:o.button,label:"Button",story:r.documentation})," remaining in place."]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"Tabulation"})," allows to move forward, first to the closing icon, then through any focusable element in the ",e.jsx(n.strong,{children:"Modal"})," (e.g. action ",e.jsx(i,{kind:o.button,label:"Button",story:r.documentation}),")"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"Shift + Tab"})," allows the opposite way to move backward in focusing items"]}),`
`]}),`
`,e.jsxs(n.p,{children:["Focus is trapped inside the ",e.jsx(n.strong,{children:"Modal"})," scope and inner elements when active."]})]})}function I(t={}){const{wrapper:n}={...d(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(a,{...t})}):a(t)}export{I as default};
