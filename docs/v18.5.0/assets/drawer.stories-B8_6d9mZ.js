import{w as u,x as c}from"./index-B1WyGMUD.js";import{x as a,o as L,C as i}from"./controls-DX883vx3.js";import{o as k}from"./unsafe-html-VJzuFJfF.js";var l=Object.freeze,I=Object.defineProperty,d=(e,N)=>l(I(e,"raw",{value:l(e.slice())})),w,m,p,b,g;const A={title:"ODS Components/Drawer",component:"ods-drawer"},t={render:e=>a(w||(w=d([`
...
<\/script>`])),e.isOpen,e.position,k(e.content),e.customCss),argTypes:L({isOpen:{table:{category:i.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},position:{table:{category:i.general,defaultValue:{summary:u.left},type:{summary:c}},control:{type:"select"},options:c},content:{table:{category:i.slot,defaultValue:{summary:"ø"}},control:"text"},customCss:{table:{category:i.design,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text",description:'Set a custom style properties. Example: "height: 100px; background-color: #008000;"'}}),args:{content:`
    <div>
    ...
    </div>`,isOpen:!1,position:u.left}},r={tags:["isHidden"],parameters:{layout:"centered"},render:()=>a(m||(m=d([`
...
<\/script>
  \`
}`,...(x=(R=s.parameters)==null?void 0:R.docs)==null?void 0:x.source}}};const H=["Demo","Overview","Default","CustomCSS","Position"],Y=Object.freeze(Object.defineProperty({__proto__:null,CustomCSS:n,Default:o,Demo:t,Overview:r,Position:s,__namedExportsOrder:H,default:A},Symbol.toStringTag,{value:"Module"}));export{n as C,Y as D,r as O,s as P,o as a};
