import{j as e,M as d,d as c}from"./index-aSJOi-xY.js";import{u as a}from"./index-D_oymSD0.js";import{a as s}from"./index-DduIf26o.js";import{H as o}from"./Heading-fUBW5LMg.js";import{S as i,H as r}from"./StorybookLink-CdkDDCl2.js";import"./iframe-Cjn0x15a.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DX_4BEHg.js";import"./index-DrFu-skq.js";import"./index-B1WyGMUD.js";function l(t){const n={a:"a",code:"code",em:"em",p:"p",...a(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"OVHcloud Design System/F.A.Q."}),`
...
`,e.jsx(n.p,{children:e.jsxs(n.em,{children:["Example here with the ",e.jsx(n.a,{href:"?path=/docs/ods-components-accordion--technical-information#style-customization",children:e.jsx(s,{label:"Accordion component"})}),"."]})}),`
...
`,e.jsxs(n.p,{children:["For detailed instructions on importing ESModule or CommonJS packages, please refer to our ",e.jsx(i,{label:"Get Started",title:r.getStarted})," documentation."]}),`
`,e.jsx(o,{label:"How can I import ODS CSS-only styling?",level:2}),`
`,e.jsxs(n.p,{children:["To import ODS CSS-only styling, please refer to our ",e.jsx(i,{label:"Get Started",title:r.getStarted})," documentation."]}),`
...
`,e.jsxs(n.p,{children:[e.jsx(s,{href:"https://github.com/facebook/react/issues/9230?fbclid=IwAR1VhQVMpSy3VkGWCOjpwO60y6PxXJOcwdvE88AX1TjBxDaHfwsfHJYeOJU#issuecomment-1094149596",label:"Issue Source",target:"_blank"}),"."]})]})}function w(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(l,{...t})}):l(t)}export{w as default};
