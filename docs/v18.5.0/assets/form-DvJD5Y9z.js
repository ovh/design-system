import{j as e,M as d,T as c,d as a}from"./index-aSJOi-xY.js";import{u as i}from"./index-D_oymSD0.js";import{a as n,b as h,c as s,d as m}from"./index-DduIf26o.js";import{H as o}from"./Heading-fUBW5LMg.js";import"./iframe-Cjn0x15a.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DX_4BEHg.js";import"./index-DrFu-skq.js";import"./index-B1WyGMUD.js";function r(l){const t={code:"code",li:"li",p:"p",ul:"ul",...i(),...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"OVHcloud Design System/Guides/Handling Form"}),`
...
`,e.jsxs(t.p,{children:[e.jsx(s,{name:"xmark",style:{color:"var(--ods-color-critical-500)"}})," The following will cause unexpected behaviour as the ",e.jsx(t.code,{children:"value"}),` will get updated twice, back to its original state,
...
`,e.jsxs(t.p,{children:[e.jsx(s,{name:"check",style:{color:"var(--ods-color-success-500)"}})," To manage this double usage, it's best to separate your local state from the component and update it only on ",e.jsx(t.code,{children:"odsChange"})," event, like:"]}),`
`,e.jsx(a,{code:`
const [isToggled, setIsToggled] = useState(true);
...
`,e.jsx(m,{color:"information",isDismissible:!1,children:e.jsxs("span",{children:[`Those are simple examples to demonstrate how ODS components could be used in different context.
...
`,dark:"true",language:"tsx"})]})}function w(l={}){const{wrapper:t}={...i(),...l.components};return t?e.jsx(t,{...l,children:e.jsx(r,{...l})}):r(l)}export{w as default};
