import{x as t,o as J,C as n}from"./controls-DX883vx3.js";import{y as Q,b as U,z as y,A as g,B as X}from"./index-B1WyGMUD.js";const Z={title:"ODS Components/Link",component:"ods-link"},s={render:e=>t`
    <ods-link
      class="my-link-demo"
      color="${e.color}"
      download="${e.download}"
  ...
  `,argTypes:J({color:{table:{category:n.design,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"select",options:Q},customCssLink:{table:{category:n.design,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text",description:'Set a custom style properties on the link. Example: "color: green; font-size: 32px;"'},customCssIcon:{table:{category:n.design,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text",description:'Set a custom style properties on the icon. Example: "width: 2rem; height: 2rem;"'},customCssLabel:{table:{category:n.design,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text",description:'Set a custom style properties on the label. Example: "overflow: auto; text-overflow: inherit; white-space: break-spaces;"'},download:{table:{category:n.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},href:{table:{category:n.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},icon:{table:{category:n.general,type:{summary:"string"}},control:"select",options:U,description:"See the whole list [here](/?path=/docs/ods-components-icon--documentation#name)"},iconAlignment:{table:{category:n.general,defaultValue:{summary:y.right},type:{summary:g}},control:{type:"select"},options:g},isDisabled:{table:{category:n.general,defaultValue:{summary:"false"},type:{summary:"boolean"}},control:"boolean"},label:{table:{category:n.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},referrerpolicy:{table:{category:n.accessibility,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},rel:{table:{category:n.accessibility,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},target:{table:{category:n.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"}}),args:{color:X.primary,iconAlignment:y.right,isDisabled:!1,label:"my label"}},l={tags:["isHidden"],parameters:{layout:"centered"},render:()=>t`
...
}`,...(v=(I=a.parameters)==null?void 0:I.docs)==null?void 0:v.source}}};var R,D,E;i.parameters={...i.parameters,docs:{...(R=i.parameters)==null?void 0:R.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-link id="link-ellipsis" class="my-link-ellipsis" href="test" label="link ellipsis" target="_blank">
</ods-link>
...
\`
}`,...(E=(D=i.parameters)==null?void 0:D.docs)==null?void 0:E.source}}};var A,$,V;c.parameters={...c.parameters,docs:{...(A=c.parameters)==null?void 0:A.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
...
<ods-link href="https://www.ovhcloud.com/" target="_top" label="Top target"></ods-link>
  ...
  \`
}`,...(W=(P=p.parameters)==null?void 0:P.docs)==null?void 0:W.source}}};var B,j,q;u.parameters={...u.parameters,docs:{...(B=u.parameters)==null?void 0:B.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-link class="my-link" href="https://www.ovhcloud.com/" label="Content"></ods-link>
...
<style>
  ...
  \`
}`,...(q=(j=u.parameters)==null?void 0:j.docs)==null?void 0:q.source}}};const ee=["Demo","Overview","Default","Color","Disabled","Ellipsis","WithLeftIcon","WithRightIcon","IconOnly","Target","CustomCSSLink"],se=Object.freeze(Object.defineProperty({__proto__:null,Color:r,CustomCSSLink:u,Default:o,Demo:s,Disabled:a,Ellipsis:i,IconOnly:m,Overview:l,Target:p,WithLeftIcon:c,WithRightIcon:d,__namedExportsOrder:ee,default:Z},Symbol.toStringTag,{value:"Module"}));export{u as C,o as D,i as E,m as I,se as L,l as O,p as T,c as W,r as a,a as b,d as c};
