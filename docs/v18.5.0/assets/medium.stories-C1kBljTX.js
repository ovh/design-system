...
<ods-medium alt="\${exampleAlt}" src="\${exampleSrc}"></ods-medium>
  \`
}`,...(O=(h=a.parameters)==null?void 0:h.docs)==null?void 0:O.source}}};var x,b,_;t.parameters={...t.parameters,docs:{...(x=t.parameters)==null?void 0:x.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-medium alt="\${exampleAlt}" src="\${exampleSrc}" height="200"></ods-medium>
  \`
}`,...(_=(b=t.parameters)==null?void 0:b.docs)==null?void 0:_.source}}};var f,$,S;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-medium alt="\${exampleAlt}" src="\${exampleSrc}" width="300"></ods-medium>
  \`
}`,...(S=($=n.parameters)==null?void 0:$.docs)==null?void 0:S.source}}};const H=["Demo","Overview","Default","Height","Width"],A=Object.freeze(Object.defineProperty({__proto__:null,Default:a,Demo:e,Height:t,Overview:r,Width:n,__namedExportsOrder:H,default:T},Symbol.toStringTag,{value:"Module"}));export{a as D,t as H,A as M,r as O,n as W};
