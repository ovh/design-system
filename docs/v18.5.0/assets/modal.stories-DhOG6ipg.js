import{a2 as c,a3 as p}from"./index-B1WyGMUD.js";import{x as e,o as F,C as s}from"./controls-DX883vx3.js";import{o as u}from"./unsafe-html-VJzuFJfF.js";const P=()=>{const o=document.querySelector("#storybook-root");o&&(o.innerHTML="")},B=o=>(P(),o());var b=Object.freeze,I=Object.defineProperty,t=(o,Q)=>b(I(o,"raw",{value:b(o.slice())})),g,L,y,q,C,S,x;const J={title:"ODS Components/Modal",component:"ods-modal",decorators:[B]},i={render:o=>e(g||(g=t([`
...
<\/script>
  `])),o.isOpen,o.isDismissible,o.color,u(o.content),u(o.actions),u(o.customCss)),argTypes:F({isOpen:{table:{category:s.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isDismissible:{table:{category:s.general,defaultValue:{summary:!0},type:{summary:"boolean"}},control:"boolean"},color:{table:{category:s.design,defaultValue:{summary:c.information},type:{summary:p}},control:{type:"select"},options:p},content:{table:{category:s.slot,defaultValue:{summary:"ø"}},control:"text"},actions:{table:{category:s.slot,defaultValue:{summary:"ø"}},control:"text"},customCss:{table:{category:s.design,defaultValue:{summary:"ø"}},control:"text",description:'Set a custom style properties. Example: "ods-modal::part(dialog) { border: 1px red solid; }"'}}),args:{isOpen:!1,isDismissible:!0,color:c.information,content:`<ods-text preset="heading-4" class="my-text">Hello, world!</ods-text>
...
<style>
  ...
  `])))};var O,v,D;i.parameters={...i.parameters,docs:{...(O=i.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: args => html\`
<ods-button class="button-demo" label="Trigger Modal"></ods-button>
...
}`,...(D=(v=i.parameters)==null?void 0:v.docs)==null?void 0:D.source}}};var f,_,T;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:`{
  tags: ['isHidden'],
  parameters: {
    layout: 'centered'
  },
...
<style>
  ...
  \`
}`,...(H=(k=r.parameters)==null?void 0:k.docs)==null?void 0:H.source}}};var V,Y,G;l.parameters={...l.parameters,docs:{...(V=l.parameters)==null?void 0:V.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-button class="button-color" label="Trigger Modal">
</ods-button>
...
<\/script>
  \`
}`,...(G=(Y=l.parameters)==null?void 0:Y.docs)==null?void 0:G.source}}};var $,j,z;m.parameters={...m.parameters,docs:{...($=m.parameters)==null?void 0:$.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-button class="button-actions" label="Trigger Modal">
</ods-button>
...
<style>
  ...
  \`
}`,...(z=(j=m.parameters)==null?void 0:j.docs)==null?void 0:z.source}}};const K=["Demo","Overview","Default","CustomCSS","NotDismissible","Color","Actions"],Z=Object.freeze(Object.defineProperty({__proto__:null,Actions:m,Color:l,CustomCSS:a,Default:d,Demo:i,NotDismissible:r,Overview:n,__namedExportsOrder:K,default:J},Symbol.toStringTag,{value:"Module"}));export{m as A,a as C,d as D,Z as M,r as N,n as O,l as a};
