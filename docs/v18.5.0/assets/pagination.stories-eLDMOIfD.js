import{G as M,H as B}from"./index-B1WyGMUD.js";import{C as a,x as t,o as Y}from"./controls-DX883vx3.js";const F={title:"ODS Components/Pagination",component:"ods-pagination"},q={defaultCurrentPage:{table:{category:a.general,defaultValue:{summary:4},type:{summary:"number"}},control:"number"},isDisabled:{table:{category:a.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},labelTooltipPrevious:{table:{category:a.general,defaultValue:{summary:"Previous label"},type:{summary:"string"}},control:"text"},labelTooltipNext:{table:{category:a.general,defaultValue:{summary:"Next label"},type:{summary:"string"}},control:"text"}},J={defaultItemsPerPage:{table:{category:a.general,defaultValue:{summary:M.option_10},type:{summary:"number"}},control:"select",options:B},totalItems:{table:{category:a.general,defaultValue:{summary:60},type:{summary:"number"}},control:"number"},beforeTotalItems:{table:{category:a.slot,defaultValue:{summary:"of "},type:{summary:"string"}},control:"text"},afterTotalItems:{table:{category:a.slot,defaultValue:{summary:" results"},type:{summary:"string"}},control:"text"}},K={totalPages:{table:{category:a.general,defaultValue:{summary:9},type:{summary:"number"}},control:"number"}},o={render:e=>t`
    <ods-pagination
  ...
  `,argTypes:Y({...q,...K}),args:{defaultCurrentPage:4,isDisabled:!1,labelTooltipPrevious:"Previous label",labelTooltipNext:"Next label",totalPages:9}},s={render:e=>t`
    <ods-pagination
      default-current-page="${e.defaultCurrentPage}"
  ...
  `,argTypes:Y({...q,...J}),args:{defaultCurrentPage:4,defaultItemsPerPage:M.option_10,isDisabled:!1,labelTooltipPrevious:"Previous label",labelTooltipNext:"Next label",totalItems:60,beforeTotalItems:"of ",afterTotalItems:" results"}},r={tags:["isHidden"],parameters:{layout:"centered"},render:()=>t`
    <ods-pagination
  ...
  \`
}`,...(z=(w=g.parameters)==null?void 0:w.docs)==null?void 0:z.source}}};const Q=["Demo","TotalItems","Overview","Default","DefaultLargeAmountOfPages","Disabled","WithTooltips","WithTotalItems","WithTotalItemsWithLabels","CustomCSS"],Z=Object.freeze(Object.defineProperty({__proto__:null,CustomCSS:g,Default:n,DefaultLargeAmountOfPages:l,Demo:o,Disabled:i,Overview:r,TotalItems:s,WithTooltips:p,WithTotalItems:d,WithTotalItemsWithLabels:u,__namedExportsOrder:Q,default:F},Symbol.toStringTag,{value:"Module"}));export{l as D,r as O,Z as P,p as W,n as a,i as b,d as c,u as d};
