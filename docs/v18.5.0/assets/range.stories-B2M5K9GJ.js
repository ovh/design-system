import{x as n,o as Ee,C as a}from"./controls-DX883vx3.js";import{V as O}from"./validityState-BuENXwQ9.js";var T=Object.freeze,xe=Object.defineProperty,r=(e,ke)=>T(xe(e,"raw",{value:T(e.slice())})),C,h,R,E,x,V;const Ve={component:"ods-range",title:"ODS Components/Form elements/Range",decorators:[e=>n`<div style="padding-top: 50px; display: flex; flex-direction: column; align-items: start;">${e()}</div>`]},s={render:e=>n`
    <ods-range
      class="my-range-demo"
...
}`,...($=(k=s.parameters)==null?void 0:k.docs)==null?void 0:$.source}}};var q,H,A;t.parameters={...t.parameters,docs:{...(q=t.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: arg => {
    return html\`
    <ods-range
      class="my-range-dual-demo"
...
<ods-range ticks="[25,50,75]" value="55"></ods-range>
  \`
}`,...(Se=(De=D.parameters)==null?void 0:De.docs)==null?void 0:Se.source}}};var ve,Oe,Te;S.parameters={...S.parameters,docs:{...(ve=S.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-range ticks="[0,25,50,75,100]" id="range-dual-ticks"></ods-range>
<script>
...
<\/script>
  \`
}`,...(Te=(Oe=S.parameters)==null?void 0:Oe.docs)==null?void 0:Te.source}}};var Ce,he,Re;v.parameters={...v.parameters,docs:{...(Ce=v.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-range is-required id="range-validity-state-demo">
</ods-range>
\${ValidityStateTemplate('range', '#range-validity-state-demo')}
  \`
}`,...(Re=(he=v.parameters)==null?void 0:he.docs)==null?void 0:Re.source}}};const _e=["Demo","DemoDual","CustomCSS","Default","DefaultDual","Disabled","DisabledDual","Error","ErrorDual","Max","Min","Overview","Step","StepDual","Ticks","TicksDual","ValidityState"],He=Object.freeze(Object.defineProperty({__proto__:null,CustomCSS:o,Default:l,DefaultDual:d,Demo:s,DemoDual:t,Disabled:u,DisabledDual:m,Error:i,ErrorDual:c,Max:g,Min:y,Overview:p,Step:b,StepDual:f,Ticks:D,TicksDual:S,ValidityState:v,__namedExportsOrder:_e,default:Ve},Symbol.toStringTag,{value:"Module"}));export{o as C,l as D,i as E,g as M,p as O,He as R,b as S,D as T,v as V,d as a,u as b,m as c,c as d,y as e,f,S as g};
