import{S as c,T as b,U as i,V as u}from"./index-B1WyGMUD.js";import{x as a,o as z,C as m}from"./controls-DX883vx3.js";import{o as e}from"./unsafe-html-VJzuFJfF.js";const B={title:"ODS Components/Table",component:"ods-table"},t=`<table>
  <caption>
...
\${unsafeHTML(exampleTable)}
  ...
  \`
}`,...(H=(v=d.parameters)==null?void 0:v.docs)==null?void 0:H.source}}};var x,C,V;l.parameters={...l.parameters,docs:{...(x=l.parameters)==null?void 0:x.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-table>
\${unsafeHTML(odsTextCaptionTable)}
  ...
  \`
}`,...(V=(C=l.parameters)==null?void 0:C.docs)==null?void 0:V.source}}};const R=["Demo","Overview","Default","Size","Variant","Caption"],Z=Object.freeze(Object.defineProperty({__proto__:null,Caption:l,Default:r,Demo:s,Overview:n,Size:o,Variant:d,__namedExportsOrder:R,default:B},Symbol.toStringTag,{value:"Module"}));export{l as C,r as D,n as O,o as S,Z as T,d as V};
