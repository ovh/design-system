...
`,e.jsxs(t.p,{children:["It works exactly the same as the one from the native ",e.jsx(c,{href:"https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/accept",label:"input file",target:"_blank"}),"."]}),`
...
`,e.jsx(n,{of:g,sourceState:"shown"})]})}function P(a={}){const{wrapper:t}={...d(),...a.components};return t?e.jsx(t,{...a,children:e.jsx(r,{...a})}):r(a)}export{P as default};
