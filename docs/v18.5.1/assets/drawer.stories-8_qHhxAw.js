import{G as u,H as c}from"./index-DCBH0_Tl.js";import{d as L}from"./ods-drawer2-DsENZFv4.js";import{x as a,o as k,C as i}from"./controls-DX883vx3.js";import{o as H}from"./unsafe-html-VJzuFJfF.js";const I=L;var l=Object.freeze,A=Object.defineProperty,d=(e,G)=>l(A(e,"raw",{value:l(e.slice())})),m,w,p,b,g;I();const N={title:"ODS Components/Drawer",component:"ods-drawer"},t={render:e=>a(m||(m=d([`
...
<\/script>`])),e.isOpen,e.position,H(e.content),e.customCss),argTypes:k({isOpen:{table:{category:i.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},position:{table:{category:i.general,defaultValue:{summary:u.left},type:{summary:c}},control:{type:"select"},options:c},content:{table:{category:i.slot,defaultValue:{summary:"ø"}},control:"text"},customCss:{table:{category:i.design,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text",description:'Set a custom style properties. Example: "height: 100px; background-color: #008000;"'}}),args:{content:`
    <div>
