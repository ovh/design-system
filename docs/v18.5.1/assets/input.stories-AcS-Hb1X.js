import{_ as Oe,$ as C}from"./index-DCBH0_Tl.js";import{d as Ce}from"./ods-input2-B9cw61K_.js";import{E as ve}from"./lit-html-DJdeL0_A.js";import{x as a,T as t,o as Te,C as n}from"./controls-DX883vx3.js";import{V as fe}from"./validityState-BuENXwQ9.js";const Re=Ce;/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Se=e=>e??ve;var v=Object.freeze,Ee=Object.defineProperty,Ve=(e,he)=>v(Ee(e,"raw",{value:v(he||e.slice())})),T;Re();const Le={title:"ODS Components/Form elements/Input",component:"ods-input"},r={render:e=>a`
...
<ods-input placeholder="Placeholder">
  ...
  `},b={tags:["isHidden"],render:()=>a(T||(T=Ve([`
...
\${ValidityStateTemplate('input', '#input-validity-state-demo')}
  \`
}`,...(be=(ge=O.parameters)==null?void 0:ge.docs)==null?void 0:be.source}}};const _e=["Demo","Overview","Default","Disabled","Error","Clearable","Loading","Masked","Readonly","Search","StepAny","Placeholder","Pattern","CustomCSS","Datalist","ValidityState"],Ye=Object.freeze(Object.defineProperty({__proto__:null,Clearable:d,CustomCSS:f,Datalist:h,Default:o,Demo:r,Disabled:l,Error:i,Loading:u,Masked:m,Overview:s,Pattern:b,Placeholder:g,Readonly:p,Search:c,StepAny:y,ValidityState:O,__namedExportsOrder:_e,default:Le},Symbol.toStringTag,{value:"Module"}));export{f as C,o as D,i as E,Ye as I,u as L,m as M,s as O,b as P,p as R,c as S,O as V,d as a,l as b,g as c,y as d,h as e};
