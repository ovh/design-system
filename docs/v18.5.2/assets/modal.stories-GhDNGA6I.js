...
<style>
  ...
  `])))},r={tags:["isHidden"],render:()=>e(x||(x=t([`
...
<\/script>
  `])),b.critical)},m={tags:["isHidden"],render:()=>e(S||(S=t([`
...
<style>
  ...
  `])))};var w,h,k;n.parameters={...n.parameters,docs:{...(w=n.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: args => html\`
<ods-button class="button-demo" label="Trigger Modal"></ods-button>
...
}`,...(k=(h=n.parameters)==null?void 0:h.docs)==null?void 0:k.source}}};var _,T,M;i.parameters={...i.parameters,docs:{...(_=i.parameters)==null?void 0:_.docs,source:{originalSource:`{
  tags: ['isHidden'],
  parameters: {
    layout: 'centered'
  },
