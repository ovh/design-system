import{D as h,E as he,F as De}from"./index-BLVG44ao.js";import{d as Ce}from"./ods-datepicker2-CijAhCPy.js";import{x as a,T as O,o as Se,C as r}from"./controls-DX883vx3.js";import{V as Oe}from"./validityState-BuENXwQ9.js";const ve=Ce;var D=Object.freeze,Re=Object.defineProperty,t=(e,Te)=>D(Re(e,"raw",{value:D(e.slice())})),C,S,v,R,L,E;ve();const Le={title:"ODS Components/Form elements/Datepicker",component:"ods-datepicker",decorators:[e=>a`<div style="height: 320px;">${e()}</div>`]},n={render:e=>a`
    ...
    `,argTypes:Se({ariaLabel:{table:{category:r.accessibility,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},ariaLabelledby:{table:{category:r.accessibility,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},format:{table:{category:r.general,defaultValue:{summary:"dd/mm/yyyy"},type:{summary:"string"}},control:"text"},hasError:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isClearable:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isDisabled:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isLoading:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isReadonly:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},isRequired:{table:{category:r.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},locale:{table:{category:r.general,defaultValue:{summary:he.en},type:{summary:"OdsDatepickerLocale"}},control:{type:"select"},options:De},max:{table:{category:r.general,defaultValue:{summary:"ø"},type:{summary:"Date"}},control:"date"},min:{table:{category:r.general,defaultValue:{summary:"ø"},type:{summary:"Date"}},control:"date"},placeholder:{table:{category:r.general,defaultValue:{summary:"ø"},type:{summary:"string"}},control:"text"},validityState:{table:{category:r.validation,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean",description:"Toggle this to see the component validityState"}}),args:{hasError:!1,isClearable:!1,isDisabled:!1,isLoading:!1,isReadonly:!1,isRequired:!1,validityState:!1}},s={tags:["isHidden"],render:()=>a`
<ods-datepicker is-clearable>
</ods-datepicker>
  `},d={tags:["isHidden"],render:()=>a(C||(C=t([`
