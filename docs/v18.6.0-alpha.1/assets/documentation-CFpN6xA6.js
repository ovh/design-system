...
title or `,e.jsx(s,{kind:r.text,label:"Text",story:o.documentation})," they complete."]})}),`
...
`,e.jsxs(n.li,{children:[e.jsx(s,{kind:r.icon,label:"Icon",story:o.documentation})," - (optional)"]}),`
...
`,e.jsxs(n.p,{children:["The notification status can be used next to a menu entry, a label or an option ; in dashboards, ",e.jsx(s,{kind:r.table,label:"Table",story:o.documentation})," or summary panels."]}),`
...
`,e.jsx(j,{donts:["- Avoid using icon-only Badges."],dos:["- The label must be short and clear."]}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Badges"})," are read by screen readers as regular ",e.jsx(s,{kind:r.text,label:"Text",story:o.documentation}),"."]})]})}function Me(i={}){const{wrapper:n}={...c(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(l,{...i})}):l(i)}export{Me as default};
