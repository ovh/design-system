import{K,L as q}from"./index-BLVG44ao.js";import{d as B}from"./ods-pagination2-shUGU0gB.js";import{C as a,x as t,o as M}from"./controls-DX883vx3.js";const F=B;F();const J={title:"ODS Components/Pagination",component:"ods-pagination"},Y={defaultCurrentPage:{table:{category:a.general,defaultValue:{summary:4},type:{summary:"number"}},control:"number"},isDisabled:{table:{category:a.general,defaultValue:{summary:!1},type:{summary:"boolean"}},control:"boolean"},labelTooltipPrevious:{table:{category:a.general,defaultValue:{summary:"Previous label"},type:{summary:"string"}},control:"text"},labelTooltipNext:{table:{category:a.general,defaultValue:{summary:"Next label"},type:{summary:"string"}},control:"text"}},Q={defaultItemsPerPage:{table:{category:a.general,defaultValue:{summary:K.option_10},type:{summary:"number"}},control:"select",options:q},totalItems:{table:{category:a.general,defaultValue:{summary:60},type:{summary:"number"}},control:"number"},beforeTotalItems:{table:{category:a.slot,defaultValue:{summary:"of "},type:{summary:"string"}},control:"text"},afterTotalItems:{table:{category:a.slot,defaultValue:{summary:" results"},type:{summary:"string"}},control:"text"}},U={totalPages:{table:{category:a.general,defaultValue:{summary:9},type:{summary:"number"}},control:"number"}},o={render:e=>t`
    <ods-pagination
  ...
  `,argTypes:M({...Y,...Q}),args:{defaultCurrentPage:4,defaultItemsPerPage:K.option_10,isDisabled:!1,labelTooltipPrevious:"Previous label",labelTooltipNext:"Next label",totalItems:60,beforeTotalItems:"of ",afterTotalItems:" results"}},r={tags:["isHidden"],parameters:{layout:"centered"},render:()=>t`
    <ods-pagination
