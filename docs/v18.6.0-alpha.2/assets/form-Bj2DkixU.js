...
`,e.jsxs(t.p,{children:[e.jsx(r,{"aria-label":"The wrong way",name:"xmark",style:{color:"var(--ods-color-critical-500)"}})," The following will cause unexpected behaviour as the ",e.jsx(t.code,{children:"value"}),` will get updated twice, back to its original state,
...
`,e.jsxs(t.p,{children:[e.jsx(r,{"aria-label":"The right way",name:"check",style:{color:"var(--ods-color-success-500)"}})," To manage this double usage, it's best to separate your local state from the component and update it only on ",e.jsx(t.code,{children:"odsChange"})," event, like:"]}),`
`,e.jsx(a,{code:`
const [isToggled, setIsToggled] = useState(true);
...
`,dark:"true",language:"tsx"})]})}function ye(l={}){const{wrapper:t}={...s(),...l.components};return t?e.jsx(t,{...l,children:e.jsx(i,{...l})}):i(l)}export{ye as default};
