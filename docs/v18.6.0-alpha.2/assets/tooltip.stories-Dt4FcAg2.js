...
<style>
  ...
  `},a={tags:["isHidden"],render:()=>o(m||(m=N([`
...
<ods-tooltip trigger-id="trigger-5"
  ...
  \`
}`,...(h=(_=i.parameters)==null?void 0:_.docs)==null?void 0:h.source}}};var C,L,v;s.parameters={...s.parameters,docs:{...(C=s.parameters)==null?void 0:C.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-text preset="paragraph">Lorem ipsum &nbsp;</ods-text>
<ods-icon id="trigger-3"
...
<style>
  ...
  \`
}`,...(v=(L=s.parameters)==null?void 0:L.docs)==null?void 0:v.source}}};var q,I,A;a.parameters={...a.parameters,docs:{...(q=a.parameters)==null?void 0:q.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-button id="modal-button"
            label="Open Modal">
...
<\/script>
  \`
}`,...(A=(I=a.parameters)==null?void 0:I.docs)==null?void 0:A.source}}};const $=["Demo","Overview","Default","ArrowTip","CustomCSS","FixedContext"],M=Object.freeze(Object.defineProperty({__proto__:null,ArrowTip:i,CustomCSS:s,Default:r,Demo:e,FixedContext:a,Overview:n,__namedExportsOrder:$,default:V},Symbol.toStringTag,{value:"Module"}));export{i as A,s as C,r as D,a as F,n as O,M as T};
