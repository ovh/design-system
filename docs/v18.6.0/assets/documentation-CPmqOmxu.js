import{j as e,M as c,C as h}from"./index-BZrH9CGX.js";import{u as d}from"./index-dt1nTXy9.js";import{M as l,O as m}from"./modal.stories-Cg3ok9rl.js";import{B as p}from"./Banner-DiaRo2C-.js";import{I as x,A as g,B as u}from"./IdentityCard-Bru_VIsl.js";import{H as t}from"./Heading-CyUtHF9O.js";import{S as s,O as o,a as r}from"./StorybookLink-CftdUnI_.js";import"./iframe-B8AsNC2M.js";import"../sb-preview/runtime.js";import"./index-8AfNH5n5.js";import"./index-D-8MO0q_.js";import"./index-DrFu-skq.js";import"./index-DZK8KyWG.js";import"./ods-modal2-BQO4yvXA.js";import"./index-DAZhnxgO.js";import"./ods-button2-dPaqs0uX.js";import"./ods-spinner2-CPyWCS2f.js";import"./ods-icon2-DRPHarK1.js";import"./icon-name-C6aMXAXT.js";import"./controls-DX883vx3.js";import"./unsafe-html-VJzuFJfF.js";import"./index-2LVqMwig.js";import"./ods-accordion2-vvZNAi9U.js";import"./ods-badge-CjbpLGl8.js";import"./ods-breadcrumb-item2-C_Ah5FZN.js";import"./ods-link2-CtVFUlMR.js";import"./ods-card-DRGl4_I-.js";import"./ods-checkbox2-B2XbvOPY.js";import"./dom-8hoR-urs.js";import"./ods-clipboard2-C65imxCo.js";import"./ods-input2-C6KOqFAM.js";import"./type-B5zI8QxY.js";import"./ods-tooltip2-CW12aP9b.js";import"./overlay-KZpfSxWH.js";import"./ods-code2-D4zmvcg_.js";import"./ods-combobox2-CC5fPZls.js";import"./_commonjsHelpers-CLD5em3H.js";import"./debounce-DRefBDpX.js";import"./ods-tag2-Bb2BMy9d.js";import"./ods-datepicker2-FisogS88.js";import"./locale-NOa-Gxlr.js";import"./ods-divider-CjaMxjcH.js";import"./ods-divider2-R3gNNk4H.js";import"./ods-drawer2-BQqpNIWL.js";import"./ods-file-upload2-teF1qz6H.js";import"./ods-progress-bar2-zR9YGHZb.js";import"./ods-form-field2-BSNGPVxz.js";import"./ods-icon-DTp5PnPI.js";import"./ods-input-CCQ46ZEm.js";import"./ods-link-BCeMi6SV.js";import"./ods-medium2-BnayTic8.js";import"./ods-message-BxLNJd0H.js";import"./ods-pagination2-BkxTbhCC.js";import"./ods-select2-C8koqTnw.js";import"./ods-password2-Cx1VaMfM.js";import"./ods-phone-number2-B3iHB89H.js";import"./ods-popover2-D09FwiGN.js";import"./ods-quantity2-7U22nj6z.js";import"./ods-radio2-C2vNRNiP.js";import"./ods-range2-l-uevN51.js";import"./ods-skeleton2-B7sDasgF.js";import"./ods-switch-item2-ebcV2EUF.js";import"./ods-tabs2-BNbhFfmR.js";import"./ods-table2-oe37kiP3.js";import"./ods-text-BO_pN8NQ.js";import"./ods-textarea2-BDOVTqwb.js";import"./ods-timepicker2-Cq-oMtdT.js";import"./ods-toggle2-Bg02aln1.js";function a(i){const n={code:"code",em:"em",img:"img",li:"li",ol:"ol",p:"p",span:"span",strong:"strong",ul:"ul",...d(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{of:l,name:"Documentation"}),`
`,e.jsx(p,{of:l}),`
...
dismiss or click on an action `,e.jsx(s,{kind:o.button,label:"Button",story:r.documentation}),` to proceed
further.`]})]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Content"})," container, filled with ",e.jsx(s,{kind:o.text,label:"Text",story:r.documentation})," or other read-only content, depending on the usage"]}),`
...
`,e.jsx(u,{donts:["- Trigger a Modal as a result of a first Modal actions","- Use a Modal if the informational content is very long within a Modal: consider alternatives if that is your case",e.jsxs(n.span,{children:["- Use a Modal only to notify users about a successful completion of their actions: use ",e.jsx(s,{kind:o.message,label:"Message",story:r.documentation})," component"]})],dos:["- Use a Modal to display information the user needs to respond to","- Use a Modal to ask a confirmation from the user before proceeding","- Use Modals sparingly since they are disruptive and stop users in their current task",e.jsxs(n.span,{children:["- Handle closing the Modal when the cancel action ",e.jsx(s,{kind:o.button,label:"Button",story:r.documentation})," is clicked"]}),"- Use scrolling only when it is absolutely needed"]}),`
...
`,e.jsx(t,{label:"Scrolling",level:3}),`
`,e.jsxs(n.p,{children:["When necessary, depending on the viewport height and the ",e.jsx(n.strong,{children:"Modal"})," content, the user can scroll vertically with the header and the action ",e.jsx(s,{kind:o.button,label:"Button",story:r.documentation})," remaining in place."]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"Tabulation"})," allows to move forward, first to the closing icon, then through any focusable element in the ",e.jsx(n.strong,{children:"Modal"})," (e.g. action ",e.jsx(s,{kind:o.button,label:"Button",story:r.documentation}),")"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"Shift + Tab"})," allows the opposite way to move backward in focusing items"]}),`
`]}),`
`,e.jsxs(n.p,{children:["Focus is trapped inside the ",e.jsx(n.strong,{children:"Modal"})," scope and inner elements when active."]})]})}function Se(i={}){const{wrapper:n}={...d(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(a,{...i})}):a(i)}export{Se as default};
