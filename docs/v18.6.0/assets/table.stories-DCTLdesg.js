import{W as c,X as b,Y as i,Z as u}from"./index-DZK8KyWG.js";import{d as B}from"./ods-table2-oe37kiP3.js";import{x as a,o as I,C as p}from"./controls-DX883vx3.js";import{o as e}from"./unsafe-html-VJzuFJfF.js";const V=B;V();const R={title:"ODS Components/Table",component:"ods-table"},t=`<table>
  <caption>
...
<ods-table size="${m.size}"
  ...
  `,argTypes:I({content:{table:{category:p.slot,defaultValue:{summary:"ø"}},control:"text"},size:{table:{category:p.design,defaultValue:{summary:c.md},type:{summary:b}},control:{type:"select"},options:b},variant:{table:{category:p.design,defaultValue:{summary:i.default},type:{summary:u}},control:{type:"select"},options:u}}),args:{content:t,size:c.md,variant:i.default}},n={tags:["isHidden"],parameters:{layout:"centered"},render:()=>a`
<ods-table>
${e(t)}
</ods-table>
...
\${unsafeHTML(exampleTable)}
  ...
  \`
}`,...(C=(v=d.parameters)==null?void 0:v.docs)==null?void 0:C.source}}};var H,x,z;l.parameters={...l.parameters,docs:{...(H=l.parameters)==null?void 0:H.docs,source:{originalSource:`{
  tags: ['isHidden'],
  render: () => html\`
<ods-table>
\${unsafeHTML(odsTextCaptionTable)}
  ...
  \`
}`,...(z=(x=l.parameters)==null?void 0:x.docs)==null?void 0:z.source}}};const M=["Demo","Overview","Default","Size","Variant","Caption"],G=Object.freeze(Object.defineProperty({__proto__:null,Caption:l,Default:r,Demo:s,Overview:n,Size:o,Variant:d,__namedExportsOrder:M,default:R},Symbol.toStringTag,{value:"Module"}));export{l as C,r as D,n as O,o as S,G as T,d as V};
