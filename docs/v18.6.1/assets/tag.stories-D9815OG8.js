import{_ as e,$ as m,b as H,a0 as g,a1 as u}from"./index-DZK8KyWG.js";import{d as x}from"./ods-tag2-Bb2BMy9d.js";import{x as a,o as V,C as t}from"./controls-DX883vx3.js";const Z=x;Z();const Y={title:"ODS Components/Tag",component:"ods-tag"},o={render:s=>a`
...
<ods-tag label="LG tag" size="\${ODS_TAG_SIZE.lg}"></ods-tag>
  \`
}`,...(N=(M=i.parameters)==null?void 0:M.docs)==null?void 0:N.source}}};const w=["Demo","Overview","Default","Color","CustomCSS","IsDisabled","Size"],W=Object.freeze(Object.defineProperty({__proto__:null,Color:l,CustomCSS:d,Default:r,Demo:o,IsDisabled:c,Overview:n,Size:i,__namedExportsOrder:w,default:Y},Symbol.toStringTag,{value:"Module"}));export{d as C,r as D,c as I,n as O,i as S,W as T,l as a};
