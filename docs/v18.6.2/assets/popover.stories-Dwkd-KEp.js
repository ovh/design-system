import{Q as l,R as u}from"./index-DZK8KyWG.js";import{d as V}from"./ods-popover2-D09FwiGN.js";import{x as t,o as B,C as p}from"./controls-DX883vx3.js";import{o as N}from"./unsafe-html-VJzuFJfF.js";const $=V;var c=Object.freeze,L=Object.defineProperty,j=(o,F)=>c(L(o,"raw",{value:c(o.slice())})),g;$();const Y={title:"ODS Components/Popover",component:"ods-popover",parameters:{layout:"centered"},decorators:[o=>t`<div style="padding-top: 50px; display: inline-flex; align-content: center;">${o()}</div>`]},e={render:o=>t`
...
<div style="display: flex;">
  ...
  \`
}`,...(I=(D=i.parameters)==null?void 0:D.docs)==null?void 0:I.source}}};const q=["Demo","ArrowTip","CustomCSS","Default","FixedContext","Overview","Menu"],J=Object.freeze(Object.defineProperty({__proto__:null,ArrowTip:n,CustomCSS:r,Default:s,Demo:e,FixedContext:d,Menu:i,Overview:a,__namedExportsOrder:q,default:Y},Symbol.toStringTag,{value:"Module"}));export{n as A,r as C,s as D,d as F,i as M,a as O,J as P};
