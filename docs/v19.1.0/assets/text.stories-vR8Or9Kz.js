...
}`,...(S=(C=s.parameters)==null?void 0:C.docs)==null?void 0:S.source}}};var f,v,O;c.parameters={...c.parameters,docs:{...(f=c.parameters)==null?void 0:f.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: ({}) => <table style={{
...
}`,...(O=(v=c.parameters)==null?void 0:v.docs)==null?void 0:O.source}}};const R=["Demo","Default","FigCaption","Overview","Preset","TableCaption"],D=Object.freeze(Object.defineProperty({__proto__:null,Default:a,Demo:r,FigCaption:o,Overview:n,Preset:s,TableCaption:c,__namedExportsOrder:R,default:L},Symbol.toStringTag,{value:"Module"}));export{a as D,o as F,n as O,s as P,D as T,c as a};
