...
`]}),`
`,e.jsx(n.p,{children:`Although, we tried to stay as close as possible to previous version behaviour, the way you integrate ODS in your React app should be rethought,
...
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Accordion"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Update internal logic to use the native behaviour of ",e.jsx(n.code,{children:"details"})," / ",e.jsx(n.code,{children:"summary"})," tags."]}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Consistent behaviour regarding blur and error state."}),`
...
`,e.jsx(n.p,{children:`As we're working towards a massive uniformization of all ODS form elements (events, nav behaviour, required state, validity state, ...),
...
`]})]})}function L(c={}){const{wrapper:n}={...a(),...c.components};return n?e.jsx(n,{...c,children:e.jsx(h,{...c})}):h(c)}export{L as default};
