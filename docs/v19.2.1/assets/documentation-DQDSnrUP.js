import{j as e}from"./jsx-runtime-Cfl8ynUo.js";import{useMDXComponents as d}from"./index-ZwkxtaJJ.js";import{t as i,l as r}from"./ods-react60-CRx7zEey.js";import{M as h,C as m}from"./index-8pGbFWRq.js";import{B as l,O as p,A as u,a as x,b as g,c as j}from"./badge.stories-B_omISr5.js";import{B as b}from"./Banner-CNp5SML8.js";import{I as f,B as y}from"./IdentityCard-e2WB6ddF.js";import{C as o}from"./Canvas-Df5XpfVk.js";import{E as a}from"./ExternalLink-izdABMGv.js";import{H as s}from"./Heading-hbfjmHNc.js";import"./index-jIWwRBLr.js";import"./index-2w0W-O47-BJ19ihbZ.js";import"./iframe-D7nmkxLr.js";import"./index-DWDEzXrj.js";import"./index-N93khynk.js";import"./index-CXQShRbs.js";import"./index-DrFu-skq.js";import"./index-CqY9YpN0.js";import"./colors-DSObuHxd.js";import"./icon-name-C581wThh.js";import"./TooltipTrigger-CT3e8Irz.js";import"./overlay-CZHjGBMC.js";import"./portal-QnUqvOWs.js";import"./use-locale-context-BIV2aQtl.js";import"./use-presence-BC2E-XtL.js";import"./use-event-c9j7vq_1.js";import"./index-DaqjtwB0.js";import"./index-Bc-ZgdcL.js";import"./controls-BtiQQn1l.js";import"./TooltipTrigger-Iu3rt7LP-DQH4Rvrv.js";import"./index-CTDx-6u2.js";import"./lz-string-U2heoObX.js";import"./meta-B7heVWH0.js";import"./source-CPEZJ6oD.js";import"./Link-BWQEuWpd-DsrdP0qI.js";import"./ods-react236-aAAP9SXj.js";function c(t){const n={code:"code",em:"em",img:"img",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...d(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(h,{of:l,name:"Documentation"}),`
`,e.jsx(b,{of:l}),`
...
`,e.jsx(f,{aliases:["Chip (previous name)","Label"],figmaLink:"https://www.figma.com/design/9jDDTcR4a9jPRFcdjawAlf/ODS---UI-Kit?node-id=3-22285",githubUrl:"https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/badge",name:"Badge",children:e.jsxs(n.p,{children:["A ",e.jsx(n.strong,{children:"Badge"}),` component labels an item, a keyword or a status. They are non-interactive and used inline, next to the
...
`,e.jsxs(n.p,{children:["Icon-only ",e.jsx(n.strong,{children:"Badge"})," is only used in very specific cases. In that case, it should be accompanied by a tooltip to provide further context."]}),`
`,e.jsxs(n.p,{children:["The accessibility of multiple ",e.jsx(n.strong,{children:"Badges"}),` presented as a collection must be considered during its implementation.
...
`,e.jsx(s,{label:"Icon-only Badge",level:3}),`
`,e.jsxs(n.p,{children:["If a ",e.jsx(n.strong,{children:"Badge"})," contains only an icon, it must include an ",e.jsx(a,{href:"https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-label",children:"aria-label"})," to provide context."]}),`
`,e.jsx(o,{of:u,sourceState:"shown"}),`
`,e.jsxs(n.p,{children:[e.jsx(i,{name:r.circleCheck,style:{color:"var(--ods-color-success-500)"}})," Screen readers will announce the aria-label instead of ignoring the ",e.jsx(n.strong,{children:"Badge"}),"."]}),`
`,e.jsxs(n.p,{children:["Since an icon-only ",e.jsx(n.strong,{children:"Badge"})," may lack detailed information, attach a tooltip and use an ",e.jsx(a,{href:"https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-labelledby",children:"aria-labelledby"})," when extra context is needed:"]}),`
`,e.jsx(o,{of:x,sourceState:"shown"}),`
`,e.jsxs(n.p,{children:[e.jsx(i,{name:r.circleCheck,style:{color:"var(--ods-color-success-500)"}})," Screen readers will announce the ",e.jsx(n.strong,{children:"Tooltip"})," content when focusing on the ",e.jsx(n.strong,{children:"Badge"}),"."]}),`
`,e.jsx(s,{label:"Structuring groups of Badges with lists",level:3}),`
`,e.jsxs(n.p,{children:["When displaying multiple ",e.jsx(n.strong,{children:"Badges"})," together, they should be wrapped within an unordered list of items (",e.jsx(n.code,{children:"<ul>"})," and ",e.jsx(n.code,{children:"<li>"}),") to ensure a proper announcement by screen readers."]}),`
`,e.jsx(o,{of:g,sourceState:"shown"}),`
`,e.jsxs(n.p,{children:[e.jsx(i,{name:r.circleCheck,style:{color:"var(--ods-color-success-500)"}})," This structure ensures that assistive technologies announce ",e.jsx(n.strong,{children:"Badges"}),` as a list, rather than reading them as separate, unrelated announcements.
Screen readers will announce the list, the number of items and the `,e.jsx(n.strong,{children:"Badges"})," content."]}),`
`,e.jsx(s,{label:"Alternative approach with ARIA roles",level:3}),`
`,e.jsxs(n.p,{children:["When modifying the HTML structure is not possible, use ",e.jsx(a,{href:"https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Roles/list_role",children:'role="list"'})," and ",e.jsx(a,{href:"https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Roles/listitem_role",children:'role="listitem"'})," to mimic list semantics."]}),`
`,e.jsx(o,{of:j,sourceState:"shown"}),`
`,e.jsxs(n.p,{children:[e.jsx(i,{name:r.circleCheck,style:{color:"var(--ods-color-success-500)"}})," This ensures that screen readers recognize the ",e.jsx(n.strong,{children:"Badges"})," as a structured list even without native ",e.jsx(n.code,{children:"<ul>"})," and ",e.jsx(n.code,{children:"<li>"})," elements."]})]})}function te(t={}){const{wrapper:n}={...d(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(c,{...t})}):c(t)}export{te as default};
