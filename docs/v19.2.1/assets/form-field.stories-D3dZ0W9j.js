import{p as w}from"./Input-DcqcPYne-DsDnfvYN.js";import{e,r as q}from"./index-jIWwRBLr.js";import{a as c,b as p,c as u,F as r}from"./FormFieldLabel-DW-nAxje.js";import{T,a as E}from"./Text-vMb3-i8V.js";import{T as t}from"./Textarea-BPSPZX_r.js";import{e as z,o as k,C as F}from"./controls-BtiQQn1l.js";const B={argTypes:z(["id","required"]),component:r,subcomponents:{FormFieldError:u,FormFieldHelper:p,FormFieldLabel:c},title:"React Components/Form Field"},a={render:o=>e.createElement(r,{invalid:o.invalid},e.createElement(c,null,o.label),e.createElement(t,{name:"demo"}),e.createElement(p,null,o.helperText),e.createElement(u,null,o.errorText)),argTypes:k({errorText:{table:{category:F.slot,type:{summary:"string"}},control:"text"},helperText:{table:{category:F.slot,type:{summary:"string"}},control:"text"},invalid:{table:{category:F.general},control:"boolean"},label:{table:{category:F.slot,type:{summary:"string"}},control:"text"}})},l={globals:{imports:"import { FormField, Textarea } from '@ovhcloud/ods-react';"},tags:["!dev"],render:({})=>e.createElement(r,null,e.createElement(t,{name:"textarea"}))},n={globals:{imports:"import { FormField, FormFieldError, Textarea } from '@ovhcloud/ods-react';"},tags:["!dev"],render:({})=>e.createElement(r,{invalid:!0},e.createElement(t,{name:"textarea"}),e.createElement(u,null,"Error message"))},s={globals:{imports:"import { TEXT_PRESET, FormField, FormFieldHelper, Text, Textarea } from '@ovhcloud/ods-react';"},tags:["!dev"],render:({})=>e.createElement(r,null,e.createElement(t,{name:"textarea"}),e.createElement(p,null,e.createElement(T,{preset:E.caption},"Helper text")))},m={globals:{imports:"import { FormField, FormFieldLabel, Textarea } from '@ovhcloud/ods-react';"},tags:["!dev"],render:({})=>e.createElement(r,null,e.createElement(c,null,"Description:"),e.createElement(t,{name:"textarea"}))},i={parameters:{layout:"centered"},tags:["!dev"],render:({})=>{const[g,G]=q.useState(0);function Y(j){G(j.target.value.length)}return e.createElement(r,{invalid:g>200},e.createElement(c,null,"Description:"),e.createElement(t,{name:"description",onInput:Y}),e.createElement(p,{style:{display:"flex",justifyContent:"space-between"}},e.createElement(T,{preset:E.caption},"Helper text"),e.createElement(T,{preset:E.caption},g,"/",200)),e.createElement(u,null,"Error message"))}},d={globals:{imports:"import { FormField, FormFieldHelper, FormFieldLabel, Input } from '@ovhcloud/ods-react';"},tags:["!dev"],render:({})=>e.createElement(r,null,e.createElement(c,null,"Login:"),e.createElement(w,{name:"input"}),e.createElement(p,null,"Username or email address"))};var x,b,v;a.parameters={...a.parameters,docs:{...(x=a.parameters)==null?void 0:x.docs,source:{originalSource:`{
