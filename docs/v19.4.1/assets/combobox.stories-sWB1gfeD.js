import{r as s,e}from"./index-jIWwRBLr.js";import{j as C}from"./jsx-runtime-Cfl8ynUo.js";import{u as Ho,F as Oe,a as ke}from"./FormFieldLabel-f_nl6yro.js";import{u as Yo}from"./context-C_-r2uoG.js";import{c as Jo}from"./index-CPOqegBX.js";import{a2 as zo}from"./use-locale-context-Da8UBLVe.js";import{c as Ce}from"./index-CqY9YpN0.js";import{b as Xo,a as Ko}from"./PopoverTrigger-BPaEUQIP.js";import{a as ve}from"./overlay-CZHjGBMC.js";import{I as Qo,a as Zo}from"./icon-name-BpdEc4-2.js";import{e as Pe}from"./element-3R7vFkDE.js";import{I as en,c as on}from"./Input-Iv7SWGNL.js";import{T as nn}from"./Tag-DlakOnvv.js";import{e as an,o as tn,C as w}from"./controls-BtiQQn1l.js";import{s as Ne}from"./source-CPEZJ6oD.js";function ln(o){const a=zo(),n=o.locale??a.locale;return s.useMemo(()=>Jo({...o,locale:n}),[n,o])}function rn(o,a,n,{allowCustomValue:l,filterFn:r,multiple:i,newElementLabel:p}){const x=l&&n.trim()!==""&&!un(o.concat(a),n,i)?[{isNewElement:!0,label:`${p}${n}`,value:n}]:[];function _(f,h,d,y){return y&&h.some(R=>R.value===f.value)?!1:r(f.label,d.trim())}return o.reduce((f,h)=>{if(fe(h)){const d=h.options.filter(y=>_(y,a,n,i));return d.length&&f.push({...h,options:d}),f}return _(h,a,n,i)&&f.push(h),f},x)}function Wo(o,a){let n;return o.some(l=>{Bo(l,r=>r.value===a?(n=r,!0):!1)}),n}function sn(o,a,n){if(a||!(n!=null&&n.length))return"";const l=Wo(o,n[0]);return l?l.label:""}function Le(o,a){return a!=null&&a.length?o.reduce((n,l)=>{if(fe(l)){const r=l.options.filter(i=>a.indexOf(i.value)>=0);return r.length&&(n=n.concat(r)),n}return a.indexOf(l.value)>=0&&n.push(l),n},[]):[]}function Fe(o,a,n){if(typeof o=="string")return bn(o,a,n);if(s.isValidElement(o)){const l=s.Children.map(o.props.children,r=>Fe(r,a,n));return s.cloneElement(o,o.props,l)}return o}function bn(o,a,n){return mn(o,a).map((r,i)=>r.toLowerCase()===a?n({key:i,part:r}):r)}function De(o){return!!o&&o.selectionStart===0&&o.selectionEnd===0}function fe(o){return"options"in o}function un(o,a,n){const l=a.trim().toLocaleLowerCase();return o.some(r=>Bo(r,i=>n?i.label.trim().toLocaleLowerCase()===l.toLocaleLowerCase()||i.value.trim().toLocaleLowerCase()===l.toLocaleLowerCase():i.label.trim().toLocaleLowerCase()===l.toLocaleLowerCase()))}function Bo(o,a){return fe(o)?o.options.some(a):a(o)}function mn(o,a){if(!o||!a)return[o];const n=a.toLowerCase().replace(/[-/\\^$*+?.()|[\]{}]/g,"\\$&"),l=new RegExp(`(${n})`,"gi");return o.split(l)}Fe.__docgenInfo={description:"",methods:[],displayName:"highlightNode"};const Mo=s.createContext(void 0),$o=({allowCustomValue:o,children:a,customFilter:n,defaultValue:l,disabled:r,items:i,multiple:p=!1,newElementLabel:x,onInputValueChange:_,onValueChange:f,readOnly:h,value:d,...y})=>{const R=s.useMemo(()=>sn(i,p,l||d),[]),L=s.useMemo(()=>Le(i,l||d),[]),{contains:N}=ln({sensitivity:"base"}),I=s.useCallback((t,v)=>n?n(t,v):N(t,v),[n]),E=s.useId(),j=s.useRef(null),[H,Y]=s.useState(""),[G,J]=s.useState(),[T,z]=s.useState(i),[g,F]=s.useState(""),[k,W]=s.useState(R),[V,B]=s.useState(!1),[q,A]=s.useState(L),D=s.useMemo(()=>T.reduce((t,v)=>fe(v)?t.concat(v.options.map($=>$.value)):(t.push(v.value),t),[]),[T]);s.useEffect(()=>{F(""),z(()=>!p&&k.trim()===""?i:rn(i,q,k,{allowCustomValue:o,filterFn:I,multiple:p,newElementLabel:x}))},[o,I,k,i,p,x,q]),s.useEffect(()=>{V||F("")},[V]),s.useEffect(()=>{const t=Le(i,d);t.length&&(p?(O(""),A(t)):(O(t[0].label),A([t[0]])))},[d]);function he(t){r||h||!p||(S(v=>v.filter($=>$.value!==t.value)),xe())}function xe(){var t;(t=j.current)==null||t.focus()}function Te(){if(V||b(!0),g===""&&T.length)F(D[0]);else{const t=D.findIndex(v=>v===g);F(D[t<D.length-1?t+1:0])}}function qe(t){V&&F(t.value)}function we(){if(V)if(g===""&&T.length)F(D[D.length-1]);else{const t=D.findIndex(v=>v===g);F(D[t>0?t-1:D.length-1])}}function Re(){if(!g)return;const t=Wo(T,g);t&&M(t)}function M(t){r||h||(p?(O(""),S(v=>{if(t.isNewElement){const{isNewElement:$,...Ie}=t;return v.concat([{...Ie,label:t.value}])}return v.concat([t])})):(O(t.isNewElement?t.value:t.label),S([t]),b(!1)),xe())}function O(t){const v=typeof t=="function"?t(k):t;W(v),_&&v!==k&&_({inputValue:v})}function b(t){B(r||h?!1:t)}function S(t){const v=typeof t=="function"?t(q):t;if(A(v),f){const $=v.length?v.map(Ie=>Ie.value):[];f({value:$})}}return C.jsx(Mo.Provider,{value:{...y,allowCustomValue:o,contentId:H,contentPosition:G,controlId:E,defaultValue:l,deselectItem:he,disabled:r,filteredItems:T,highlightNextOption:Te,highlightOption:qe,highlightPreviousOption:we,highlightedOptionValue:g,inputRef:j,inputValue:k,isOpen:V,items:i,multiple:p,newElementLabel:x,onInputValueChange:_,onValueChange:f,readOnly:h,selectHighlightedItem:Re,selectItem:M,selection:q,setContentId:Y,setContentPosition:J,setInputValue:O,setIsOpen:b,setSelection:S,value:d},children:a})};function _e(){return Yo(Mo)}$o.__docgenInfo={description:"",methods:[],displayName:"ComboboxProvider",props:{allowCustomValue:{required:!1,tsType:{name:"boolean"},description:"Whether to allow adding a value which is not part of the items."},customFilter:{required:!1,tsType:{name:"signature",type:"function",raw:"(label: string, query: string) => boolean",signature:{arguments:[{type:{name:"string"},name:"label"},{type:{name:"string"},name:"query"}],return:{name:"boolean"}}},description:"Custom filter logic to apply to each item."},customOptionRenderer:{required:!1,tsType:{name:"signature",type:"function",raw:"(item: ComboboxItem) => JSX.Element",signature:{arguments:[{type:{name:"union",raw:"ComboboxGroupItem<T> | ComboboxOptionItem<T>",elements:[{name:"signature",type:"object",raw:`{
