import{j as e}from"./jsx-runtime-Cfl8ynUo.js";import{useMDXComponents as h}from"./index-ZwkxtaJJ.js";import{_ as r,n as a}from"./icon-name-BOjNLCTH-CoYid0iC.js";import{k as i}from"./Kbd-Cnje_EfN-CvQx-mOR.js";import{M as u}from"./index-CorwBrna.js";import{B as l,O as p,A as m,a as x,b as j}from"./button.stories-Ck1SCnO6.js";import{A as g}from"./Anatomy-DkXJCwiR.js";import{B as b}from"./Banner-BzsM7Ov4.js";import{B as f}from"./BestPractices-DmW3jiI3.js";import{C as o}from"./Canvas-DmU-XW-X.js";import{E as c}from"./ExternalLink-B7meJZZV.js";import{H as t}from"./Heading-CqLsFmC8.js";import{I as y}from"./IdentityCard-Dz2mtlUf.js";import{S as v}from"./StorybookLink-fxXoIeO7.js";import{S as w,R as B}from"./meta-vhIdvDvL.js";import"./index-jIWwRBLr.js";import"./index-CWkFp9WS-BSIT86NH.js";import"./iframe-CTupHpWb.js";import"./index-DWDEzXrj.js";import"./index-N93khynk.js";import"./index-CXQShRbs.js";import"./index-DrFu-skq.js";import"./Button-B-GJ-1TA.js";import"./index-CqY9YpN0.js";import"./Spinner-DJB5ZadI.js";import"./colors-DSObuHxd.js";import"./icon-name-RfJfucZu.js";import"./controls-BtiQQn1l.js";import"./source-CPEZJ6oD.js";import"./index-CvuQtheM.js";import"./context-Z_Xa7sWf-5kwUyuQy.js";import"./index-D-PjbIVM.js";import"./lz-string-U2heoObX.js";import"./ResetTheme-DQ5v3p_P.js";import"./tokens-BrWUS-3i.js";import"./Link-JvSirtKN-DiqnrgRb.js";import"./divider-color-DMMH0ySn-B7JauIP0.js";import"./colors-C1Wmnk_L-aAAP9SXj.js";import"./Table-Bof_Nsov-CS9ZUwCH.js";import"./Table-BXVk_N0H.js";function d(s){const n={em:"em",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...h(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(u,{of:l,name:"Documentation"}),`
`,e.jsx(b,{of:l}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Buttons"})," don't usually redirect to an external page. For that, see ",e.jsx(v,{kind:B.link,story:w.documentation,children:"Link"}),"."]}),`
...
`,e.jsx(g,{src:"components/button/anatomy.png"}),`
...
`,e.jsxs(n.p,{children:["Pressing ",e.jsx(i,{children:"Enter"})," or ",e.jsx(i,{children:"Space"})," while the ",e.jsx(n.strong,{children:"Button"})," is focused activates it, triggering its action."]}),`
`,e.jsxs(n.p,{children:["Pressing ",e.jsx(i,{children:"Shift"})," + ",e.jsx(i,{children:"Alt"})," moves focus to the previous interactive element."]}),`
`,e.jsx(t,{label:"Accessibility",level:2}),`
`,e.jsxs(n.p,{children:["This component complies with the ",e.jsx(c,{href:"https://www.w3.org/WAI/ARIA/apg/patterns/button/",children:"Button WAI-ARIA design pattern"}),"."]}),`
...
`,e.jsxs(n.p,{children:[e.jsx(r,{name:a.circleCheck,style:{color:"var(--ods-color-success-500)"}})," Screen readers will announce the text content."]}),`
`,e.jsx(t,{label:"Icon Button",level:3}),`
`,e.jsxs(n.p,{children:["If a ",e.jsx(n.strong,{children:"Button"})," contains only an icon, it must include an ",e.jsx(c,{href:"https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-label",children:"aria-label"})," to provide context."]}),`
`,e.jsx(o,{of:x,sourceState:"shown"}),`
`,e.jsxs(n.p,{children:[e.jsx(r,{name:a.circleCheck,style:{color:"var(--ods-color-success-500)"}})," Screen readers will announce the label."]}),`
...
`,e.jsxs(n.p,{children:[e.jsx(r,{name:a.circleCheck,style:{color:"var(--ods-color-success-500)"}})," When the ",e.jsx(n.strong,{children:"Button"})," is focused, the screen reader will announce the linked label."]})]})}function de(s={}){const{wrapper:n}={...h(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(d,{...s})}):d(s)}export{de as default};
