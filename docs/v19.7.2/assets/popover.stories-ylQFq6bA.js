import{e,r as ne}from"./index-jIWwRBLr.js";import{B as a,d as f}from"./Button-FbO6Dzi8.js";import{C as ae}from"./colors-B-ZpHcIp.js";import{D as pe}from"./divider-color-DMT-YAbT.js";import{I as p,a as i}from"./icon-name-Dvh-h22i.js";import{P as o,a as r,b as t}from"./index-BhuCm2O7.js";import{o as ie,C as l,e as le}from"./controls-BtiQQn1l.js";import{s as se}from"./source-CPEZJ6oD.js";import{O as E,a as ce}from"./overlay-3VYsQcKu.js";const me={argTypes:le(["autoFocus","onOpenChange","onPositionChange","open","overlayConfig","positionerStyle","triggerId"]),component:t,subcomponents:{PopoverContent:r,PopoverTrigger:o},title:"React Components/Popover"},s={parameters:{layout:"centered"},render:n=>e.createElement(t,{overlayConfig:{gutter:n.gutter,position:n.position,sameWidth:n.sameWidth}},e.createElement(o,null,"Show popover"),e.createElement(r,{withArrow:n.withArrow},n.content)),argTypes:ie({content:{table:{category:l.slot},control:"text"},gutter:{table:{category:l.design,type:{summary:"number"}},control:"number"},position:{table:{category:l.general,type:{summary:"POPOVER_POSITION"}},control:{type:"select"},options:ce},sameWidth:{table:{category:l.design},control:{type:"boolean"}},withArrow:{table:{category:l.design,defaultValue:{summary:!1},type:{summary:"boolean"}},control:{type:"boolean"}}}),args:{content:"My popover content"}},c={tags:["!dev"],render:({})=>e.createElement(t,{open:!0,overlayConfig:{flip:!1,position:E.top}},e.createElement(o,{asChild:!0},e.createElement(a,null,"Popover trigger")),e.createElement(r,{createPortal:!1},"This is the popover content"))},m={decorators:[n=>e.createElement("div",{style:{display:"flex",flexFlow:"row",gap:"8px",alignItems:"center"}},n())],globals:{imports:`import { ICON_NAME, Button, Icon, Popover, PopoverContent, PopoverTrigger } from '@ovhcloud/ods-react';
