import{r as s,e}from"./index-jIWwRBLr.js";import{F as De,a as We,c as je,d as He}from"./index-DH_BFchB.js";import{F as x}from"./FileThumbnail-bvbWMsJN.js";import{j as h}from"./jsx-runtime-Cfl8ynUo.js";import{c as N}from"./index-C322fmIg.js";import{u as $e}from"./context-C_-r2uoG.js";import{B as Re,d as _e,a as ke}from"./Button-FbO6Dzi8.js";import{I as Ue,a as Oe}from"./icon-name-Dvh-h22i.js";import{T as Ge}from"./Textarea-CsFsC7cj.js";import{T as ze,a as Me}from"./Text-CzHK83-l.js";import{o as Xe,C as D,e as Ye}from"./controls-BtiQQn1l.js";import{s as qe}from"./source-CPEZJ6oD.js";import{D as Ke}from"./divider-color-DMT-YAbT.js";const Ve=s.createContext(void 0),Le=({children:t,disabled:o,loading:u,onInputSubmit:n,onFileChange:g,onValueChange:f,readOnly:d,...r})=>{const[c,I]=s.useState(r.value??r.defaultValue??""),P=r.value!==void 0,b=s.useRef(null);s.useEffect(()=>{r.value!==void 0&&I(r.value)},[r.value,P]);const F=T=>{var L;n==null||n(T),!P&&!d&&I(""),(L=b.current)==null||L.focus()};return h.jsx(Ve.Provider,{value:{...r,disabled:o,inputValue:c,loading:u,onFileChange:g,onInputSubmit:F,onValueChange:f,readOnly:d,setInputValue:I,textareaRef:b},children:t})};function W(){return $e(Ve)}Le.__docgenInfo={description:"",methods:[],displayName:"PromptInputProvider",props:{defaultValue:{required:!1,tsType:{name:"string"},description:"The initial textarea value. Use when you don't need to control the value of the textarea."},disabled:{required:!1,tsType:{name:"boolean"},description:"Whether the component is disabled."},fileCollection:{required:!1,tsType:{name:"Array",elements:[{name:"File"}],raw:"File[]"},description:"Array of the files associated with the prompt input."},value:{required:!1,tsType:{name:"string"},description:"The controlled textarea value."},loading:{required:!1,tsType:{name:"boolean"},description:"Whether the component is in loading state."},name:{required:!1,tsType:{name:"string"},description:"The name of the textarea form element. Useful for form submission."},onInputSubmit:{required:!1,tsType:{name:"signature",type:"function",raw:"(detail: PromptInputInputSubmitDetails) => void",signature:{arguments:[{type:{name:"PromptInputInputSubmitDetails"},name:"detail"}],return:{name:"void"}}},description:"Callback fired when the prompt input is submitted."},onValueChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(detail: PromptInputValueChangeDetails) => void",signature:{arguments:[{type:{name:"PromptInputValueChangeDetails"},name:"detail"}],return:{name:"void"}}},description:"Callback fired when the prompt input text value changes."},onFileChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(detail: PromptInputFileChangeDetails) => void",signature:{arguments:[{type:{name:"PromptInputFileChangeDetails"},name:"detail"}],return:{name:"void"}}},description:"Callback fired when a file change is triggered on the file-upload button."},readOnly:{required:!1,tsType:{name:"boolean"},description:"Whether the component is readonly."},children:{required:!0,tsType:{name:"ReactNode"},description:""}}};const H={"prompt-input":"_prompt-input_1hegn_2","prompt-input--disabled":"_prompt-input--disabled_1hegn_28"},j=s.forwardRef(({children:t,className:o,defaultValue:u,disabled:n,fileCollection:g,value:f,loading:d,name:r,onFileChange:c,onInputSubmit:I,onValueChange:P,readOnly:b,...F},T)=>h.jsx(Le,{defaultValue:u,disabled:n,fileCollection:g,value:f,loading:d,name:r,onFileChange:c,onInputSubmit:I,onValueChange:P,readOnly:b,children:h.jsx("div",{className:N(H["prompt-input"],{[H["prompt-input--disabled"]]:n||d},o),"data-ods":"prompt-input",ref:T,...F,children:t})}));j.displayName="PromptInput";j.__docgenInfo={description:"",methods:[],displayName:"PromptInput",props:{defaultValue:{required:!1,tsType:{name:"string"},description:"The initial textarea value. Use when you don't need to control the value of the textarea."},disabled:{required:!1,tsType:{name:"boolean"},description:"Whether the component is disabled."},fileCollection:{required:!1,tsType:{name:"Array",elements:[{name:"File"}],raw:"File[]"},description:"Array of the files associated with the prompt input."},value:{required:!1,tsType:{name:"string"},description:"The controlled textarea value."},loading:{required:!1,tsType:{name:"boolean"},description:"Whether the component is in loading state."},name:{required:!1,tsType:{name:"string"},description:"The name of the textarea form element. Useful for form submission."},onInputSubmit:{required:!1,tsType:{name:"signature",type:"function",raw:"(detail: PromptInputInputSubmitDetails) => void",signature:{arguments:[{type:{name:"PromptInputInputSubmitDetails"},name:"detail"}],return:{name:"void"}}},description:"Callback fired when the prompt input is submitted."},onValueChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(detail: PromptInputValueChangeDetails) => void",signature:{arguments:[{type:{name:"PromptInputValueChangeDetails"},name:"detail"}],return:{name:"void"}}},description:"Callback fired when the prompt input text value changes."},onFileChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(detail: PromptInputFileChangeDetails) => void",signature:{arguments:[{type:{name:"PromptInputFileChangeDetails"},name:"detail"}],return:{name:"void"}}},description:"Callback fired when a file change is triggered on the file-upload button."},readOnly:{required:!1,tsType:{name:"boolean"},description:"Whether the component is readonly."}},composes:["Omit"]};const Ze={"prompt-input-controls":"_prompt-input-controls_1qbww_2"},a=s.forwardRef(({children:t,className:o,...u},n)=>h.jsx("div",{className:N(Ze["prompt-input-controls"],o),"data-ods":"prompt-input-controls",ref:n,...u,children:t}));a.displayName="PromptInputControls";a.__docgenInfo={description:"",methods:[],displayName:"PromptInputControls",composes:["ComponentPropsWithRef"]};const Je={"prompt-input-file-upload-button__input":"_prompt-input-file-upload-button__input_1xxr2_2"},i=s.forwardRef(({accept:t,className:o,multiple:u,...n},g)=>{const{disabled:f,loading:d,onFileChange:r}=W(),c=s.useRef(null),I=P=>{const b=Array.from(P.target.files??[]);r==null||r({files:b}),P.target.value=""};return h.jsxs(h.Fragment,{children:[h.jsx("input",{accept:t,"aria-hidden":!0,className:Je["prompt-input-file-upload-button__input"],disabled:f||d||n.disabled,multiple:u,onChange:I,ref:c,type:"file"}),h.jsx(Re,{className:o,"data-ods":"prompt-input-file-upload-button",size:ke.sm,variant:_e.ghost,...n,disabled:f||d||n.disabled,onClick:()=>{var P;return(P=c.current)==null?void 0:P.click()},ref:g,type:"button",children:h.jsx(Ue,{name:Oe.paperclip})})]})});i.displayName="PromptInputFileUploadButton";i.__docgenInfo={description:"",methods:[],displayName:"PromptInputFileUploadButton",props:{color:{required:!1,tsType:{name:"literal",value:"`${COLOR}`"},description:`@type=BUTTON_COLOR
The color preset to use.`},loading:{required:!1,tsType:{name:"boolean"},description:"Whether the component is in loading state, disabling it."},size:{required:!1,tsType:{name:"literal",value:"`${BUTTON_SIZE}`"},description:"The size preset to use."},variant:{required:!1,tsType:{name:"literal",value:"`${BUTTON_VARIANT}`"},description:"The variant preset to use."},accept:{required:!1,tsType:{name:"HTMLInputElement['accept']",raw:"HTMLInputElement['accept']"},description:"Expected file type in file upload controls"},multiple:{required:!1,tsType:{name:"HTMLInputElement['multiple']",raw:"HTMLInputElement['multiple']"},description:"Whether multiple files can be selected at once"}},composes:["ComponentPropsWithRef"]};const Qe={"prompt-input-files":"_prompt-input-files_egyyc_2"},C=s.forwardRef(({children:t,className:o,...u},n)=>s.Children.count(t)?h.jsx("div",{className:N(Qe["prompt-input-files"],o),"data-ods":"prompt-input-files",ref:n,...u,children:t}):h.jsx(h.Fragment,{}));C.displayName="PromptInputFiles";C.__docgenInfo={description:"",methods:[],displayName:"PromptInputFiles",composes:["ComponentPropsWithRef"]};const l=s.forwardRef(({...t},o)=>{const{disabled:u,inputValue:n,fileCollection:g,loading:f,onInputSubmit:d}=W(),r=u||n.trim()===""&&!(g!=null&&g.length)||f;return h.jsx(Re,{"data-ods":"prompt-input-send-button",size:ke.sm,variant:_e.ghost,ref:o,...t,disabled:r,loading:f,onClick:()=>d==null?void 0:d({inputValue:n}),type:"button",children:h.jsx(Ue,{name:Oe.arrowUp})})});l.displayName="PromptInputSendButton";l.__docgenInfo={description:"",methods:[],displayName:"PromptInputSendButton",props:{color:{required:!1,tsType:{name:"literal",value:"`${COLOR}`"},description:`@type=BUTTON_COLOR
The color preset to use.`},loading:{required:!1,tsType:{name:"boolean"},description:"Whether the component is in loading state, disabling it."},size:{required:!1,tsType:{name:"literal",value:"`${BUTTON_SIZE}`"},description:"The size preset to use."},variant:{required:!1,tsType:{name:"literal",value:"`${BUTTON_VARIANT}`"},description:"The variant preset to use."}},composes:["ComponentPropsWithRef"]};function et(t,o){try{return CSS.supports(t,o)}catch{return!1}}const tt={"prompt-input-text-control":"_prompt-input-text-control_1p0bb_2"},$=et("field-sizing","content");function G(t){t.style.setProperty("--explicit-height","unset"),t.style.setProperty("--explicit-height",`${t.scrollHeight}px`)}const p=s.forwardRef(({className:t,placeholder:o,...u},n)=>{const{disabled:g,inputValue:f,loading:d,name:r,onValueChange:c,onInputSubmit:I,readOnly:P,setInputValue:b,textareaRef:F}=W(),T=s.useRef(null);s.useImperativeHandle(n,()=>T.current),s.useLayoutEffect(()=>{F.current=T.current},[F]),s.useLayoutEffect(()=>{$||G(T.current)},[f]);const L=y=>{y.key==="Enter"&&!y.shiftKey&&(y.preventDefault(),!g&&f.trim()!==""&&(I==null||I({inputValue:y.currentTarget.value})))},Ne=y=>{$||G(y.target),c==null||c({inputValue:y.currentTarget.value}),b(y.target.value)};return h.jsx(Ge,{className:N(tt["prompt-input-text-control"],t),"data-ods":"prompt-input-text-control",rows:1,...u,placeholder:o,value:f,disabled:g||d,name:r,onChange:Ne,onKeyDown:L,readOnly:P,ref:T})});p.displayName="PromptInputTextControl";p.__docgenInfo={description:"",methods:[],displayName:"PromptInputTextControl",props:{invalid:{required:!1,tsType:{name:"boolean"},description:"Whether the component is in error state."},placeholder:{required:!1,tsType:{name:"string"},description:""}},composes:["ComponentPropsWithRef"]};const m=Object.assign(j,{Controls:a,FileUploadButton:i,Files:C,SendButton:l,TextControl:p}),ot={argTypes:Ye(["defaultValue","fileCollection","name","onInputSubmit","onValueChange","onFileChange","value"]),component:m,subcomponents:{PromptInputControls:a,PromptInputFiles:C,PromptInputFileUploadButton:i,PromptInputSendButton:l,PromptInputTextControl:p},tags:["new"],title:"React Components/Prompt Input"},E={argTypes:Xe({disabled:{control:"boolean",table:{category:D.general}},loading:{control:"boolean",table:{category:D.general}},readOnly:{control:"boolean",table:{category:D.general}}}),render:t=>e.createElement(m,{loading:t.loading,readOnly:t.readOnly,disabled:t.disabled},e.createElement(a,null,e.createElement(i,null),e.createElement(p,{placeholder:"Type your message here..."}),e.createElement(l,null)))},v={tags:["!dev"],render:({})=>{const t=new File(["foo"],"a-default-text-file.txt",{type:"text/plain"});return e.createElement("div",{style:{minWidth:"500px"}},e.createElement(m,null,e.createElement(C,null,e.createElement(x,{file:t})),e.createElement(a,null,e.createElement(i,null),e.createElement(p,{placeholder:"This is where you can ask about something…"}),e.createElement(l,null))))}},S={tags:["!dev"],globals:{imports:"import { PromptInput, PromptInputControls, PromptInputFileUploadButton, PromptInputTextControl, PromptInputSendButton } from '@ovhcloud/ods-react';"},render:({})=>e.createElement(m,null,e.createElement(a,null,e.createElement(i,null),e.createElement(p,null),e.createElement(l,null)))},A={tags:["!dev"],render:({})=>{const[t,o]=s.useState([new File(["foo"],"a-default-text-file.txt",{type:"text/plain"}),new File(["foo"],"another-default-text-file.txt",{type:"text/plain"})]),[u,n]=s.useState(!1),g=({files:r})=>{o(c=>[...c,...r])},f=r=>{o(c=>c.filter(I=>I!==r))},d=()=>{n(!0),setTimeout(()=>{n(!1)},1500)};return e.createElement(m,{loading:u,onFileChange:g,onInputSubmit:d,fileCollection:t},e.createElement(C,null,t==null?void 0:t.map((r,c)=>e.createElement(x,{key:c,file:r,onFileRemove:()=>f(r)}))),e.createElement(a,null,e.createElement(i,{multiple:!0,"aria-description":"description","aria-label":"label"}),e.createElement(p,{"aria-label":"Ask someone about something…",placeholder:"Ask someone about something…"}),e.createElement(l,{"aria-label":u?"Sending message…":"Send message"})))}},B={tags:["!dev"],globals:{imports:"import { PromptInput, PromptInputControls, PromptInputFileUploadButton, PromptInputTextControl, PromptInputSendButton } from '@ovhcloud/ods-react';"},render:({})=>e.createElement(m,{disabled:!0,defaultValue:"Nobody’s here to answer…"},e.createElement(a,null,e.createElement(i,{"aria-label":"Attach a file"}),e.createElement(p,{"aria-label":"Ask someone about something…"}),e.createElement(l,{"aria-label":"Send message"})))},w={tags:["!dev"],globals:{imports:"import { PromptInput, PromptInputControls, PromptInputFileUploadButton, PromptInputTextControl, PromptInputSendButton } from '@ovhcloud/ods-react';"},render:({})=>e.createElement(m,{readOnly:!0,defaultValue:"This is a read-only prompt input."},e.createElement(a,null,e.createElement(i,{"aria-label":"Attach a file"}),e.createElement(p,{"aria-label":"Ask someone about something…"}),e.createElement(l,{"aria-label":"Send message"})))},R={tags:["!dev"],globals:{imports:"import { PromptInput, PromptInputControls, PromptInputFileUploadButton, PromptInputTextControl, PromptInputSendButton } from '@ovhcloud/ods-react';"},render:({})=>e.createElement(m,{defaultValue:"“Someone” is processing your request…",loading:!0},e.createElement(a,null,e.createElement(i,{"aria-label":"Attach a file"}),e.createElement(p,{"aria-label":"Ask someone about something…"}),e.createElement(l,{"aria-label":"Send message"})))},_={parameters:{docs:{source:{...qe()}}},globals:{imports:"import { FileThumbnail, PromptInput, PromptInputControls, PromptInputFiles, PromptInputFileUploadButton, PromptInputTextControl, PromptInputSendButton } from '@ovhcloud/ods-react';"},tags:["!dev"],render:({})=>{const t=new File(["foo"],"loading-pdf-file.pdf",{type:"application/pdf"}),o=new File(["bar"],"text-file.txt",{type:"text/plain"});return e.createElement(m,{fileCollection:[t,o]},e.createElement(C,null,e.createElement(x,{file:t,progress:45}),e.createElement(x,{file:o})),e.createElement(a,null,e.createElement(i,{"aria-label":"Attach a file"}),e.createElement(p,{"aria-label":"Ask someone about something…"}),e.createElement(l,{"aria-label":"Send message"})))}},k={globals:{imports:`import { Divider, FormField, FormFieldError, FormFieldHelper, FormFieldLabel, PromptInput, PromptInputControls, PromptInputFileUploadButton, PromptInputTextControl, PromptInputSendButton, Text, TEXT_PRESET } from '@ovhcloud/ods-react';
import { useState } from 'react';`},tags:["!dev"],parameters:{docs:{source:{...qe()}}},render:({})=>{const[o,u]=s.useState("Some text that is almost hitting the length limit...");return e.createElement(De,{invalid:(o==null?void 0:o.length)>60},e.createElement(We,null,"Here is a prompt input inside a form field:"),e.createElement(m,{defaultValue:o,name:"prompt-input-textArea",onValueChange:({inputValue:n})=>u(n)},e.createElement(a,null,e.createElement(i,{"aria-label":"Attach a file"}),e.createElement("div",{style:{display:"flex",flexDirection:"column",flexGrow:1,rowGap:"var(--ods-theme-row-gap)"}},e.createElement(p,{"aria-label":"Ask someone about something…"}),e.createElement(Ke,{style:{width:"100%"}}),e.createElement(je,null,e.createElement(ze,{preset:Me.caption},o==null?void 0:o.length," / ",60))),e.createElement(l,{"aria-label":"Send message"}))),e.createElement(He,null,"Character limit exceeded"))}},U={tags:["!dev"],globals:{imports:"import { PromptInput, PromptInputControls, PromptInputTextControl, PromptInputSendButton } from '@ovhcloud/ods-react';"},render:({})=>e.createElement(m,null,e.createElement(a,null,e.createElement(p,{"aria-label":"Ask someone about something…"}),e.createElement(l,null)))},O={tags:["!dev"],globals:{imports:"import { PromptInput, PromptInputControls, PromptInputFileUploadButton, PromptInputTextControl, PromptInputSendButton } from '@ovhcloud/ods-react';"},render:({})=>e.createElement(m,null,e.createElement(a,null,e.createElement(i,{"aria-label":"Attach file"}),e.createElement(p,{"aria-label":"Ask someone about something…"}),e.createElement(l,{"aria-label":"Send request"})))},q={tags:["!dev"],globals:{imports:"import { PromptInput, PromptInputControls, PromptInputTextControl, PromptInputSendButton, PromptInputFileUploadButton } from '@ovhcloud/ods-react';"},render:({})=>e.createElement(m,{loading:!0},e.createElement(a,null,e.createElement(i,{"aria-label":"Attach file"}),e.createElement(p,{"aria-label":"Ask someone about something…"}),e.createElement(l,{"aria-label":"Request is processing"})))},V={parameters:{layout:"fullscreen"},tags:["!dev"],render:({})=>e.createElement("div",{style:{display:"flex",flexDirection:"column",gap:"12px"}},e.createElement(m,null,e.createElement(C,null,e.createElement(x,{file:new File(["foo"],"file1.pdf",{type:"application/pdf"}),progress:45}),e.createElement(x,{file:new File(["bar"],"file2.txt",{type:"text/plain"})})),e.createElement(a,null,e.createElement(i,{"aria-label":"Attach file"}),e.createElement(p,{"aria-label":"Ask someone about something…",placeholder:"Ask someone about something…"}),e.createElement(l,{"aria-label":"Send request"}))),e.createElement(m,{defaultValue:"This is a default value"},e.createElement(a,null,e.createElement(i,{"aria-label":"Attach file"}),e.createElement(p,{"aria-label":"Ask someone about something…",placeholder:"Ask someone about something…"}),e.createElement(l,{"aria-label":"Send request"}))),e.createElement(m,{disabled:!0,defaultValue:"This is a default value in a disabled prompt input."},e.createElement(a,null,e.createElement(i,{"aria-label":"Attach file"}),e.createElement(p,{"aria-label":"Ask someone about something…",placeholder:"Ask someone about something…"}),e.createElement(l,{"aria-label":"Request is processing"}))),e.createElement(m,{loading:!0},e.createElement(a,null,e.createElement(i,{"aria-label":"Attach file"}),e.createElement(p,{"aria-label":"Ask someone about something…",placeholder:"Placeholder in loading prompt input…"}),e.createElement(l,{"aria-label":"Request is processing"}))),e.createElement(m,{readOnly:!0,defaultValue:"This is a read-only prompt input."},e.createElement(a,null,e.createElement(p,{"aria-label":"Ask someone about something…",placeholder:"Ask someone about something…"}),e.createElement(l,{"aria-label":"Request is processing"}))))};var z,M,X;E.parameters={...E.parameters,docs:{...(z=E.parameters)==null?void 0:z.docs,source:{originalSource:`{
...
}`,...(le=(ae=B.parameters)==null?void 0:ae.docs)==null?void 0:le.source}}};var pe,se,ie;w.parameters={...w.parameters,docs:{...(pe=w.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  tags: ["!dev"],
  globals: {
    imports: "import { PromptInput, PromptInputControls, PromptInputFileUploadButton, PromptInputTextControl, PromptInputSendButton } from '@ovhcloud/ods-react';"
  },
...
}`,...(ie=(se=w.parameters)==null?void 0:se.docs)==null?void 0:ie.source}}};var ue,me,de;R.parameters={...R.parameters,docs:{...(ue=R.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  tags: ["!dev"],
  globals: {
    imports: "import { PromptInput, PromptInputControls, PromptInputFileUploadButton, PromptInputTextControl, PromptInputSendButton } from '@ovhcloud/ods-react';"
  },
...
}`,...(we=(Be=V.parameters)==null?void 0:Be.docs)==null?void 0:we.source}}};const nt=["Demo","AnatomyTech","Default","Overview","Disabled","ReadOnly","Loading","WithFiles","InFormField","AccessibilityAriaLabel","AccessibilityButtonsLabels","AccessibilityLoadingState","ThemeGenerator"],It=Object.freeze(Object.defineProperty({__proto__:null,AccessibilityAriaLabel:U,AccessibilityButtonsLabels:O,AccessibilityLoadingState:q,AnatomyTech:v,Default:S,Demo:E,Disabled:B,InFormField:k,Loading:R,Overview:A,ReadOnly:w,ThemeGenerator:V,WithFiles:_,__namedExportsOrder:nt,default:ot},Symbol.toStringTag,{value:"Module"}));export{U as A,S as D,k as I,R as L,A as O,It as P,w as R,_ as W,O as a,q as b,v as c,B as d};
