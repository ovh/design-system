import{r as s,e}from"./index-jIWwRBLr.js";import{j as d}from"./jsx-runtime-Cfl8ynUo.js";import{u as Uo,F as Fe,a as Se}from"./index-DH_BFchB.js";import{u as Qo}from"./context-C_-r2uoG.js";import{u as Zo}from"./use-filter-DeNf3i4g.js";import{c as M}from"./index-C322fmIg.js";import{b as en,a as on}from"./index-BhuCm2O7.js";import{I as Mo,a as $o}from"./icon-name-Dvh-h22i.js";import{h as nn,e as je}from"./element-B8BTzFb4.js";import{O as xe}from"./overlay-3VYsQcKu.js";import{I as tn,a as an}from"./Input-6AH7vp_K.js";import{T as ln}from"./Tag-75MPzaMW.js";import{o as rn,C as N,e as sn}from"./controls-BtiQQn1l.js";import{s as Pe}from"./source-CPEZJ6oD.js";function mn(n,a,o,{allowCustomValue:l,filterFn:i,multiple:c,newElementLabel:g}){const v=l&&o.trim()!==""&&!un(n.concat(a),o,c)?[{isNewElement:!0,label:`${g}${o}`,value:o}]:[];function T(C,y,f,h){return h&&y.some(E=>E.value===C.value)?!1:i(C.label,f.trim())}return n.reduce((C,y)=>{if(ye(y)){const f=y.options.filter(h=>T(h,a,o,c));return f.length&&C.push({...y,options:f}),C}return T(y,a,o,c)&&C.push(y),C},v)}function Yo(n,a){let o;return n.some(l=>{Jo(l,i=>i.value===a?(o=i,!0):!1)}),o}function bn(n,a,o){if(a||!(o!=null&&o.length))return"";const l=Yo(n,o[0]);return l?l.label:""}function Ae(n,a){return a!=null&&a.length?n.reduce((o,l)=>{if(ye(l)){const i=l.options.filter(c=>a.indexOf(c.value)>=0);return i.length&&(o=o.concat(i)),o}return a.indexOf(l.value)>=0&&o.push(l),o},[]):[]}function Ne(n){return!!n&&n.selectionStart===0&&n.selectionEnd===0}function ye(n){return"options"in n}function un(n,a,o){const l=a.trim().toLocaleLowerCase();return n.some(i=>Jo(i,c=>o?c.label.trim().toLocaleLowerCase()===l.toLocaleLowerCase()||c.value.trim().toLocaleLowerCase()===l.toLocaleLowerCase():c.label.trim().toLocaleLowerCase()===l.toLocaleLowerCase()))}function Jo(n,a){return ye(n)?n.options.some(a):a(n)}const zo=s.createContext(void 0),Xo=({allowCustomValue:n,children:a,customFilter:o,defaultOpen:l,defaultValue:i,disabled:c,items:g,multiple:v=!1,newElementLabel:T,onInputValueChange:C,onOpenChange:y,onValueChange:f,open:h,readOnly:E,value:D,...V})=>{const w=s.useMemo(()=>bn(g,v,i||D),[]),H=s.useMemo(()=>Ae(g,i||D),[]),{contains:_}=Zo({sensitivity:"base"}),L=s.useCallback((t,m)=>o?o(t,m):_(t,m),[o]),X=s.useId(),G=s.useRef(null),[K,W]=s.useState(""),[Q,x]=s.useState(),[F,j]=s.useState(g),[q,A]=s.useState(""),[S,O]=s.useState(w),[I,_e]=s.useState(l??h??!1),[B,$]=s.useState(H),k=s.useMemo(()=>F.reduce((t,m)=>ye(m)?t.concat(m.options.map(J=>J.value)):(t.push(m.value),t),[]),[F]);s.useEffect(()=>{A(""),j(()=>!v&&S.trim()===""?g:mn(g,B,S,{allowCustomValue:n,filterFn:L,multiple:v,newElementLabel:T}))},[n,L,S,g,v,T,B]),s.useEffect(()=>{I||A("")},[I]),s.useEffect(()=>{typeof h=="boolean"&&_e(h)},[h]),s.useEffect(()=>{if(!D)return;const t=Ae(g,D);t.length?v?(Y(""),$(t)):(Y(t[0].label),$([t[0]])):D.length===0&&(Y(""),$([]))},[D]);function De(t){c||E||!v||(Ee(m=>m.filter(J=>J.value!==t.value)),Te())}function Te(){var t;(t=G.current)==null||t.focus()}function Ie(){if(I||Oe(!0),q===""&&F.length)A(k[0]);else{const t=k.findIndex(m=>m===q);A(k[t<k.length-1?t+1:0])}}function Z(t){I&&A(t.value)}function U(){if(I)if(q===""&&F.length)A(k[k.length-1]);else{const t=k.findIndex(m=>m===q);A(k[t>0?t-1:k.length-1])}}function r(){if(!q)return;const t=Yo(F,q);t&&P(t)}function P(t){c||E||(v?(Y(""),Ee(m=>{if(t.isNewElement){const{isNewElement:J,...ke}=t;return m.concat([{...ke,label:t.value}])}return m.concat([t])})):(Y(t.isNewElement?t.value:t.label),Ee([t]),Oe(!1)),Te())}function Y(t){const m=typeof t=="function"?t(S):t;O(m),C&&m!==S&&C({inputValue:m})}function Oe(t){let m;c||E?m=!1:m=typeof t=="function"?t(I):t,typeof h!="boolean"&&_e(m),y&&y({open:m})}function Ee(t){const m=typeof t=="function"?t(B):t;if($(m),f){const J=m.length?m.map(ke=>ke.value):[];f({value:J})}}return d.jsx(zo.Provider,{value:{...V,allowCustomValue:n,contentId:K,contentPosition:Q,controlId:X,defaultValue:i,deselectItem:De,disabled:c,filteredItems:F,highlightNextOption:Ie,highlightOption:Z,highlightPreviousOption:U,highlightedOptionValue:q,inputRef:G,inputValue:S,isOpen:I,items:g,multiple:v,newElementLabel:T,onInputValueChange:C,onValueChange:f,readOnly:E,selectHighlightedItem:r,selectItem:P,selection:B,setContentId:W,setContentPosition:x,setInputValue:Y,setIsOpen:Oe,setSelection:Ee,value:D},children:a})};function qe(){return Qo(zo)}Xo.__docgenInfo={description:"",methods:[],displayName:"ComboboxProvider",props:{allowCustomValue:{required:!1,tsType:{name:"boolean"},description:"Whether to allow adding a value which is not part of the items."},customFilter:{required:!1,tsType:{name:"signature",type:"function",raw:"(label: string, query: string) => boolean",signature:{arguments:[{type:{name:"string"},name:"label"},{type:{name:"string"},name:"query"}],return:{name:"boolean"}}},description:"Custom filter logic to apply to each item."},customOptionRenderer:{required:!1,tsType:{name:"signature",type:"function",raw:"(item: ComboboxItem) => JSX.Element",signature:{arguments:[{type:{name:"union",raw:"ComboboxGroupItem<T> | ComboboxOptionItem<T>",elements:[{name:"signature",type:"object",raw:`{
...
/!\\ Only work for single selection mode for now.`},value:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:"The controlled selected value(s)."},children:{required:!0,tsType:{name:"ReactNode"},description:""}}};const Le=s.forwardRef(({allowCustomValue:n=!0,children:a,className:o,customFilter:l,customOptionRenderer:i,defaultOpen:c,defaultValue:g,disabled:v,highlightResults:T=!1,i18n:C,invalid:y,items:f,locale:h,multiple:E,name:D,newElementLabel:V="Add ",noResultLabel:w="No results found",onInputValueChange:H,onOpenChange:_,onValueChange:L,open:X,overlayConfig:G,readOnly:K,required:W,value:Q,...x},F)=>{const j=Uo(),q=y||(j==null?void 0:j.invalid);return d.jsx(Xo,{allowCustomValue:n,customFilter:l,customOptionRenderer:i,defaultOpen:c,defaultValue:g,disabled:v,highlightResults:T,i18n:C,invalid:q,items:f,locale:h,multiple:E,name:D,newElementLabel:V,noResultLabel:w,onInputValueChange:H,onOpenChange:_,onValueChange:L,open:X,overlayConfig:G,readOnly:K,required:W,value:Q,children:d.jsx("div",{className:o,"data-ods":"combobox",ref:F,...x,children:a})})});Le.displayName="Combobox";Le.__docgenInfo={description:"",methods:[],displayName:"Combobox",props:{allowCustomValue:{required:!1,tsType:{name:"boolean"},description:"Whether to allow adding a value which is not part of the items.",defaultValue:{value:"true",computed:!1}},customFilter:{required:!1,tsType:{name:"signature",type:"function",raw:"(label: string, query: string) => boolean",signature:{arguments:[{type:{name:"string"},name:"label"},{type:{name:"string"},name:"query"}],return:{name:"boolean"}}},description:"Custom filter logic to apply to each item."},customOptionRenderer:{required:!1,tsType:{name:"signature",type:"function",raw:"(item: ComboboxItem) => JSX.Element",signature:{arguments:[{type:{name:"union",raw:"ComboboxGroupItem<T> | ComboboxOptionItem<T>",elements:[{name:"signature",type:"object",raw:`{
  customRendererData?: T,
  label: string;
  options: ComboboxOptionItem[];
}`,signature:{properties:[{key:"customRendererData",value:{name:"T",required:!1}},{key:"label",value:{name:"string",required:!0}},{key:"options",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
/!\\ Only work for single selection mode for now.`},value:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:"The controlled selected value(s)."}}};const cn={"combobox-highlight":"_combobox-highlight_1y4e6_2"},Ko=({children:n,highlight:a,inputValue:o})=>!a||!o?d.jsx(d.Fragment,{children:n}):d.jsx(d.Fragment,{children:nn(n,o.toLowerCase(),({key:l,part:i})=>d.jsx("span",{className:cn["combobox-highlight"],children:i},l))});Ko.__docgenInfo={description:"",methods:[],displayName:"ComboboxHighlight",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},highlight:{required:!1,tsType:{name:"boolean"},description:""},inputValue:{required:!0,tsType:{name:"string"},description:""}}};const z={"combobox-option":"_combobox-option_10qpo_2","combobox-option--disabled":"_combobox-option--disabled_10qpo_12","combobox-option--highlighted":"_combobox-option--highlighted_10qpo_18","combobox-option--new":"_combobox-option--new_10qpo_21","combobox-option--selected":"_combobox-option--selected_10qpo_24","combobox-option__new-item":"_combobox-option__new-item_10qpo_27"},Re=({className:n,isHighlighted:a,item:o,...l})=>{const{customOptionRenderer:i,disabled:c,highlightOption:g,highlightResults:v,inputValue:T,selection:C,selectItem:y}=qe(),f=s.useRef(null);s.useEffect(()=>{f.current&&a&&f.current.scrollIntoView({block:"nearest"})},[a,f]);function h(){c||y(o)}return d.jsx("div",{"aria-selected":a,className:M(z["combobox-option"],{[z["combobox-option--disabled"]]:c},{[z["combobox-option--highlighted"]]:a},{[z["combobox-option--new"]]:o.isNewElement},{[z["combobox-option--selected"]]:C.some(E=>E.value===o.value)},n),onClick:h,onPointerEnter:()=>g(o),ref:f,role:"option",tabIndex:-1,...l,children:o.isNewElement?d.jsxs("div",{className:z["combobox-option__new-item"],children:[d.jsx(Mo,{name:$o.plus})," ",o.label]}):d.jsx(Ko,{highlight:v,inputValue:T,children:i?i(o):o.label})})};Re.displayName="ComboboxOption";Re.__docgenInfo={description:"",methods:[],displayName:"ComboboxOption",props:{isHighlighted:{required:!0,tsType:{name:"boolean"},description:""},item:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  customRendererData?: T,
  group?: string;
  /** @internal */
  isNewElement?: boolean;
