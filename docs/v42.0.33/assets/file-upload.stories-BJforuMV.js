...
}`,...(ze=(Ae=B.parameters)==null?void 0:Ae.docs)==null?void 0:ze.source}}};var Ce,we,ke;Y.parameters={...Y.parameters,docs:{...(Ce=Y.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  tags: ['!dev'],
  parameters: {
    docs: {
      source: {
...
}`,...(ke=(we=Y.parameters)==null?void 0:we.docs)==null?void 0:ke.source}}};const nr=["Demo","Accept","CustomLabels","Default","Disabled","MaxFile","MaxSize","Overview","Upload"],Er=Object.freeze(Object.defineProperty({__proto__:null,Accept:k,CustomLabels:q,Default:M,Demo:w,Disabled:$,MaxFile:G,MaxSize:V,Overview:B,Upload:Y,__namedExportsOrder:nr,default:or},Symbol.toStringTag,{value:"Module"}));export{k as A,q as C,M as D,Er as F,G as M,B as O,Y as U,$ as a,V as b};
