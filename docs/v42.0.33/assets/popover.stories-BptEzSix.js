import{r as v,e as r}from"./index-D_CmzhJ4.js";import{B as D}from"./Button-CbWLwkmI.js";import{I as ve,a as Pe}from"./icon-name-BOrBmUKT.js";import{j as d}from"./jsx-runtime-VM66peLj.js";import{a as fe,O as Oe}from"./overlay-CZHjGBMC.js";import{s as he,P as Ee}from"./portal-Cd4TVoZS.js";import{u as _,a as Te,P as Ce}from"./use-presence-B3rWeOdE.js";import{c as we,N as h,O as R,P as ye,Q as Ie,T as Re,W as be,z as xe,v as Ae,r as S,ac as j,ad as Se,u as Ne,R as Fe,A as Le,S as Be}from"./use-locale-context-BCvnGTO-.js";import{g as De,a as G}from"./index-CV381T9I.js";import{t as _e,p as ke,a as je}from"./index-BWpg1GWN.js";import{t as Ge}from"./index--ILUttcN.js";import{c as Ve}from"./index-CkQHsVsO.js";import{e as Me,o as $e,C as N}from"./controls-BtiQQn1l.js";import{s as Ye}from"./source-d0g_Nd0q.js";const[qe,b]=we({name:"PopoverContext",hookName:"usePopoverContext",providerName:"<PopoverProvider />"}),ie=v.forwardRef((e,o)=>{const t=b(),n=h(t.getArrowProps(),e);return d.jsx(R.div,{...n,ref:o})});ie.displayName="PopoverArrow";const ae=v.forwardRef((e,o)=>{const t=b(),n=h(t.getArrowTipProps(),e);return d.jsx(R.div,{...n,ref:o})});ae.displayName="PopoverArrowTip";const pe=v.forwardRef((e,o)=>{const t=b(),n=_(),s=h(t.getContentProps(),n.getPresenceProps(),e);return n.unmounted?null:d.jsx(R.div,{...s,ref:ye(n.ref,o)})});pe.displayName="PopoverContent";const le=v.forwardRef((e,o)=>{const t=b(),n=_(),s=h(t.getPositionerProps(),e);return n.unmounted?null:d.jsx(R.div,{...s,ref:o})});le.displayName="PopoverPositioner";var We=Ie("popover").parts("arrow","arrowTip","anchor","trigger","indicator","positioner","content","title","description","closeTrigger"),m=We.build(),ce=e=>{var o;return((o=e.ids)==null?void 0:o.anchor)??`popover:${e.id}:anchor`},de=e=>{var o;return((o=e.ids)==null?void 0:o.trigger)??`popover:${e.id}:trigger`},F=e=>{var o;return((o=e.ids)==null?void 0:o.content)??`popover:${e.id}:content`},ue=e=>{var o;return((o=e.ids)==null?void 0:o.positioner)??`popover:${e.id}:popper`},Ke=e=>{var o;return((o=e.ids)==null?void 0:o.arrow)??`popover:${e.id}:arrow`},L=e=>{var o;return((o=e.ids)==null?void 0:o.title)??`popover:${e.id}:title`},B=e=>{var o;return((o=e.ids)==null?void 0:o.description)??`popover:${e.id}:desc`},Ue=e=>{var o;return((o=e.ids)==null?void 0:o.closeTrigger)??`popover:${e.id}:close`},V=e=>e.getById(ce(e)),f=e=>e.getById(de(e)),O=e=>e.getById(F(e)),M=e=>e.getById(ue(e)),He=e=>e.getById(L(e)),Qe=e=>e.getById(B(e));function Je(e,o){const{state:t,context:n,send:s,computed:i,prop:a,scope:g}=e,P=t.matches("open"),x=n.get("currentPlacement"),me=i("currentPortalled"),k=n.get("renderedElements"),A=De({...a("positioning"),placement:x});return{portalled:me,open:P,setOpen(u){t.matches("open")!==u&&s({type:u?"OPEN":"CLOSE"})},reposition(u={}){s({type:"POSITIONING.SET",options:u})},getArrowProps(){return o.element({id:Ke(g),...m.arrow.attrs,dir:a("dir"),style:A.arrow})},getArrowTipProps(){return o.element({...m.arrowTip.attrs,dir:a("dir"),style:A.arrowTip})},getAnchorProps(){return o.element({...m.anchor.attrs,dir:a("dir"),id:ce(g)})},getTriggerProps(){return o.button({...m.trigger.attrs,dir:a("dir"),type:"button","data-placement":x,id:de(g),"aria-haspopup":"dialog","aria-expanded":P,"data-state":P?"open":"closed","aria-controls":F(g),onPointerDown(u){be()&&u.currentTarget.focus()},onClick(u){u.defaultPrevented||s({type:"TOGGLE"})},onBlur(u){s({type:"TRIGGER_BLUR",target:u.relatedTarget})}})},getIndicatorProps(){return o.element({...m.indicator.attrs,dir:a("dir"),"data-state":P?"open":"closed"})},getPositionerProps(){return o.element({id:ue(g),...m.positioner.attrs,dir:a("dir"),style:A.floating})},getContentProps(){return o.element({...m.content.attrs,dir:a("dir"),id:F(g),tabIndex:-1,role:"dialog",hidden:!P,"data-state":P?"open":"closed","data-expanded":Re(P),"aria-labelledby":k.title?L(g):void 0,"aria-describedby":k.description?B(g):void 0,"data-placement":x})},getTitleProps(){return o.element({...m.title.attrs,id:L(g),dir:a("dir")})},getDescriptionProps(){return o.element({...m.description.attrs,id:B(g),dir:a("dir")})},getCloseTriggerProps(){return o.button({...m.closeTrigger.attrs,dir:a("dir"),id:Ue(g),type:"button","aria-label":"close",onClick(u){u.defaultPrevented||(u.stopPropagation(),s({type:"CLOSE"}))}})}}}var Xe=Ae({props({props:e}){return{closeOnInteractOutside:!0,closeOnEscape:!0,autoFocus:!0,modal:!1,portalled:!0,...e,positioning:{placement:"bottom",...e.positioning}}},initialState({prop:e}){return e("open")||e("defaultOpen")?"open":"closed"},context({bindable:e}){return{currentPlacement:e(()=>({defaultValue:void 0})),renderedElements:e(()=>({defaultValue:{title:!0,description:!0}}))}},computed:{currentPortalled:({prop:e})=>!!e("modal")||!!e("portalled")},watch({track:e,prop:o,action:t}){e([()=>o("open")],()=>{t(["toggleVisibility"])})},entry:["checkRenderedElements"],states:{closed:{on:{"CONTROLLED.OPEN":{target:"open",actions:["setInitialFocus"]},TOGGLE:[{guard:"isOpenControlled",actions:["invokeOnOpen"]},{target:"open",actions:["invokeOnOpen","setInitialFocus"]}],OPEN:[{guard:"isOpenControlled",actions:["invokeOnOpen"]},{target:"open",actions:["invokeOnOpen","setInitialFocus"]}]}},open:{effects:["trapFocus","preventScroll","hideContentBelow","trackPositioning","trackDismissableElement","proxyTabFocus"],on:{"CONTROLLED.CLOSE":{target:"closed",actions:["setFinalFocus"]},CLOSE:[{guard:"isOpenControlled",actions:["invokeOnClose"]},{target:"closed",actions:["invokeOnClose","setFinalFocus"]}],TOGGLE:[{guard:"isOpenControlled",actions:["invokeOnClose"]},{target:"closed",actions:["invokeOnClose"]}],"POSITIONING.SET":{actions:["reposition"]}}}},implementations:{guards:{isOpenControlled:({prop:e})=>e("open")!=null},effects:{trackPositioning({context:e,prop:o,scope:t}){e.set("currentPlacement",o("positioning").placement);const n=V(t)??f(t);return G(n,()=>M(t),{...o("positioning"),defer:!0,onComplete(i){e.set("currentPlacement",i.placement)}})},trackDismissableElement({send:e,prop:o,scope:t}){const n=()=>O(t);let s=!0;return Ge(n,{pointerBlocking:o("modal"),exclude:f(t),defer:!0,onEscapeKeyDown(i){var a;(a=o("onEscapeKeyDown"))==null||a(i),!o("closeOnEscape")&&i.preventDefault()},onInteractOutside(i){var a;(a=o("onInteractOutside"))==null||a(i),!i.defaultPrevented&&(s=!(i.detail.focusable||i.detail.contextmenu),o("closeOnInteractOutside")||i.preventDefault())},onPointerDownOutside:o("onPointerDownOutside"),onFocusOutside:o("onFocusOutside"),persistentElements:o("persistentElements"),onDismiss(){e({type:"CLOSE",src:"interact-outside",restoreFocus:s})}})},proxyTabFocus({prop:e,scope:o}){return e("modal")||!e("portalled")?void 0:Se(()=>O(o),{triggerElement:f(o),defer:!0,onFocus(n){n.focus({preventScroll:!0})}})},hideContentBelow({prop:e,scope:o}){return e("modal")?je(()=>[O(o),f(o)],{defer:!0}):void 0},preventScroll({prop:e,scope:o}){if(e("modal"))return ke(o.getDoc())},trapFocus({prop:e,scope:o}){return e("modal")?_e(()=>O(o),{initialFocus:()=>j({root:O(o),getInitialEl:e("initialFocusEl"),enabled:e("autoFocus")})}):void 0}},actions:{reposition({event:e,prop:o,scope:t,context:n}){const s=V(t)??f(t);G(s,()=>M(t),{...o("positioning"),...e.options,defer:!0,listeners:!1,onComplete(a){n.set("currentPlacement",a.placement)}})},checkRenderedElements({context:e,scope:o}){S(()=>{Object.assign(e.get("renderedElements"),{title:!!He(o),description:!!Qe(o)})})},setInitialFocus({prop:e,scope:o}){e("modal")||S(()=>{const t=j({root:O(o),getInitialEl:e("initialFocusEl"),enabled:e("autoFocus")});t==null||t.focus({preventScroll:!0})})},setFinalFocus({event:e,scope:o}){var n;const t=e.restoreFocus??((n=e.previousEvent)==null?void 0:n.restoreFocus);t!=null&&!t||S(()=>{const s=f(o);s==null||s.focus({preventScroll:!0})})},invokeOnOpen({prop:e}){var o;(o=e("onOpenChange"))==null||o({open:!0})},invokeOnClose({prop:e}){var o;(o=e("onOpenChange"))==null||o({open:!1})},toggleVisibility({event:e,send:o,prop:t}){o({type:t("open")?"CONTROLLED.OPEN":"CONTROLLED.CLOSE",previousEvent:e})}}}});xe()(["autoFocus","closeOnEscape","closeOnInteractOutside","dir","getRootNode","id","ids","initialFocusEl","modal","onEscapeKeyDown","onFocusOutside","onInteractOutside","onOpenChange","onPointerDownOutside","defaultOpen","open","persistentElements","portalled","positioning"]);const Ze=e=>{const o=v.useId(),{getRootNode:t}=Ne(),{dir:n}=Fe(),s={id:o,dir:n,getRootNode:t,...e},i=Le(Xe,s);return Je(i,Be)},ze=e=>{const[o,{children:t,...n}]=he(e),s=Ze(n),i=Te(h({present:s.open},o));return d.jsx(qe,{value:s,children:d.jsx(Ce,{value:i,children:t})})},ge=v.forwardRef((e,o)=>{const t=b(),n=_(),s=h({...t.getTriggerProps(),"aria-controls":n.unmounted?void 0:t.getTriggerProps()["aria-controls"]},e);return d.jsx(R.button,{...s,ref:o})});ge.displayName="PopoverTrigger";const p=({children:e,onOpenChange:o,open:t,position:n=fe.top,...s})=>d.jsx(ze,{onOpenChange:o,open:t,positioning:{placement:n},...s,children:e});p.displayName="Popover";p.__docgenInfo={description:"",methods:[],displayName:"Popover",props:{onOpenChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(detail: PopoverOpenChangeDetail) => void",signature:{arguments:[{type:{name:"PopoverOpenChangeDetail"},name:"detail"}],return:{name:"void"}}},description:"Callback fired when the popover open state changes."},open:{required:!1,tsType:{name:"boolean"},description:"The controlled open state of the popover."},position:{required:!1,tsType:{name:"literal",value:"`${OVERLAY_POSITION}`"},description:`@type=POPOVER_POSITION
...
}`,...(U=(K=T.parameters)==null?void 0:K.docs)==null?void 0:U.source}}};var H,Q,J;C.parameters={...C.parameters,docs:{...(H=C.parameters)==null?void 0:H.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: ({}) => <Popover>
      <PopoverTrigger asChild>
        <Button>
...
}`,...(J=(Q=C.parameters)==null?void 0:Q.docs)==null?void 0:J.source}}};var X,Z,z;w.parameters={...w.parameters,docs:{...(X=w.parameters)==null?void 0:X.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: ({}) => <Popover>
      <PopoverTrigger>
        Show popover
...
}`,...(se=(ne=I.parameters)==null?void 0:ne.docs)==null?void 0:se.source}}};const to=["Demo","Controlled","CustomTrigger","Default","Grid","Overview"],ho=Object.freeze(Object.defineProperty({__proto__:null,Controlled:T,CustomTrigger:C,Default:w,Demo:E,Grid:y,Overview:I,__namedExportsOrder:to,default:oo},Symbol.toStringTag,{value:"Module"}));export{C,w as D,y as G,I as O,ho as P,T as a};
