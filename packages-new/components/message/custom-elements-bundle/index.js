import { HTMLElement, h, Host, createEvent, proxyCustomElement } from '@stencil/core/internal/client';
...
const OsdsMessage$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    ...
    this.inline = DEFAULT_ATTRIBUTE$1.inline;
    /** @see OdsMessageAttributes.icon */
    this.icon = DEFAULT_ATTRIBUTE$1.icon;
    /** @see OdsMessageAttributes.removable */
    this.removable = DEFAULT_ATTRIBUTE$1.removable;
    /** @see OdsMessageAttributes.type */
    this.type = DEFAULT_ATTRIBUTE$1.type;
...
const OsdsMessage = /*@__PURE__*/proxyCustomElement(OsdsMessage$1, [1,"osds-message",{"color":[1537],"inline":[516],"icon":[1537],"removable":[516],"type":[513],"contrasted":[516]}]);
...
export { ODS_MESSAGE_TYPE, ODS_MESSAGE_TYPES, OsdsIcon, OsdsMessage, defineCustomElements };
