...
const OsdsIcon = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement() {
  ...
  const components = ["osds-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "osds-icon":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, OsdsIcon);
      }
      break;
  } });
}

export { OsdsIcon as O, OdsThemeColorIntent as a, OdsLogger as b, ODS_ICON_SIZE as c, defineCustomElement as d, odsIsTermInEnum as o };
