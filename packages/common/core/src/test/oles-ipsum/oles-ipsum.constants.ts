export const OLES_IPSUM_START = 'Oles ipsum dolor sit amet, ';

export const LOREM_IPSUM = 'consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ' +
...
export const LOREM_IPSUM_KEYWORDS = ['a', 'ac', 'accommodare', 'accumsan', 'accusata', 'ad', 'adhuc', 'adipisci',
...
export const LOREM_IPSUM_PUNCTUATION = ['.', '?'];
export const LOREM_IPSUM_CARRIAGE_RETURN = '\n';

export const OVHCLOUD_KEYWORDS = ["address", "advance", "anonymous", "application", "armor", "array", "availability", "back", "backup", "balancer", "bandwidth", "bare", "bastion",
