...
**Note:** Version bump only for package @ovhcloud/ods-component-progress-bar-react
...
**Note:** Version bump only for package @ovhcloud/ods-stencil-progress-bar-react
