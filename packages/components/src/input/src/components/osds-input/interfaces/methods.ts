import type { OdsCommonFieldValidityState, OdsFormControlMethods } from '@ovhcloud/ods-common-core';

interface OdsInputMethod extends OdsFormControlMethods<OdsCommonFieldValidityState> {
  /**
