...
In `packages/tools/storybook/stories/components/1_Introduction.stories.ts`, you can add your component depending on its type (quark, atom, molecule, organism, layout or meta).
...
atoms: [
  {
    name: "%Component",
    tag: 'osds-‰component%',
    url: '/?path=/story/ui-components-%component%-atom-web-component--default',
    attributes: {
