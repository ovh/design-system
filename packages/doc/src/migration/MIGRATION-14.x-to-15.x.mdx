...
Update your dependency from `@ovhcloud/ods-stencil-text` to `@ovhcloud/ods-component-text`.
...
Update your dependency from `@ovhcloud/ods-stencil-textarea` to `@ovhcloud/ods-component-textarea`.
