...
As it is a major version, you have to do the [migration guide 14.x to 15.x](/story/ovhcloud-design-system-what-s-new-migration-guide-14-x-to-15-x--page)
...
* **Form Field**: [See Form Field Documentation](/story/form-field--default)
* **Switch**: [See Form Field Documentation](/story/switch--default)
...
### New features:
We added the following components:
* **Progress Bar**: [See Progress Bar Documentation](/story/progress-bar--default)
* **Popover**: [See Popover Documentation](/story/popover--default)
* **Tooltip**: [See Popover Documentation](/story/tooltip--default)

Components version 2:
* **Input V2**: [See Input Documentation](/story/input--default)
...
* **Select V2**: it is now connected to our CDK and keyboard navigation has been added [See Select Documentation](/story/select--default)

**Quantity** component accepts four digits in the input field:
[See Quantity Documentation](/story/quantity--default)
...
### New features:
We added the following components:
* Breadcrumb: [See Breadcrumb Documentation](/story/breadcrumb--default)
* Collapsible: [See Collapsible Documentation](/story/collapsible--default)
* Pagination: [See Pagination Documentation](/story/pagination--default)
* Spinner: [See Spinner Documentation](/story/spinner--default)

[Circle-shaped button](/story/button--default) has been added to Button Component (circle attribute)
...
[See Tabs Documentation](/story/ui-components-tabs-atom-specifications--page)
...
[Dual range](/story/range--dual) is now available for Range component; It offers two handles to set a min and max value.
...
[See Select Documentation](/story/ui-components-select-atom-specifications--page)
