...
<IdentityCard aliases={ ['Call To Action', 'CTA'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/button"
              name="Button">
...
**Buttons** don't usually redirect to an external page. For that, see <DocLink to="/components/link">Link</DocLink>.
...
<Anatomy src="components/button/anatomy.png" />
...
<Canvas story="AccessibilityExplicitTextContent" />
