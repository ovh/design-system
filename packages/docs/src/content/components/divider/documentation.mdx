...
<Canvas story="Default" source="none" />
...
<IdentityCard aliases={ ['Separator', 'Spacer', 'Horizontal Line'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/divider"
              name="Divider">
...
<Anatomy src="components/divider/anatomy.png" />
