...
<IdentityCard aliases={ ['Complex Tooltip'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/popover"
              name="Popover">
...
- Both components look similar but a <DocLink to="/components/tooltip">Tooltip</DocLink> is displayed on hover and focus while **Popover** is triggered by click.
...
<Anatomy src="components/popover/anatomy.png" />
...
Pressing <Kbd>Escape</Kbd> closes the currently opened **Popover**.

Pressing <Kbd>Tab</Kbd> moves focus forward through the focusable elements inside the **Popover**.

Pressing <Kbd>Shift</Kbd> + <Kbd>Tab</Kbd> moves focus backward within the **Popover**.
...
<Canvas story="AccessibilityWithMenu" />
