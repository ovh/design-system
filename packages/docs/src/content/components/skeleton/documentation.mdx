...
<IdentityCard aliases={ ['Skeleton loader'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/skeleton"
              name="Skeleton">
...
Both <DocLink to="/components/spinner">Spinner</DocLink> and **Skeleton** indicate that content is loading, but they serve different purposes:
