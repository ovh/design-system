...
Both **Spinner** and <DocLink to="/components/skeleton">Skeleton</DocLink> indicate that content is loading, but they serve different purposes:
...
<Canvas story="AccessibilityAriaBusyAriaLive" />
