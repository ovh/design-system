...
<Canvas story="AccessibilityBadPracticeLabelledBy" />

<Icon name="circle-xmark"
      style={{ color: 'var(--ods-color-critical-500)' }} /> Screen readers will announce a button.

<Canvas story="AccessibilityLabelledBy" />
...
<Canvas story="AccessibilityBadPracticeDecorative" />
...
<Canvas story="AccessibilityBadPracticeLoading" />
...
<Canvas story="AccessibilityLoading" />
...
<Canvas story="AccessibilityBadPracticesRoleAlert" />
...
<Canvas story="AccessibilityRoleAlert" />
...
<Canvas story="AccessibilityBadPracticeRating" />
...
<Canvas story="AccessibilityRating" />
