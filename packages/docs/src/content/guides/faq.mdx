...
See <DocLink to="/components/drawer">Drawer example</DocLink>
and <DocLink to="/components/modal">Modal example</DocLink>.

<Heading label="Icons are not displayed" level={ 2 } />

Ensure you did import the fonts in your application, check the <DocLink to="/guides/get-started">get started</DocLink>
