...
<Canvas story="GuideFormMandatory" source="hidden" />
...
<Canvas story="GuideFormError" source="hidden" />
...
<Canvas story="GuideFormSimple" source="hidden" />

<Heading label="Grouped fields form" level={ 3 } />

<Canvas story="GuideFormGroupedField" source="hidden" />

<Heading label="Critical form" level={ 3 } />

<Canvas story="GuideFormCritical" source="hidden" />
