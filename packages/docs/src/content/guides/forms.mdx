...
<Canvas story="GuideFormMandatory" from="form-field" source="hidden" />
...
<Canvas story="GuideFormError" from="form-field" source="hidden" />
...
<Canvas story="GuideFormSimple" from="form-field" source="hidden" />

<Heading label="Grouped fields form" level={ 3 } />

<Canvas story="GuideFormGroupedField" from="form-field" source="hidden" />

<Heading label="Critical form" level={ 3 } />

<Canvas story="GuideFormCritical" from="form-field" source="hidden" />
...
Use <DocLink to="/components/input">Input</DocLink> component.
...
Use <DocLink to="/components/textarea">Textarea</DocLink> component.
...
Use <DocLink to="/components/password">Password</DocLink> component.
...
Use <DocLink to="/components/input">Input</DocLink> or <DocLink to="/components/quantity">Quantity</DocLink> component
...
Use <DocLink to="/components/range">Range</DocLink> component.
...
Use <DocLink to="/components/radio-group">Radio</DocLink> buttons.
...
Use <DocLink to="/components/select">Select</DocLink> when the list is limited and easy to scan visually.
...
Use <DocLink to="/components/combobox">Combobox</DocLink> when the list is long or when search significantly improves usability.
...
Use <DocLink to="/components/checkbox">Checkboxes</DocLink>.
...
Use <DocLink to="/components/toggle">Toggle</DocLink> component.
...
In those cases, use a <DocLink to="/components/checkbox">Checkbox</DocLink>.

<Heading label="When the user must select a specific date" level={ 3 } />

Use <DocLink to="/components/datepicker">Datepicker</DocLink> component.
...
Use <DocLink to="/components/file-upload">File Upload</DocLink> component.
...
<Heading label="Implementing a Form" level={ 1 } />
...
You can use each form element directly in your own form, or wrap them using the <DocLink to="/components/form-field">Form Field</DocLink> component.

<Heading label="Form Field" level={ 2 } />

Using <DocLink to="/components/form-field">Form Field</DocLink> component
