...
- <DocLink to="/components/datepicker">Datepicker</DocLink>
- <DocLink to="/components/phone-number">Phone number</DocLink>
...
For example, take the <DocLink to="/components/message">Message</DocLink> component:

![i18n anatomy](components/message/anatomy-i18n.png)
