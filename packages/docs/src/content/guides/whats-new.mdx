...
<DocLink to="/components/avatar">See Documentation</DocLink>.

**DataTable**

<DocLink to="/components/data-table">See Documentation</DocLink>.

**FileThumbnail**

<DocLink to="/components/file-thumbnail">See Documentation</DocLink>.

**Markdown**

<DocLink to="/components/markdown">See Documentation</DocLink>.

**MessageBubble**

<DocLink to="/components/message-bubble">See Documentation</DocLink>.

**PromptInput**

<DocLink to="/components/prompt-input">See Documentation</DocLink>.

**QueryFilter**

<DocLink to="/components/query-filter">See Documentation</DocLink>.

<Heading label="New recipes:" level={ 3 } />

**Data Grid with Query Filter**

<DocLink to="/recipes/components">See Recipes</DocLink>.
...
<DocLink to="/components/cart">See Documentation</DocLink>.

**Menu**

<DocLink to="/components/menu">See Documentation</DocLink>.
...
<DocLink to="/components/editable">See Documentation</DocLink>.

**Logo**

<DocLink to="/components/logo">See Documentation</DocLink>.

**Tile**

<DocLink to="/components/tile">See Documentation</DocLink>.
...
You can see some examples on the <DocLink to="/components/modal">Modal Technical Page</DocLink>.
...
<DocLink to="/components/button-group">See Documentation</DocLink>.

**Kbd**

<DocLink to="/components/kbd">See Documentation</DocLink>.
...
<DocLink to="/components/toaster">See Documentation</DocLink>
...
<DocLink to="/components/meter">See Documentation</DocLink>

**TreeView**

<DocLink to="/components/tree-view">See Documentation</DocLink>
...
- a <DocLink to="/guides/accessibility">guide about accessibility</DocLink> best practices.
...
See the related storybook <DocLink to="/guides/internationalization">Internationalization guide</DocLink> for more information.
...
To check how to start with this new version, please follow the <DocLink to="/guides/get-started">Get Started</DocLink> documentation.
...
<DocLink to="/components/combobox">See Documentation</DocLink>
...
**Icon**
- `alt` attribute has been removed. This optional attribute was in fact doing nothing at all, it can safely be kept if you were using it, but you should remove it and follow the <DocLink to="/components/icon">accessibility best practices</DocLink> instead.
...
- Update the accessibility section of the <DocLink to="/components/icon">Icon</DocLink> component, with best practices and examples.
...
<DocLink to="/components/drawer">See Documentation</DocLink>
...
**Input**
- You can now link a native `datalist` to an `ods-input` using the `list` attribute and the `list` slot. A full example is available in the <DocLink to="/components/input">Technical information</DocLink> page.
...
As it is a major version, you'll have to follow the <DocLink to="/guides/migration-17-to-18">migration guide 17.x to 18.x</DocLink>
...
<DocLink to="/components/file-upload">See Documentation</DocLink>

**Timepicker**

<DocLink to="/components/timepicker">See Documentation</DocLink>

<Heading label="Component changes:" level={ 3 } />

Please check the <DocLink to="/guides/migration-17-to-18">migration guide</DocLink> regarding all the component changes.
...
<DocLink to="/components/table">See Documentation</DocLink>
...
As it is a major version, you'll have to follow the <DocLink to="/guides/migration-16-to-17">migration guide 16.x to 17.x</DocLink>
...
* the updated <DocLink to="/guides/get-started">Get Started documentation</DocLink>
* the 16.x to 17.x <DocLink to="/guides/migration-16-to-17">Migration guide</DocLink>
...
<DocLink to="/components/medium">See Documentation</DocLink>
...
<DocLink to="/components/datepicker">See Documentation</DocLink>
...
<DocLink to="/components/phone-number">See Documentation</DocLink>
...
As it is a major version, you'll have to follow the <DocLink to="/guides/migration-15-to-16">migration guide 15.x to 16.x</DocLink>
...
<DocLink to="/components/clipboard">See Documentation</DocLink>
...
<DocLink to="/components/modal">See Documentation</DocLink>
...
As it is a major version, you have to do the <DocLink to="/guides/migration-14-to-15">migration guide 14.x to 15.x</DocLink>
...
<DocLink to="/components/form-field">See Documentation</DocLink>

**Switch**

<DocLink to="/components/switch">See Documentation</DocLink>
...
> For more information, check our documentation <DocLink to="/components/pagination">See Documentation</DocLink>
...
As it is a major version, you have to do the <DocLink to="/guides/migration-13-to-14">migration guide 13.x to 14.x</DocLink>

<Heading label="New features:" level={ 3 } />

We added the following components:

* **Progress Bar**: <DocLink to="/components/progress-bar">See Documentation</DocLink>
* **Popover**: <DocLink to="/components/popover">See Documentation</DocLink>
* **Tooltip**: <DocLink to="/components/tooltip">See Documentation</DocLink>

Components version 2:

* **Input V2**: <DocLink to="/components/input">See Documentation</DocLink>
...
* **Select V2**: it is now connected to our CDK and keyboard navigation has been added <DocLink to="/components/select">See Documentation</DocLink>

**Quantity** component accepts four digits in the input field:

<DocLink to="/components/quantity">See Documentation</DocLink>
...
As it is a major version, you have to do the <DocLink to="/guides/migration-12-to-13">migration guide 12.x to 13.x</DocLink>

<Heading label="New features:" level={ 3 } />

We added the following components:

* Breadcrumb: <DocLink to="/components/breadcrumb">See Documentation</DocLink>
* Collapsible: See Documentation using version selector
* Pagination: <DocLink to="/components/pagination">See Documentation</DocLink>
* Spinner: <DocLink to="/components/spinner">See Documentation</DocLink>
...
<DocLink to="/components/tabs">See Documentation</DocLink>
...
For more details about assets, see <DocLink to="/guides/get-started">Installation</DocLink> page.
...
<DocLink to="/components/select">See Documentation</DocLink>
...
You can read the updated <DocLink to="/guides/get-started">Getting Started</DocLink>
