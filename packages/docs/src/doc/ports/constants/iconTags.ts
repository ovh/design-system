/* Search aliases per icon, ported verbatim from the Storybook constants — the
   gallery filter matches on the icon name AND on these tags. */
import { type ICON_NAME } from '../../../ods';
