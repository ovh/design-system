export const translations: Record<string, string> = {
  ...
  'cart.price': '€ {{price}}',
  'cart.extra': 'extra fees € {{extra}} not included',
  'footer.item.price': '€ {{price}}',

  // translation used by you that to the cart through properties
  'my-cart.header.title': 'my cart',
  'my-cart.footer.total': 'Grand Total',
