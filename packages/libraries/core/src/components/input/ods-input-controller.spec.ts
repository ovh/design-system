...
import { OdsInputMock } from './ods-input-mock';
...
describe('spec:ods-input-controller', () => {
  ...
  function setup(attributes: Partial<OdsInput> = {}) {
    component = { ...component, ...attributes };
    controller = new OdsInputController(component);
  }

  beforeEach(() => {
    component = new OdsInputMock();
  ...
  describe('methods', () => {
    ...
    describe('methods:onInput', () => {
      ...
      it('should not change component value if it is disabled', () => {
        const value = '3';
        const inputEl = document.createElement('input');
        setup({ disabled: true, value, type: OdsInputType.number, inputEl });
        controller.onInput(new Event(''));
      ...
      it('should change the component number value', () => {
        const inputEl = document.createElement('input');
        inputEl.value = '5';
        setup({ disabled: false, value: '3', type: OdsInputType.number, inputEl });
        controller.onInput(new Event(''));
