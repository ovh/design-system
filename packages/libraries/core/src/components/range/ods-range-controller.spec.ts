...
import { OdsRangeMock } from './ods-range-mock';
...
describe('spec:ods-range-controller', () => {
  ...
  function setup(attributes: Partial<OdsRange> = {}) {
  ...
  describe('methods', () => {
    ...
    describe('methods:onFormControlChange', () => {
      it('should call formControl.register', () => {
        const formControl = new OdsFormControl<OdsRangeValidityState>('id');
    ...
    describe('methods:hasError', () => {
      it('should return false', () => {
        setup({ error: false });
        controller.getRangeValidity = jest.fn().mockImplementation(() => { return { invalid: false } });
      ...
      it('should return true if getRangeValidity.invalid', () => {
        setup({ error: false });
        controller.getRangeValidity = jest.fn().mockImplementation(() => { return { invalid: true } });
        const hasError = controller.hasError();
        expect(hasError).toEqual(true);
      });
    });
