...
import { DataTable, DataTableBody, type DataTableColumnDef, type DataTableColumnPinningState, DataTableEmpty, DataTableHead, type DataTableRowSelectionState, type DataTableSortingState } from '.';
...
//  if so, we need to add manualPagination option + specific model (see https://tanstack.com/table/latest/docs/guide/pagination)
