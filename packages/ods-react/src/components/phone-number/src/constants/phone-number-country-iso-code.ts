enum PHONE_NUMBER_COUNTRY_ISO_CODE {
  ad = 'ad', // Andorra
...
type PhoneNumberCountryIsoCode = `${PHONE_NUMBER_COUNTRY_ISO_CODE}`;

const PHONE_NUMBER_COUNTRY_ISO_CODES = Object.freeze(Object.values(PHONE_NUMBER_COUNTRY_ISO_CODE));

export {
  PHONE_NUMBER_COUNTRY_ISO_CODE,
  PHONE_NUMBER_COUNTRY_ISO_CODES,
  type PhoneNumberCountryIsoCode,
};
