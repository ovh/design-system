import { OdsPopoverBaseUI as OdsPopover, OdsPopoverContentBaseUI as OdsPopoverContent, OdsPopoverTriggerBaseUI as OdsPopoverTrigger } from '.';
...
export const CustomTrigger = () => (
  <OdsPopover>
    <OdsPopoverTrigger render={ <OdsButton /> }>
      Custom Trigger
    </OdsPopoverTrigger>
    <OdsPopoverContent>
