...
import { type FC, HTMLAttributes, type JSX } from 'react';
...
type OdsSpinnerProp = HTMLAttributes<HTMLDivElement> & {
  ...
  return (
    <div
      className={ classNames(
        styles['ods-spinner'],
        styles[`ods-spinner--${color}`],
        styles[`ods-spinner--${size}`],
      )}
      role="progressbar"
      { ...props }>
      <svg
        className={ styles['ods-spinner__svg'] }
        viewBox="0 0 24 24"
