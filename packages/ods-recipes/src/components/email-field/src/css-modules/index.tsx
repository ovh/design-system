  ...
  return (
    <FormField>
      ...
      <div className={style["email-field__field"]}>
        ...
        <Text className={style["email-field__field__at"]} preset={TEXT_PRESET.span}>
          @
        </Text>

        <Select items={DOMAINS} name="domain">
          <SelectControl className={style["email-field__field__select"]} placeholder="Select domain" />
