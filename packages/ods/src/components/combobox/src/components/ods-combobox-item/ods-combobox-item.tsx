...
export class OdsComboboxItem {
  ...
  @Prop({ reflect: true }) public searchLabel?: string; // TODO remove? or allow multiple terms to add to regex?
  ...
  public async select(): Promise<void> {
    this.odsComboboxSelected.emit({
      id: this.el.id,
      // text: this.searchLabel || this.el.textContent || '', // TODO move this to controller function
