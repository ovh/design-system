...
import { getInitialValue, hasNoValueOption, inlineValue, moveSlottedElements, setSelectValue, updateInternals } from '../../src/controller/ods-combobox';
...
describe('ods-combobox controller', () => {
  ...
  // describe('getSelectPlugin', () => {
  //   it('should return default config', () => {
  //     // @ts-ignore for test purpose
  //     expect(getSelectPlugin(false, false, null)).toEqual({
  ...
  //     // @ts-ignore for test purpose
  //     expect(getSelectPlugin(true, false, null)).toEqual({
  //       caret_position: {},
  //       input_autogrow: {},
  //       remove_item_on_ods_remove_plugin: {},
  //     });
  //   });
  //
  //   it('should return clearable selection config', () => {
  //     const dummyTemplateFunction = () => '';
  //
  //     expect(getSelectPlugin(false, true, dummyTemplateFunction)).toEqual({
  //       clear_button: { html: dummyTemplateFunction },
  //       remove_item_on_ods_remove_plugin: {},
  //     });
  //   });
  // });
