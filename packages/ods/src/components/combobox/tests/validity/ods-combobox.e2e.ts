...
describe('ods-combobox validity', () => {
  ...
  describe('initialization', () => {
    describe('with no value attribute defined', () => {
      it('should return validity true if not required', async() => {
        ...
        await setup('<ods-combobox allow-multiple><option value="1">1</option></ods-combobox>');

        expect(await el.callMethod('checkValidity')).toBe(true);
      });

      it('should return validity false if required', async() => {
        await setup('<ods-combobox is-required><option value="1">1</option></ods-combobox>');

        expect(await el.callMethod('checkValidity')).toBe(false);

        await setup('<ods-combobox allow-multiple is-required><option value="1">1</option></ods-combobox>');
    ...
    describe('with empty string value', () => {
      it('should return validity true if not required', async() => {
        await setup('<ods-combobox value=""><option value="1">1</option></ods-combobox>');

        expect(await el.callMethod('checkValidity')).toBe(true);

        await setup('<ods-combobox allow-multiple value=""><option value="1">1</option></ods-combobox>');

        expect(await el.callMethod('checkValidity')).toBe(true);
      });

      it('should return validity false if required', async() => {
        await setup('<ods-combobox value="" is-required><option value="1">1</option></ods-combobox>');

        expect(await el.callMethod('checkValidity')).toBe(false);

        await setup('<ods-combobox allow-multiple value="" is-required><option value="1">1</option></ods-combobox>');
    ...
    describe('with no value but default-value defined', () => {
      it('should return validity true if not required', async() => {
        await setup('<ods-combobox default-value="2"><option value="1">1</option><option value="2">2</option></ods-combobox>');

        expect(await el.callMethod('checkValidity')).toBe(true);

        await setup('<ods-combobox allow-multiple default-value="2"><option value="1">1</option><option value="2">2</option></ods-combobox>');

        expect(await el.callMethod('checkValidity')).toBe(true);
      });

      it('should return validity true if required', async() => {
        await setup('<ods-combobox default-value="2" is-required><option value="1">1</option><option value="2">2</option></ods-combobox>');

        expect(await el.callMethod('checkValidity')).toBe(true);

        await setup('<ods-combobox allow-multiple default-value="2" is-required><option value="1">1</option><option value="2">2</option></ods-combobox>');
    ...
    describe('with defined value', () => {
      it('should return validity true if not required', async() => {
        await setup('<ods-combobox value="1"><option value="1">1</option><option value="2">2</option></ods-combobox>');

        expect(await el.callMethod('checkValidity')).toBe(true);

        await setup('<ods-combobox allow-multiple value="1"><option value="1">1</option><option value="2">2</option></ods-combobox>');

        expect(await el.callMethod('checkValidity')).toBe(true);
      });

      it('should return validity true if required', async() => {
        await setup('<ods-combobox value="1" is-required><option value="1">1</option><option value="2">2</option></ods-combobox>');

        expect(await el.callMethod('checkValidity')).toBe(true);

        await setup('<ods-combobox allow-multiple value="1" is-required><option value="1">1</option><option value="2">2</option></ods-combobox>');
  ...
  describe('methods', () => {
    describe('checkValidity', () => {
      it('should return true if internals validity is true', async() => {
        ...
        await setup('<ods-combobox default-value="1" is-required><option value="1">1</option><option value="2">2</option></ods-combobox>');
        expect(await el.callMethod('checkValidity')).toBe(true);
      });
      ...
      it('should return false if internals validity is false', async() => {
        ...
        await setup('<ods-combobox default-value="" is-required><option value="1">1</option></ods-combobox>');
        expect(await el.callMethod('checkValidity')).toBe(false);
      });
    });
    ...
    describe('clear', () => {
      it('should update the validity state accordingly, given value', async() => {
        await setup('<ods-combobox value="1" is-required><option value="1">1</option></ods-combobox>');
      ...
      it('should update the validity state accordingly, given default-value', async() => {
        await setup('<ods-combobox default-value="1" is-required><option value="1">1</option></ods-combobox>');
    ...
    describe('reset', () => {
      it('should update the validity state accordingly, given value', async() => {
        await setup('<ods-combobox default-value="2" value="1" is-required><option value="1">1</option><option value="2">2</option></ods-combobox>');
  ...
  describe('in a form', () => {
    it('should not submit the form on submit before any changes if input is invalid', async() => {
      await setup('<form method="get" onsubmit="return false"><ods-combobox is-required><option value="1">1</option></ods-combobox></form>');
    ...
    it('should submit the form if input is valid', async() => {
      await setup('<form method="get" onsubmit="return false"><ods-combobox is-required value="1"><option value="1">1</option></ods-combobox></form>');
