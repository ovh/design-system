...
export class OdsDatepicker {
  ...
  handleInputValueReset() {
    this.onChange(new Date(this.defaultValue as string))
  }
  ...
  componentWillLoad(): void {
    ...
    if (!this.value) {
      this.value = (typeof this.defaultValue === 'string' ? new Date(this.defaultValue) : this.defaultValue) ?? null;
    }
    setFormValue(this.internals ,this.formatDate(this.value) ?? null);
  }

  formResetCallback(): void {
    this.value = typeof this.defaultValue === 'string' ? new Date(this.defaultValue) : this.defaultValue;
  }
    ...
    return (
      ...
      >
        <ods-input
          ...
          defaultValue={ typeof this.defaultValue === 'string' ? this.defaultValue : this.formatDate(this.defaultValue) }
          exportparts="input"
