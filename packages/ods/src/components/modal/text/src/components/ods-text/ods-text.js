...
export class OdsText {
    ...
    render() {
        ...
        return (h(Host, { key: '277747930065fc76c9e394fd5a887eea76ec16fd', class: "ods-text" }, h(Tag, { key: '2aa7b033b929ef356755fcf1986cdb042e1e89d9', class: `ods-text--${this.preset}`, part: "text" }, h("slot", { key: '1af8e4c09c9be3e3077568f88d74661c2b4eb4f5' }))));
    }
