...
export class OdsInput {
    ...
    render() {
        ...
        return (h(Host, { key: 'c83e4283bc69956d082dc1c81a46e57876b8a1fa', class: "ods-input" }, h("input", { key: '8692cb3d867c71dba6937f67f3fbcc7e24ad189a', "aria-label": this.ariaLabel, "aria-labelledby": this.ariaLabelledby, class: {
            ...
            }, disabled: this.isDisabled, max: this.max, maxlength: this.maxlength, min: this.min, minlength: this.minlength, name: this.name, onBlur: () => this.odsBlur.emit(), onFocus: () => this.odsFocus.emit(), onInput: () => this.onInput(), pattern: this.pattern, part: "input", placeholder: this.placeholder, readonly: this.isReadonly, ref: (el) => this.inputEl = el, required: this.isRequired, step: this.step, type: this.isPassword && this.isMasked ? ODS_INPUT_TYPE.password : this.type, value: ((_a = this.value) === null || _a === void 0 ? void 0 : _a.toString()) || '' }), h("div", { key: '7e44d63303e80f1d07b75b0689df16fcadc9eb48', class: "ods-input__actions" }, this.isLoading && h("ods-spinner", { class: "ods-input__actions__spinner", color: this.isDisabled ? ODS_SPINNER_COLOR.neutral : ODS_SPINNER_COLOR.primary }), hasClearableIcon &&
            h("button", { class: {
