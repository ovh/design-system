export default [
  ...
  { isoCode: 'gf', name: 'Guayana Francesa' },
  ...
  { isoCode: 'io', name: 'Territorio Británico del Océano Índico' },
  ...
  { isoCode: 'pm', name: 'San Pedro y Miquelón' },
  ...
  { isoCode: 'sj', name: 'Svalbard y Jan Mayen' },
  ...
  { isoCode: 'sx', name: 'San Martín (Países Bajos)' },
