jest.mock('@ovhcloud/ods-core/src/components/accordion-group/ods-accordion-group-controller'); // keep jest.mock before any import

import { OdsAccordionGroupController, OdsAccordionMock } from '@ovhcloud/ods-core';
...
describe('spec:osds-accordion-group', () => {
  ...
  describe('controller', () => {
    ...
    it('should call controller.registerAccordion from registerAccordion method', async () => {
      const accordion = new OdsAccordionMock() as unknown as (HTMLElement & OsdsAccordion);
      await setup();
