...
import { OdsCreateAttributes, odsFlagBaseAttributes, OdsStringAttributes2Str } from '@ovhcloud/ods-testing';
import { odsSetE2eInterceptRequest } from '@ovhcloud/ods-stencil/libraries/stencil-testing';
import { HTTPRequest as pRequest } from 'puppeteer';
...
describe('e2e:osds-flag', () => {
  ...
  async function setup({ attributes, html = '', cbkInterceptorRequest, outsideViewport }: { attributes: Partial<OdsFlagAttributes>, html?: string, cbkInterceptorRequest?: (request: pRequest) => void, outsideViewport?: boolean }) {
