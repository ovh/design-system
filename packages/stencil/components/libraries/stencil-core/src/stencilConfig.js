...
export function getStencilConfig({ namespace, args, jestConfig, distCustomElements, distCustomElementsBundle, reactOutput, vueOutput, dev, prod }) {
   ...
   * @see https://stenciljs.com/docs/cli
   */
  isProd = args.includes('--prod'), isTest = args.includes('--e2e') || args.includes('--spec');
  ...
  let distCustomElementsBundleCopy = [];
  ...
  // globalScript
  let globalScriptOption = {};
  if (isDev && (dev === null || dev === void 0 ? void 0 : dev.globalScript)) {
    globalScriptOption = { globalScript: dev.globalScript };
  }
  else if (isProd && (prod === null || prod === void 0 ? void 0 : prod.globalScript)) {
    globalScriptOption = { globalScript: prod.globalScript };
  }
  (globalScriptOption === null || globalScriptOption === void 0 ? void 0 : globalScriptOption.globalScript) && console.info(`ODS: integrates globalScript ${globalScriptOption.globalScript} into the Build`);
  // tsConfig
  let tsConfigOption = {};
  if (isDev) {
    tsConfigOption = { tsconfig: (dev === null || dev === void 0 ? void 0 : dev.tsConfig) ? dev.tsConfig : 'tsconfig.dev.json' };
  }
  else if (isProd) {
    tsConfigOption = { tsconfig: (prod === null || prod === void 0 ? void 0 : prod.tsConfig) ? prod.tsConfig : 'tsconfig.prod.json' };
  }
  (tsConfigOption === null || tsConfigOption === void 0 ? void 0 : tsConfigOption.tsconfig) && console.info(`ODS: using ${tsConfigOption.tsconfig}`);
  return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ namespace }, ((isDev) ? {
    sourceMap: true
  } : {})), ((isTest || isDev) ? {
    ...
    ] }), tsConfigOption), { outputTargets: [
      // generate react output only if we are not in dev mode (serving)
      ...(isDev ? [] : [
        reactOutputTarget(Object.assign({ componentCorePackage: '@ovhcloud/ods-stencil/components', proxiesFile: './react/src/components/stencil-generated/index.ts', customElementsDir: 'custom-elements', includeImportCustomElements: true, includePolyfills: false, includeDefineCustomElements: false }, reactOutput)),
        vueOutputTarget(Object.assign({ componentCorePackage: '@ovhcloud/ods-stencil/components', proxiesFile: './vue/src/components/stencil-generated/index.ts', customElementsDir: 'custom-elements', includeImportCustomElements: true, includePolyfills: false, includeDefineCustomElements: false }, vueOutput))
      ]),
      {
        type: 'dist',
        esmLoaderPath: '../loader',
      },
      Object.assign(Object.assign({ type: 'dist-custom-elements', dir: 'custom-elements', includeGlobalScripts: false }, (distCustomElements ? distCustomElements : {})), { copy: distCustomElementsCopy }),
      Object.assign(Object.assign({ type: 'dist-custom-elements-bundle', dir: 'custom-elements-bundle', includeGlobalScripts: false }, (distCustomElementsBundle ? distCustomElementsBundle : {})), { copy: distCustomElementsBundleCopy }),
      {
        type: 'docs-readme',
        dir: 'dist/docs',
      },
