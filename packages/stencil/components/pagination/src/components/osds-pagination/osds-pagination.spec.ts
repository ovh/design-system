...
describe('spec:osds-pagination', () => {
  ...
  describe('attributes', () => {
    const config = {
      page: () => page,
      instance: () => instance,
      setup: async (options: {attributes?: Partial<OdsPaginationAttributes> | undefined}) => {
    ...
    describe('totalItems', () => {
      odsUnitTestAttribute<OdsPaginationAttributes, 'totalItems'>({
        ...getAttributeContextOptions<OdsPaginationAttributes, OsdsPagination, 'totalItems'>({
          name: 'totalItems',
          list: [1, 2, 3],
