...
export class OdsFlagController extends OdsComponentController {
  constructor(component) {
    super(component);
    this.logger = new OdsLogger('OdsFlagController');
    this.svgLoadContent = new OdsLoadContent([
   ...
   */
  onInit(onBecomeVisible, isBrowser = true) {
