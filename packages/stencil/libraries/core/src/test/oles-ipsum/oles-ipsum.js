import { LOREM_IPSUM_CARRIAGE_RETURN, LOREM_IPSUM_KEYWORDS, LOREM_IPSUM_PUNCTUATION, OLES_IPSUM_START, OVHCLOUD_KEYWORDS, } from './oles-ipsum.constants';
...
export function olesIpsum(generationType, amount) {
