  ...
  return (
    ...
    >
      ...
      >
        ...
        <g id="_x37_3379683-787c-4fcf-8e09-8c37de9198c9" transform="matrix(1 0 0 1 1645.59 422.3)">
          <path
            d="M-1326.32-418.05h10.33c5.9,0,10.5,1.59,13.81,4.78c3.3,3.19,4.96,7.96,4.96,14.34c0,3.19-0.42,6-1.27,8.44
          ...
          />
          <path
            d="M-1291.92-393.91c0-2.36,0.37-4.48,1.12-6.37c0.75-1.89,1.74-3.48,2.98-4.78c1.24-1.3,2.66-2.3,4.28-3.01
          ...
          />
          <path
            d="M-1259.83-387.13c1.3,1.02,2.59,1.82,3.86,2.39c1.28,0.57,2.66,0.86,4.16,0.86c1.57,0,2.73-0.32,3.48-0.97
          ...
          />
          <path
            d="M-1231.27-413.5c-1.22,0-2.22-0.35-3.01-1.06c-0.79-0.71-1.18-1.63-1.18-2.77c0-1.14,0.39-2.07,1.18-2.8
          ...
          />
          <path
            d="M-1221.18-374.21c0-1.22,0.35-2.35,1.06-3.39c0.71-1.04,1.73-1.98,3.07-2.8v-0.24
          ...
          />
          <path
            d="M-1188.55-408.43h5.6l0.47,3.89h0.24c1.3-1.26,2.7-2.34,4.22-3.25c1.51-0.9,3.27-1.36,5.28-1.36
          ...
          />
          <path
            d="M-1141.47-389.08c1.38,1.3,2.95,2.35,4.72,3.16c1.77,0.81,3.54,1.21,5.31,1.21c2.2,0,3.87-0.45,5.01-1.36
          ...
          />
          <path
            d="M-1110.88-373.18c0.37,0.1,0.74,0.15,1.09,0.15c1.53,0,2.76-0.46,3.69-1.39c0.92-0.92,1.62-2.12,2.09-3.57
          ...
          />
          <path
            d="M-1081.77-387.13c1.3,1.02,2.59,1.82,3.86,2.39s2.67,0.86,4.16,0.86c1.57,0,2.73-0.32,3.48-0.97
          ...
          />
          <path
            d="M-1055.63-403.06h-4.13v-5.07l4.48-0.29l0.83-7.91h5.66v7.91h7.38v5.37h-7.38v13.81
          ...
          />
          <path
            d="M-1037.81-393.91c0-2.36,0.37-4.48,1.12-6.37c0.75-1.89,1.74-3.48,2.98-4.78c1.24-1.3,2.66-2.3,4.28-3.01
          ...
          />
          <path
            d="M-1006.01-408.43h5.61l0.47,3.95h0.24c1.22-1.3,2.55-2.4,3.98-3.3c1.44-0.9,3.06-1.36,4.87-1.36
