import { BUTTON_VARIANT, ICON_NAME, MODAL_COLOR, Button, Clipboard, ClipboardControl, ClipboardTrigger, Icon, Modal, ModalBody, ModalContent, Tooltip, TooltipContent, TooltipTrigger } from '@ovhcloud/ods-react';
