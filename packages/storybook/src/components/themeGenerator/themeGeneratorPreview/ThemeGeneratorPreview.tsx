...
import * as Command from '../../../../stories/components/command/command.stories';
...
const THEME_PREVIEW_COMPONENTS: ThemePreviewItem[] = [
  ...
  { key: 'Command', kind: REACT_COMPONENTS_TITLE.command, label: 'Command' },
  ...
  { key: 'Markdown', kind: REACT_COMPONENTS_TITLE.markdown, label: 'Markdown' },
