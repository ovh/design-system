...
enum ODS_COMPONENTS_TITLE {
  ...
  fileUpload = `${SECTION.odsComponents}/${SECTION.formElements}/FileUpload`,
  flag = `${SECTION.odsComponents}/Flag`,
  formField = `${SECTION.odsComponents}/${SECTION.formElements}/FormField`,
  ...
  phoneNumber = `${SECTION.odsComponents}/${SECTION.formElements}/PhoneNumber`,
  popover = `${SECTION.odsComponents}/Popover`,
  progressBar = `${SECTION.odsComponents}/ProgressBar`,
  searchBar = `${SECTION.odsComponents}/SearchBar`,
