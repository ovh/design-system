...
2. **Icon**: A "down/up" chevron <StorybookLink kind={ ODS_COMPONENTS_TITLE.icon } story={ STORY.documentation }>Icon</StorybookLink> is used to indicate the “expand/collapse” action, though the entire header area is clickable (always visible).
...
<BestPractices
  donts={ [
    ...
    <span>- Use <StorybookLink kind={ ODS_COMPONENTS_TITLE.icon } story={ STORY.documentation }>Icon</StorybookLink> in header text</span>,
  ...
  dos={ [
    <span>- Header <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } story={ STORY.documentation }>Text</StorybookLink> describes the content contained in the panel. Use a clear and concise <StorybookLink
      kind={ ODS_COMPONENTS_TITLE.text } story={ STORY.documentation }>Text</StorybookLink>, and be explicit about the action that will happen if the option is selected</span>,
    <span>- Use sentence-style capitalization in header <StorybookLink kind={ ODS_COMPONENTS_TITLE.text }
                                                                       story={ STORY.documentation }>Text</StorybookLink> (only the first word in a phrase and any proper nouns capitalized), no more than three words, and no punctuation</span>,
    <span>- Use Accordion instead of <StorybookLink kind={ ODS_COMPONENTS_TITLE.tabs }
                                                    story={ STORY.documentation }>Tab</StorybookLink> if users need to see multiple sections at once</span>,
  ] }
/>
...
The header part can be navigated through tabulation, with the same behavior as a <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } story={ STORY.documentation }>Button</StorybookLink>.
