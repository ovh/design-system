...
<IdentityCard2 aliases={ ['Chip (previous name)', 'Label'] }
  ...
  title or <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" /> they complete.
</IdentityCard2>
...
1. **Container**
2. <StorybookLink kind="ODS Components/Icon" label="Icon" story="Documentation" /> - (optional)
3. **Label**
...
**Badges** are read by screen readers as regular <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" />.
