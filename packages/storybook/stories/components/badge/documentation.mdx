...
<IdentityCard aliases={ ['Chip (previous name)', 'Label'] }
  ...
  title or <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } label="Text" story={ STORY.documentation } /> they complete.
</IdentityCard>
...
1. **Container**
2. <StorybookLink kind={ ODS_COMPONENTS_TITLE.icon } label="Icon" story={ STORY.documentation } /> - (optional)
3. **Label** - (optional)
...
The notification status can be used next to a menu entry, a label or an option ; in dashboards, <StorybookLink kind={ ODS_COMPONENTS_TITLE.table } label="Table" story={ STORY.documentation } /> or summary panels.
...
**Badges** are read by screen readers as regular <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } label="Text" story={ STORY.documentation } />.

**Icon-only Badge** is only used in very specific cases. In the case of its use, it should be accompagnied by a hoverable/tab-able <StorybookLink kind={ ODS_COMPONENTS_TITLE.tooltip } label="Tooltip" story={ STORY.documentation } /> to provide further context.
