...
<IdentityCard aliases={ ['Chip (previous name)', 'Label'] }
  ...
  title or <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } story={ STORY.documentation }>Text</StorybookLink> they complete.
</IdentityCard>
...
1. **Container**
2. <StorybookLink kind={ ODS_COMPONENTS_TITLE.icon } story={ STORY.documentation }>Icon</StorybookLink> - (optional)
3. **Label** - (optional)
...
The notification status can be used next to a menu entry, a label or an option ; in dashboards, <StorybookLink kind={ ODS_COMPONENTS_TITLE.table } story={ STORY.documentation }>Table</StorybookLink> or summary panels.
...
**Badges** are read by screen readers as regular <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } story={ STORY.documentation }>Text</StorybookLink>.

**Icon-only Badge** is only used in very specific cases. In the case of its use, it should be accompanied by a hoverable/tab-able <StorybookLink kind={ ODS_COMPONENTS_TITLE.tooltip } story={ STORY.documentation }>Tooltip</StorybookLink> to provide further context.
