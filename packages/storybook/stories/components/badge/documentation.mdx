...
<BestPractices
  donts={[]}
  dos={[
    '- You must use either an icon or a label, or both.',
...
**Icon-only Badge** is only used in very specific cases. In the case of its use, it should be accompagnied by a hoverable/tab-able tooltip to provide further context.
