...
<Meta of={ BadgeStories } name="Migration v17 to v18" />
...
`disabled` <Badge color="critical" size="sm">Removed</Badge>
...
`removable` <Badge color="critical" size="sm">Removed</Badge>

Has been removed.

Badges are not interactive element anymore.

`selectable` <Badge color="critical" size="sm">Removed</Badge>
