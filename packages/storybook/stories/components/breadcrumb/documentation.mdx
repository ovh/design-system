...
_A list of <StorybookLink kind={ ODS_COMPONENTS_TITLE.link } label="Links" story={ STORY.documentation } /> showing the current page location in the navigational hierarchy._
...
1. **Page link** (as Home <StorybookLink kind={ ODS_COMPONENTS_TITLE.icon } label="Icon" story={ STORY.documentation } />)
...
<BestPractices
  donts={[
    ...
    <span>- Add external <StorybookLink kind={ ODS_COMPONENTS_TITLE.link } label="Link" story={ STORY.documentation } /> in the component</span>,
    '- Put more than 4 imbrications inside a Breadcrumb, as the structure will be too complex',
  ]}
  dos={[
    <span>- The first Breadcrumb element has to be a <StorybookLink kind={ ODS_COMPONENTS_TITLE.link } label="Link" story={ STORY.documentation } /> to its preferential home page (with an <StorybookLink kind={ ODS_COMPONENTS_TITLE.icon } label="Icon" story={ STORY.documentation } />, or with "Home" <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } label="Text" story={ STORY.documentation } /></span>,
...
When the **Breadcrumb** has more than 4 <StorybookLink kind={ ODS_COMPONENTS_TITLE.link } label="Link" story={ STORY.documentation } /> visible, an ellipsis is displayed as a replacement for the middle <StorybookLink kind={ ODS_COMPONENTS_TITLE.link } label="Link" story={ STORY.documentation } />.

A click on the ellipsis will expanded all previously hidden <StorybookLink kind={ ODS_COMPONENTS_TITLE.link } label="Link" story={ STORY.documentation } /> inline, the collapsed state can't be redone afterwards.

The **Breadcrumb** <StorybookLink kind={ ODS_COMPONENTS_TITLE.link } label="Link" story={ STORY.documentation } /> are kept inline, even on mobile viewports.
...
All <StorybookLink kind={ ODS_COMPONENTS_TITLE.link } label="Links" story={ STORY.documentation } /> are accessible through tabulation.
