...
_A list of <StorybookLink kind="ODS Components/Link" label="Links" story="Documentation" /> showing the current page location in the navigational hierarchy._
...
1. **Page link** (as Home <StorybookLink kind="ODS Components/Icon" label="Icon" story="Documentation" />)
...
<BestPractices
  donts={[
    ...
    <span>- Add external <StorybookLink kind="ODS Components/Link" label="Link" story="Documentation" /> in the component</span>,
...
When the **Breadcrumb** has more than 4 <StorybookLink kind="ODS Components/Link" label="Link" story="Documentation" /> visible, an ellipsis is displayed as a replacement for the middle <StorybookLink kind="ODS Components/Link" label="Link" story="Documentation" />.

A click on the ellipsis will expanded all previously hidden <StorybookLink kind="ODS Components/Link" label="Link" story="Documentation" /> inline, the collapsed state can't be redone afterwards.

The **Breadcrumb** <StorybookLink kind="ODS Components/Link" label="Link" story="Documentation" /> are kept inline, even on mobile viewports.
...
All <StorybookLink kind="ODS Components/Link" label="Links" story="Documentation" /> are accessible through tabulation.
