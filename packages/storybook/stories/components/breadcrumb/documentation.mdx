...
**Breadcrumb** component should be properly identified and structured to ensure it is accessible to assistive technologies.
...
<Canvas of={ BreadcrumbStories.AccessibilityWithAriaLabel } sourceState="shown" />
 <Icon aria-hidden="true"
       ...
       style={{ color: 'var(--ods-color-success-500)' }} /> Screen readers will announce the link, the label of the first link, the list and the number of item. "Link, home page, List Breadcrumb 4 items".
