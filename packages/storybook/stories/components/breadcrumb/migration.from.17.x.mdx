...
The attribute list is the same as the <StorybookLink kind="ODS Components/Link" label="ods-link" story="Technical information" /> component.

Which means you have the same attributes, following the link <StorybookLink kind="ODS Components/Link" label="migration guide" story="Migration From 17.x" />.
