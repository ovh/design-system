...
<Meta of={ BreadcrumbStories } name="Migration v17 to v18" />
...
The attribute list is the same as the <StorybookLink kind={ REACT_COMPONENTS_TITLE.link } story={ STORY.technicalInformation }>ods-link</StorybookLink> component.

Which means you have the same attributes, following the link <StorybookLink kind={ REACT_COMPONENTS_TITLE.link } story={ STORY.migrationFrom17 }>migration guide</StorybookLink>.
