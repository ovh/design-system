...
Each breadcrumb item supports the same attribute list as the <StorybookLink kind="ODS Components/Link" label="ods-link" story="Technical information" /> component.
