...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.link } story={ STORY.documentation }>Links</StorybookLink> and **Buttons** serve different purposes, and using them correctly improves both accessibility and user experience:
...
The **Button** supports a loading state, during which a Spinner replaces its label.
