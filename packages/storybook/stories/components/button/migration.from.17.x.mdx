...
<Meta of={ ButtonStories } name="Migration v17 to v18" />
...
`circle` <Badge color="critical" size="sm">Removed</Badge>
...
`download` <Badge color="critical" size="sm">Removed</Badge>

`href` <Badge color="critical" size="sm">Removed</Badge>

`rel` <Badge color="critical" size="sm">Removed</Badge>

`target` <Badge color="critical" size="sm">Removed</Badge>

Have been removed.

They're now irrelevant as the button cannot be rendered as a link anymore.

`icon` <Badge color="success" size="sm">New</Badge>

New attribute (optional).

Allow you to render an icon on the left side of the button.

`isDisabled` <Badge color="success" size="sm">New</Badge>
...
`label` <Badge color="success" size="sm">New</Badge>

New attribute (required).

The label you want to render in the button.

`textAlign` <Badge color="critical" size="sm">Removed</Badge>
