...
`circle` <ods-badge size="sm" color="critical" label="Removed"></ods-badge>
...
`download` <ods-badge size="sm" color="critical" label="Removed"></ods-badge>

`href` <ods-badge size="sm" color="critical" label="Removed"></ods-badge>

`rel` <ods-badge size="sm" color="critical" label="Removed"></ods-badge>

`target` <ods-badge size="sm" color="critical" label="Removed"></ods-badge>
...
`isDisabled` <ods-badge size="sm" color="success" label="New"></ods-badge>
...
`textAlign` <ods-badge size="sm" color="critical" label="Removed"></ods-badge>
