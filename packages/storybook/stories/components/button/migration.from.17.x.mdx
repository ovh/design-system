...
`circle` <OdsBadge color="critical" size="sm">Removed</OdsBadge>
...
`download` <OdsBadge color="critical" size="sm">Removed</OdsBadge>

`href` <OdsBadge color="critical" size="sm">Removed</OdsBadge>

`rel` <OdsBadge color="critical" size="sm">Removed</OdsBadge>

`target` <OdsBadge color="critical" size="sm">Removed</OdsBadge>
...
`isDisabled` <OdsBadge color="success" size="sm">New</OdsBadge>

New attribute (optional).

Allow to you to make the button disabled.

`isLoading` <OdsBadge color="success" size="sm">New</OdsBadge>
...
`textAlign` <OdsBadge color="critical" size="sm">Removed</OdsBadge>
