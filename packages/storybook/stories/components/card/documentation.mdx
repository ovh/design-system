...
<IdentityCard aliases={ ['Tile (previous name)', 'Content Container', 'Product Card'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/card"
              name="Card">
...
<Canvas of={ CardStories.AccessibilityGrouping } sourceState="shown" />
...
<Canvas of={ CardStories.AccessibilityAlternativeGrouping } sourceState="shown" />
