...
2. **Text** - Use this <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" /> label to describe what the <StorybookLink kind="ODS Components/Form elements/Radio" label="Radio" story="Documentation" /> is for.
...
<BestPractices
  donts={[
    <span>- Avoid using Checkbox if only one item in list can be selected, prefer using <StorybookLink kind="ODS Components/Form elements/Radio" label="Radio" story="Documentation" /> instead</span>,
...
The **Checkbox** can be autonomous, as it can be labelled in a starting/ending <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" />.
