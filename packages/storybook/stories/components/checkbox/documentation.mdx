...
2. **Text** - Use this <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } label="Text" story={ STORY.documentation } /> label to describe what the <StorybookLink kind={ ODS_COMPONENTS_TITLE.radio } label="Radio" story={ STORY.documentation } /> is for.
...
<BestPractices
  donts={[
    <span>- Avoid using Checkbox if only one item in list can be selected, prefer using <StorybookLink kind={ ODS_COMPONENTS_TITLE.radio } label="Radio" story={ STORY.documentation } /> instead</span>,
...
The **Checkbox** can be autonomous, as it can be labelled in a starting/ending <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } label="Text" story={ STORY.documentation } />.
