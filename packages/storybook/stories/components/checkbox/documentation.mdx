...
<IdentityCard aliases={ ['Checkbox Button (previous name)', 'Check Box', 'Tick Box'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/checkbox"
              name="Checkbox">
...
Try to keep a vertical spacing of at least `8px` between each checkboxes, to provide sufficient tactile and visual separation.
