...
<BestPractices
  donts={[
    ...
    <span>- Use Code just to display some simple <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" /></span>,
...
When focusing on the "Copy" icon <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" />, the component can be triggered with `Space` or `Enter` keys.
