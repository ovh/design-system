...
<IdentityCard aliases={ ['Code snippet'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/code"
              name="Code">
...
<Anatomy src="components/code/anatomy.png" />
...
Pressing <Kbd>Tab</Kbd> moves focus to the "Copy" button if available.

Pressing <Kbd>Enter</Kbd> or <Kbd>Space</Kbd> while the "Copy" button is focused copies the code to the clipboard.
