...
<AnatomyTech of={ CodeStories.AnatomyTech } />
...
`Code` does support all <ExternalLink href="https://shiki.style/">Shiki v4</ExternalLink> languages and themes.
