...
You can update the component style using a class on the web-component directly or access the internal list element using the part `list`.
...
If the component container is defining a position context, the combobox may not appear at the right place, or partially clipped.
...
<Canvas of={ ComboboxStories.FixedContext } sourceState="shown" />
