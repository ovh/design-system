...
`maxDate` <img src="https://img.shields.io/badge/updated-00FFFF" />

Has been updated.

You can use the new `max` attribute to obtain the same behavior.

`minDate` <img src="https://img.shields.io/badge/updated-00FFFF" />

Has been updated.

You can use the new `min` attribute to obtain the same behavior.

`showSiblingsMonthDays` <img src="https://img.shields.io/badge/removed-FF0000" />
