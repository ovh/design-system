...
<IdentityCard aliases={ ['Sidenav', 'Panel'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/drawer"
              name="Drawer">
</IdentityCard>
...
<Anatomy src="components/drawer/anatomy.png" />
...
Pressing <Kbd>Escape</Kbd> closes the **Drawer**.

Pressing <Kbd>Tab</Kbd> moves focus forward through the focusable elements inside the **Drawer**.

Pressing <Kbd>Shift</Kbd> + <Kbd>Tab</Kbd> moves focus backward within the **Drawer**.
...
<Canvas of={ DrawerStories.AccessibilityAriaLabel } sourceState="shown" />

<Canvas of={ DrawerStories.AccessibilityAriaLabelledBy } sourceState="shown" />
