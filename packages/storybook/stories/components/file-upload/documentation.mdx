...
To ensure proper accessibility, the **File Upload** component must provide proper labeling and clear feedback for screen readers.

<Heading label="Labeling cancel/delete Button" level={ 3 } />

The "Cancel"/"Delete" file button has to be explicit by adding context about its action and the file name.
