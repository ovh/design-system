...
<Meta of={ FileUploadStories } name="Migration v17 to v18" />

<Heading label="File Upload - migrate from v17 to v18" level={ 1 } />

This component has been first released with the v18, there is no migration involved coming from v17.x.

To learn how to use this component, please check the <StorybookLink kind={ REACT_COMPONENTS_TITLE.fileUpload } story={ STORY.documentation }>documentation</StorybookLink>.
