...
<IdentityCard aliases={ ['Form Control'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/form-field"
              name="Form Field">
...
<Anatomy src="components/form-field/anatomy.png" />
...
<Canvas of={ FormFieldStories.AccessibilityLabel } sourceState="shown" />
