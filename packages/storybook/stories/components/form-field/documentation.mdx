...
<IdentityCard aliases={ ['Form Control'] }
  ...
  <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" /> to handle specific types of information, like a
  <StorybookLink kind="ODS Components/Form elements/Password" label="Password" story="Documentation" /> field for example.
</IdentityCard>
...
<BestPractices
  donts={[
    <span>- Use a Form Field for content longer than a single line: Use a <StorybookLink kind="ODS Components/Form elements/Textarea" label="Textarea" story="Documentation" /> instead</span>,
    <span>- Use an Input when you have a predefined list of answers: use a <StorybookLink kind="ODS Components/Form elements/Select" label="Select" story="Documentation" /> or <StorybookLink kind="ODS Components/Form elements/Radio" label="Radio" story="Documentation" /> Buttons instead</span>,
    ...
    <span>- Use interactive content such as a <StorybookLink kind="ODS Components/Link" label="Link" story="Documentation" /> or a <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" /> inside the Form Field label</span>,
  ]}
  dos={[
    '- Use several Form Fields for strongly related content and/or fields',
    '- Use a Form Fields to help users to fill in a form',
    <span>- Remember to use a field with a length proportional to the expected user <StorybookLink kind="ODS Components/Form elements/Input" label="Input" story="Documentation" /></span>,
...
If the field is in error state, an error message is displayed below the helper <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" /> when it exists. When no helper <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" /> exists, the error message is displayed below the form component.
