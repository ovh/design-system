...
<div>
  ...
  <table>
    ...
    <tr>
      ...
      <td>
        [**Checkbox**](?path=/docs/ods-components-form-elements-checkbox--documentation), [**File
        Upload**](?path=/docs/ods-components-form-elements-file-upload--documentation),
        [**Input**](?path=/docs/ods-components-form-elements-input--documentation),
        [**Password**](?path=/docs/ods-components-form-elements-password--documentation), [**Phone
        Number**](?path=/docs/ods-components-form-elements-phone-number--documentation),
        [**Quantity**](?path=/docs/ods-components-form-elements-quantity--documentation),
        [**Radio**](?path=/docs/ods-components-form-elements-radio--documentation),
        [**Select**](?path=/docs/ods-components-form-elements-select--documentation),
        [**Switch**](?path=/docs/ods-components-form-elements-switch--documentation),
        [**Textarea**](?path=/docs/ods-components-form-elements-textarea--documentation),
        [**Toggle**](?path=/docs/ods-components-form-elements-toggle--documentation)
      </td>
    </tr>
    <tr>
