...
The Icon is ignored by screen readers and does not create unnecessary noise.
...
Screen readers will announce "home", ensuring users understand the Icon's meaning.
