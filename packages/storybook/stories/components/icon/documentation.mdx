import { ICON_NAME, Icon, Message, MessageBody } from '@ovhcloud/ods-react';
...
<IdentityCard aliases={ ['Symbol'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/icon"
              name="Icon">
