...
**Icons** can be used in standalone <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } story={ STORY.documentation }>Button</StorybookLink> and can be usually associated with some sort of action.
...
<BestPractices
  donts={[
    ...
    <span>- Baseline-align Icons when they are next to <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } story={ STORY.documentation }>Text</StorybookLink></span>,
    <span>- When Icons are next to <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } story={ STORY.documentation }>Text</StorybookLink>, don't use different colors for both of them</span>,
  ]}
  dos={[
    '- Give an equivalent text as aria-name to the Icon',
    '- Assure a good contrast between the background and Icon colors',
    <span>- Center-align when Icons are next to <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } story={ STORY.documentation }>Text</StorybookLink></span>,
    <span>- When Icons are next to <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } story={ STORY.documentation }>Text</StorybookLink>, use the same color for pairing them</span>,
  ]}
/>
...
**Icons** can stand alone or be included in a <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } story={ STORY.documentation }>Button</StorybookLink> or other components depending on the usage.
...
<Canvas of={ IconStories.AccessibilityDecorative } sourceState="shown" />
...
<Canvas of={ IconStories.AccessibilityInformative } sourceState="shown" />
...
See <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } story={ STORY.documentation }>Button</StorybookLink> examples.
