...
4. Clickable icon <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" />, used for extra actions
5. Clickable icon <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" />, used for extra actions

<Heading label="Usage" level={ 2 } />

An **Input** is used to type a free-form short text in a field. It is often used within a <StorybookLink kind="ODS Components/Form elements/Form Field" label="Form Field" story="Documentation" /> component that adds its label.
...
<BestPractices
  donts={[
    <span>- Use an Input for content longer than a single line: Use a <StorybookLink kind="ODS Components/Form elements/Textarea" label="Textarea" story="Documentation" /> instead</span>,
    <span>- Use an Input when you have a predefined list of answers: use a <StorybookLink kind="ODS Components/Form elements/Select" label="Select" story="Documentation" /> or <StorybookLink kind="ODS Components/Form elements/Radio" label="Radio" story="Documentation" /> instead</span>,
  ]}
  dos={[
    <span>- Add label and helper message to the Input with <StorybookLink kind="ODS Components/Form elements/Form Field" label="Form Field" story="Documentation" /> component</span>,
  ]}
/>
