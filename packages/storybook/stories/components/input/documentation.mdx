...
4. Clickable icon <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" />, used for secondary extra actions such as clear the field
5. Clickable icon <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" />, used for extra actions such as toggle the field content visibility or trigger a search
