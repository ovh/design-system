import changelog from '@ovhcloud/ods-components/interactive-surface/CHANGELOG.md';
import { defineCustomElements } from '@ovhcloud/ods-components/interactive-surface/loader';
import { html } from 'lit-html';
import { unsafeHTML } from 'lit-html/directives/unsafe-html';

import page from './interactive-surface.web-component.stories.page.mdx';
...
export default {
  title: 'UI Components/Interactive Surface [quark]/Web Component',
...
const TemplateDefault = (args:any) => {
  return html`<osds-interactive-surface ...=${getTagAttributes(args)}>
