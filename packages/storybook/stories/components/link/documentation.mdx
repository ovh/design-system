...
<IdentityCard aliases={ ['Hyperlink', 'Anchor'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/link"
              name="Link">
...
<Canvas of={ LinkStories.AccessibilityIconOnlyLink } sourceState="shown" />
<Icon aria-hidden="true"
      name={ ICON_NAME.circleCheck }
      style={{ color: 'var(--ods-color-success-500)' }} /> Screen readers will announce the link type and its label.
...
<Canvas of={ LinkStories.AccessibilityInANewTab } sourceState="shown" />
<Icon aria-hidden="true"
      name={ ICON_NAME.circleCheck }
      style={{ color: 'var(--ods-color-success-500)' }} /> The screen reader will announce the link type, the opening in a new tab behavior and the link label.
...
<Canvas of={ LinkStories.AccessibilityFileDownload } sourceState="shown" />
<Icon aria-hidden="true"
      name={ ICON_NAME.circleCheck }
      style={{ color: 'var(--ods-color-success-500)' }} /> Screen readers will announce the link type, the link label with the file name, type and size, ensuring users know they are downloading a file.
