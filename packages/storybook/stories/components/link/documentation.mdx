...
2. <StorybookLink kind="ODS Components/Icon" label="Icon" story="Documentation" /> (optional): Indicates the destination or type of content being.
...
<StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" /> is used for actions while **Link** is used for navigation.

<Heading label="Dos & Don'ts" level={ 3 } />

<BestPractices
  donts={[
    <span>- Use a Link as a <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" /> for actions such as 'save', 'cancel' or 'submit'</span>,
    '- Use "Click Here" or "Here" as description for a Link',
    '- Write a full long sentence as Link description',
    <span>- Use different color for Link and the optional <StorybookLink kind="ODS Components/Icon" label="Icon" story="Documentation" /> when you add one</span>,
  ]}
  dos={[
...
An optional <StorybookLink kind="ODS Components/Icon" label="Icon" story="Documentation" /> can be displayed on the left or right of the **Link** label content.
...
When users clicks anywhere on the **Link**, even its optional <StorybookLink kind="ODS Components/Icon" label="Icon" story="Documentation" />, they are redirected to the expected page or section.
