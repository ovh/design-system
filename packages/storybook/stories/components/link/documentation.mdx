...
<Icon aria-hidden="true"
      name={ ICON_NAME.circleCheck }
      style={{ color: 'var(--ods-color-success-500)' }} /> The screen reader will announce "Link, Blank target, Visit Example opens in a new tab".
...
<Icon aria-hidden="true"
      name={ ICON_NAME.circleCheck }
      style={{ color: 'var(--ods-color-success-500)' }} /> Screen readers will announce "Link, (visited,) Download WCAG20 Guidelines, PDF, 481 KB" or "(visited,) WCAG20 Guidelines, Download WCAG20 Guidelines, PDF, 481 KB", ensuring users know they are downloading a file.
