...
**Medium** is used to display assets with an alternative <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" /> description.
...
An alternative <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" /> description is mandatory to describe the information the asset may bring to the user.
