...
1. <StorybookLink kind={ ODS_COMPONENTS_TITLE.icon } label="Icon" story={ STORY.documentation } /> to inform users about what kind of message it is (optional)

2. <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } label="Text" story={ STORY.documentation } />, which can be a plain text or contain a link

3. A `cross` icon <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } label="Button" story={ STORY.documentation } />, which is a close button to dismiss the **Message** (optional)
...
When a **Message** is dismissible, a click on the `close` icon <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } label="Button" story={ STORY.documentation } /> will dismiss the **Message**.
...
The `close` icon <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } label="Button" story={ STORY.documentation } /> is focusable and can be triggered with the `Enter`/`Space` key.
