...
<IdentityCard aliases={ ['Notifier', 'Notification', 'Banner', 'Alert', 'Feedback'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/message"
              name="Message">
...
<Canvas of={ MessageStories.AccessibilityRoles } sourceState="shown" />
