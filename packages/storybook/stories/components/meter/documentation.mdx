...
<IdentityCard aliases={ [] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/meter"
              name="Meter"
              startingVersion={ 19 }>
...
<Anatomy src="components/meter/anatomy.png" />
...
<Canvas of={ MeterStories.AccessibilityAriaLabel } sourceState="shown" />
...
<Canvas of={ MeterStories.AccessibilityAriaLabelledby } sourceState="shown" />
...
<Canvas of={ MeterStories.AccessibilityAriaValuetext } sourceState="shown" />
