...
<Anatomy src="components/modal/anatomy.png" />
...
Pressing <Kbd>Escape</Kbd> closes the **Modal** (if dismissible)
...
Pressing <Kbd>Shift</Kbd> + <Kbd>Tab</Kbd> moves focus backward through the focusable elements.
...
<Canvas of={ ModalStories.AccessibilityAriaLabel } sourceState="shown" />
