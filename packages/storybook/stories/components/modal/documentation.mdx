...
<IdentityCard aliases={ ['Dialog', 'Alert Dialog', 'Confirm Dialog'] }
  ...
  dismiss or click on an action <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } label="Button" story={ STORY.documentation } /> to proceed
  further.
</IdentityCard>
...
2. **Container**
3. **Content** container, filled with <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } label="Text" story={ STORY.documentation } /> or other read-only content, depending on the usage
...
<BestPractices
  donts={[
    ...
    <span>- Use a Modal only to notify users about a successful completion of their actions: use <StorybookLink kind={ ODS_COMPONENTS_TITLE.message } label="Message" story={ STORY.documentation } /> component</span>,
  ]}
  dos={[
    ...
    <span>- Handle closing the Modal when the cancel action <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } label="Button" story={ STORY.documentation } /> is clicked</span>,
...
When necessary, depending on the viewport height and the **Modal** content, the user can scroll vertically with the header and the action <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } label="Button" story={ STORY.documentation } /> remaining in place.
...
- `Tabulation` allows to move forward, first to the closing icon, then through any focusable element in the **Modal** (e.g. action <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } label="Button" story={ STORY.documentation } />)
