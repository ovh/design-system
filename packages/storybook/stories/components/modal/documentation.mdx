...
- `Tabulation` allows to move forward, first to the closing icon, then through any focusable element in the **Modal** (e.g. action [**Button**](?path=/docs/ods-components-actions-button--documentation)))
