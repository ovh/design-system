...
// todo we should automatize Overview page components generation in a script. For now, this page is disabled
// export default {
//   title: 'ODS Components/Overview',
//   id: 'ods-components',
// };
...
const ODSComponents = {
  ...
  Form: [
    ...
    },
    {
      name: 'Datepicker',
      tag: 'osds-datepicker',
      url: parent.location.href.replace(parent.location.search, '?path=/story/datepicker--default'),
      attributes: {
        inline: true,
    ...
    },
    {
      ...
      url: parent.location.href.replace(parent.location.search, '?path=/story/phone-number--default'),
      attributes: {
        inline: true,
        style: 'max-width: 12em;',
      },
  ...
  Navigation: [
    ...
    },
    {
      name: 'Search Bar',
      tag: 'osds-search-bar',
      url: parent.location.href.replace(parent.location.search, '?path=/story/search-bar--default'),
      attributes: {
      },
    },
    {
...
<span style="
  ...
  <span style="
              ...
              padding: 1rem 2rem;
            ">
    <h1 class="cardSection">Components overview</h1>
    <p>This section lists all components currently available in ODS</p>
  </span>
  ${
  Object.keys(ODSComponents).map((section) =>
