...
Current page <StorybookLink kind={ REACT_COMPONENTS_TITLE.button } story={ STORY.documentation }>Button</StorybookLink> has a selected styling, yet it is a not clickable.

If the selected page number is the first page, the previous page arrow <StorybookLink kind={ REACT_COMPONENTS_TITLE.button } story={ STORY.documentation }>Button</StorybookLink> is disabled; same thing applies with the last page as selected and the next page arrow <StorybookLink kind={ REACT_COMPONENTS_TITLE.button } story={ STORY.documentation }>Button</StorybookLink> disabled.
...
All <StorybookLink kind={ REACT_COMPONENTS_TITLE.button } story={ STORY.documentation }>Buttons</StorybookLink> are accessible via tabulation controls.

Previous and next page arrow <StorybookLink kind={ REACT_COMPONENTS_TITLE.button } story={ STORY.documentation }>Buttons</StorybookLink> are labelled as their explicit usage.
