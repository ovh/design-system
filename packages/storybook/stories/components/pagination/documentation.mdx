...
Pagination is a form of navigation, but it serve a specific purpose distinct from primary navigation menus. To ensure it is correctly recognized, an aria-label should be added to explicitly identify it.

<Canvas of={ PaginationStories.AccessibilityLabel } sourceState="shown" />
