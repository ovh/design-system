...
<IdentityCard aliases={ ['Password field', 'Password input'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/password"
              name="Password">
...
<Anatomy src="components/password/anatomy.png" />
...
Pressing <Kbd>Backspace</Kbd> deletes the last character before the cursor position.

Pressing <Kbd>Enter</Kbd> while the clear button is focused clears the Password content.

Pressing <Kbd>Enter</Kbd> while the toggle mask button is focused toggles between showing and hiding the field content.
...
<Canvas of={ PasswordStories.AccessibilityFormField } sourceState="shown" />
...
<Canvas of={ PasswordStories.AccessibilityI18n } sourceState="shown" />
