...
_**Phone Number** component is a combo of a selection of country phone indicator and an [**Input**](?path=/docs/ods-components-form-elements-input--documentation) field for entering a phone number_
  ...
  <table>
    ...
    <tr>
      ...
      <td>
        ...
        [**Flag**](?path=/story/ods-components-flag--demo), [**Form
...
**Phone Number** is a group of [**Select**](?path=/docs/ods-components-form-elements-select--documentation) and [**Input**](?path=/docs/ods-components-form-elements-input--documentation), and should act as their specific placements.
...
An event is triggered when the [**Input**](?path=/docs/ods-components-form-elements-input--documentation) value changes.

### Locale

The locale (i.e. country list translation in [**Select**](?path=/docs/ods-components-form-elements-select--documentation)) is first set to the value provided as a property.
...
Keyboard navigation is the same as [**Select**](?path=/docs/ods-components-form-elements-select--documentation) and [**Input**](?path=/docs/ods-components-form-elements-input--documentation) does, `Tab` key allows to focus to one another.
