...
- As <StorybookLink kind={ REACT_COMPONENTS_TITLE.formField } story={ STORY.documentation }>Form Field</StorybookLink> in an user profile
...
<BestPractices
  donts={[
    ...
    <span>- Make a Phone Number <StorybookLink kind={ REACT_COMPONENTS_TITLE.input } story={ STORY.documentation }>Input</StorybookLink> as required without explaining to users why this field is required</span>,
    '- Assume exclusive use of mobile phone numbers',
  ]}
  dos={[
    '- Validate Phone number format when user leaves the field',
    <span>- Use Phone Number without the optional country indicator <StorybookLink kind={ REACT_COMPONENTS_TITLE.select } story={ STORY.documentation }>Select</StorybookLink> when you only accept user's locale as selection</span>,
...
An event is triggered when the <StorybookLink kind={ REACT_COMPONENTS_TITLE.input } story={ STORY.documentation }>Input</StorybookLink> value changes.
...
Keyboard navigation is the same as <StorybookLink kind={ REACT_COMPONENTS_TITLE.select } story={ STORY.documentation }>Select</StorybookLink> and <StorybookLink kind={ REACT_COMPONENTS_TITLE.input } story={ STORY.documentation }>Input</StorybookLink> does, `Tab` key allows to focus to one another.
