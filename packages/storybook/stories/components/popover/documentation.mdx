...
_**Popover** component is triggered by click and is used to provide additional information to the user in a new temporary window that overlays the page_
...
- `Tab` permits to focus in inner **Popover** content
