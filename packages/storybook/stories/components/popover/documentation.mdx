...
<Icon aria-hidden="true"
      ...
      style={{ color: 'var(--ods-color-primary-500)' }} /> Screen readers will recognize that this **Popover** contains a menu and menu items. It indicates that the element can trigger a popup and the nature of this popup.
