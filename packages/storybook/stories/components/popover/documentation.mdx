...
1. **Container**: main container that has all content (i.e <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" />, <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" />, etc.)
...
It can include interactive elements such as <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" /> or <StorybookLink kind="ODS Components/Link" label="Link" story="Documentation" />.

<Heading label="Tooltip vs Popover" level={ 3 } />

- Both components look similar but a <StorybookLink kind="ODS Components/Tooltip" label="Tooltip" story="Documentation" /> is displayed on hover and focus while a **Popover** is triggered by click.
- <StorybookLink kind="ODS Components/Tooltip" label="Tooltip" story="Documentation" /> are commonly used for shorter explanations, while longer <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" /> / complex UIs would suit **Popovers** better.
- Use a **Popover** when you need to insert interactive elements such as <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" />.
- A **Popover** can be dismissed if an action <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" /> allows it.
...
<BestPractices
  ...
  dos={[
    <span>- Use a Popover instead of a <StorybookLink kind="ODS Components/Tooltip" label="Tooltip" story="Documentation" /> when the <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" /> is long; but keep it concise</span>,
    <span>- Write Popover's <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" /> as full sentences with punctuation</span>,
  ]}
/>
...
It triggers when the user clicks on the **Popover**'s trigger element such as a <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" />.
