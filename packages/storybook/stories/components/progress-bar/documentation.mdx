...
To ensure a Progress Bar is correctly recognized, an aria-label should be added to explicitly identify it.

<Canvas of={ ProgressBarStories.AccessibilityLabel } sourceState="shown" />
