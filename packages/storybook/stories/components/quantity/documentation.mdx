...
<IdentityCard aliases={ ['Numeric', 'Number input', 'Amount'] }
  ...
  It includes an <StorybookLink kind={ ODS_COMPONENTS_TITLE.input } story={ STORY.documentation }>Input</StorybookLink> field combined with increment and
  decrement <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } story={ STORY.documentation }>Button</StorybookLink> to adjust the value easily.
</IdentityCard>
...
It should be used with numeric <StorybookLink kind={ ODS_COMPONENTS_TITLE.input } story={ STORY.documentation }>Input</StorybookLink> that are in a fairly narrow range.

<Heading label="Behavior" level={ 2 } />

**Quantity** numeric field can be edited directly by the user.

The user can also decrease or increase the value by clicking on <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } story={ STORY.documentation }>Button</StorybookLink>.
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.input } story={ STORY.documentation }>Input</StorybookLink> and <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } story={ STORY.documentation }>Button</StorybookLink> accessibility features avail here, with former tabulation and triggers.
