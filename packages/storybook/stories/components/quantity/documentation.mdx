...
<IdentityCard aliases={ ['Numeric', 'Number input', 'Amount'] }
  ...
  It includes an <StorybookLink kind="ODS Components/Form elements/Input" label="Input" story="Documentation" /> field combined with increment and
  decrement <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" /> to adjust the value easily.
</IdentityCard>
...
It should be used with numeric <StorybookLink kind="ODS Components/Form elements/Input" label="Input" story="Documentation" /> that are in a fairly narrow range.

<Heading label="Behavior" level={ 2 } />

**Quantity** numeric field can be edited directly by the user.

The user can also decrease or increase the value by clicking on <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" />.
...
<StorybookLink kind="ODS Components/Form elements/Input" label="Input" story="Documentation" /> and <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" /> accessibility features avail here, with former tabulation and triggers.
