...
<StorybookLink kind="ODS Components/Form elements/Input" label="Doc input" story="Migration From 17.x" />

<Heading label="Button attributes changes" level={ 2 } />

<StorybookLink kind="ODS Components/Button" label="Doc button" story="Migration From 17.x" />
