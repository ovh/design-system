...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.input } story={ STORY.migrationFrom17 }>Doc input</StorybookLink>

<Heading label="Button attributes changes" level={ 2 } />

<StorybookLink kind={ ODS_COMPONENTS_TITLE.button } story={ STORY.migrationFrom17 }>Doc button</StorybookLink>
