...
`defaultValue` <ods-badge size="sm" color="success" label="New"></ods-badge>
...
`hasError` <ods-badge size="sm" color="success" label="New"></ods-badge>
...
`slot:minus` <ods-badge size="sm" color="critical" label="Removed"></ods-badge>

Has been removed.

The slot minus is now automatically in the component with an ods-button

`slot:default` <ods-badge size="sm" color="critical" label="Removed"></ods-badge>

Has been removed.

The slot is now automatically in the component with an ods-input

`slot:plus` <ods-badge size="sm" color="critical" label="Removed"></ods-badge>
