...
<Anatomy src="components/radio-group/anatomy.png" />
...
Pressing <Kbd>Tab</Kbd> moves focus to the next focusable and enabled radio button in the group.

Pressing <Kbd>Shift</Kbd> + <Kbd>Tab</Kbd> moves focus backward through the radio buttons.

Pressing <Kbd>Arrow Down</Kbd> or <Kbd>Arrow Right</Kbd> moves focus and selects the next radio button in the group.

Pressing <Kbd>Arrow Up</Kbd> or <Kbd>Arrow Left</Kbd> moves focus and selects the previous radio button in the group.

Pressing <Kbd>Space</Kbd> when focused on an unchecked radio button selects it.
