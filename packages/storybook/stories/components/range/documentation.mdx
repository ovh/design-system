...
<BestPractices
  ...
  dos={[
    ...
    <span>- Include a label on a Range, such as the one provided by <StorybookLink kind="ODS Components/Form elements/Form Field" label="Form Field" story="Documentation" /> component, to explain the purpose of the Range</span>,
...
It also can be combined with other elements such as an <StorybookLink kind="ODS Components/Form elements/Input" label="Input" story="Documentation" /> for a better control of the value selection.
