...
<BestPractices
  ...
  dos={[
    ...
    <span>- Include a label on a Range, such as the one provided by <StorybookLink kind={ REACT_COMPONENTS_TITLE.formField } story={ STORY.documentation }>Form Field</StorybookLink> component, to explain the purpose of the Range</span>,
...
It also can be combined with other elements such as an <StorybookLink kind={ REACT_COMPONENTS_TITLE.input } story={ STORY.documentation }>Input</StorybookLink> for a better control of the value selection.
