...
<IdentityCard aliases={ ['Slider'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/range"
              name="Range">
...
To ensure an optimal experience for assistive technologies, proper semantic elements and ARIA attributes must be used for both simple and dual **Range**.
...
<Canvas of={ RangeStories.AccessibilityFormField } sourceState="shown" />
<Icon aria-hidden="true"
      name={ ICON_NAME.circleCheck }
      style={{ color: 'var(--ods-color-success-500)' }} /> Screen readers will announce the value, the fact it's a slider and its label.

<Canvas of={ RangeStories.AccessibilityDualRangeFormField } sourceState="shown" />
<Icon aria-hidden="true"
      name={ ICON_NAME.circleCheck }
      style={{ color: 'var(--ods-color-success-500)' }} /> Screen readers will announce the value, the fact it's a slider and its label.

<Heading label="Using a visible label" level={ 3 } />

<Canvas of={ RangeStories.AccessibilityVisibleLabel } sourceState="shown" />
<Icon aria-hidden="true"
      name={ ICON_NAME.circleCheck }
      style={{ color: 'var(--ods-color-success-500)' }} /> Screen readers will announce the value, the fact it's a slider and its label.

<Canvas of={ RangeStories.AccessibilityDualRangeVisibleLabel } sourceState="shown" />
<Icon aria-hidden="true"
      name={ ICON_NAME.circleCheck }
      style={{ color: 'var(--ods-color-success-500)' }} /> Screen readers will announce the value, the fact it's a slider and its label.
...
<Canvas of={ RangeStories.AccessibilityDescriptiveSubLabel } sourceState="shown" />
<Icon aria-hidden="true"
      name={ ICON_NAME.circleCheck }
      style={{ color: 'var(--ods-color-success-500)' }} /> Screen readers will announce the values, the fact it's a slider and its label.

<Icon aria-hidden="true"
      name={ ICON_NAME.circleInfo }
      style={{ color: 'var(--ods-color-primary-500)' }} /> Using aria-labelledby to link the sub-label and aria-live="polite" ensure that the content is vocalized by screen readers.
