...
As an alternative to the Search Bar component, a similar functionality can be achieved using the <StorybookLink kind="ODS Components/Form elements/Input" label="ods-input" story="Documentation"></StorybookLink> component with the `search` type.
