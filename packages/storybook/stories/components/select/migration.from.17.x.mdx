...
`allowMultiple` <ods-badge size="sm" color="success" label="New"></ods-badge>

New attribute (optional).

Set this to true to allow multiple selection in the select.

`customRenderer` <ods-badge size="sm" color="success" label="New"></ods-badge>
...
`multipleSelectionLabel` <ods-badge size="sm" color="success" label="New"></ods-badge>
...
`opened ` <ods-badge size="sm" color="critical" label="Removed"></ods-badge>
