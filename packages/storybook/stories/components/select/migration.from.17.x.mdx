...
`allowMultiple` <OdsBadge color="success" label="New" size="sm" />

New attribute (optional).

Set this to true to allow multiple selection in the select.

`customRenderer` <OdsBadge color="success" label="New" size="sm" />
...
`multipleSelectionLabel` <OdsBadge color="success" label="New" size="sm" />
...
`opened ` <OdsBadge color="critical" label="Removed" size="sm" />
