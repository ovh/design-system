...
A **Skeleton** can be used in a variety of contexts such as in <StorybookLink kind={ ODS_COMPONENTS_TITLE.card } story={ STORY.documentation }>Card</StorybookLink>, lists, and <StorybookLink kind={ ODS_COMPONENTS_TITLE.table } story={ STORY.documentation }>Table</StorybookLink> content.
