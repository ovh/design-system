...
<BestPractices
  donts={[
    ...
    <span>- Use Spinner for text-only loading. Use <StorybookLink kind={ ODS_COMPONENTS_TITLE.skeleton } story={ STORY.documentation }>Skeleton</StorybookLink> component instead</span>,
  ]}
  dos={[
