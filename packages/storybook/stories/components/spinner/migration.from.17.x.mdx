...
`color` <ods-badge size="sm" color="success" icon="star" label="New"></ods-badge>
...
`mode` <ods-badge size="sm" color="critical" icon="circle-xmark" label="Removed"></ods-badge>

Has been removed.

There was only was mode value, it is now the default rendering.

`size` <ods-badge size="sm" icon="circle-info" label="Updated"></ods-badge>
