...
1. **Controls**: the user clicks on them to choose a state or an item. Controls' content can be <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" />, <StorybookLink kind="ODS Components/Icon" label="Icon" story="Documentation" />, or both.
...
<BestPractices
  donts={[
    <span>- Use a Switch when there are more than four options to display to the user: use others component such as <StorybookLink kind="ODS Components/Form elements/Checkbox" label="Checkbox" story="Documentation" /> button, <StorybookLink kind="ODS Components/Form elements/Radio" label="Radio" story="Documentation" /> button or <StorybookLink kind="ODS Components/Form elements/Select" label="Select" story="Documentation" /></span>,
    <span>- Use a Switch when you are not expecting an immediate effect by clicking on it: use a <StorybookLink kind="ODS Components/Form elements/Checkbox" label="Checkbox" story="Documentation" /> component instead</span>,
  ...
  dos={[
    ...
    <span>- Consider whether a <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" />, an <StorybookLink kind="ODS Components/Icon" label="Icon" story="Documentation" />, or both would suit better to your Switch controls content</span>,
  ]}
/>
...
It may replace two <StorybookLink kind="ODS Components/Form elements/Radio" label="Radio" story="Documentation" /> buttons or a single <StorybookLink kind="ODS Components/Form elements/Checkbox" label="Checkbox" story="Documentation" /> to allow users to choose between several states.
