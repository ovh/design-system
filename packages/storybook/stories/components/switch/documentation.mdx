...
<BestPractices
  donts={[
    <span>- Use a Switch when there are more than four options to display to the user: use others component such as <StorybookLink kind={ REACT_COMPONENTS_TITLE.checkbox } story={ STORY.documentation }>Checkbox</StorybookLink> button, <StorybookLink kind={ REACT_COMPONENTS_TITLE.radioGroup } story={ STORY.documentation }>Radio</StorybookLink> button or <StorybookLink kind={ REACT_COMPONENTS_TITLE.select } story={ STORY.documentation }>Select</StorybookLink></span>,
    <span>- Use a Switch when you are not expecting an immediate effect by clicking on it: use a <StorybookLink kind={ REACT_COMPONENTS_TITLE.checkbox } story={ STORY.documentation }>Checkbox</StorybookLink> component instead</span>,
  ...
  dos={[
    ...
    <span>- Consider whether a <StorybookLink kind={ REACT_COMPONENTS_TITLE.text } story={ STORY.documentation }>Text</StorybookLink>, an <StorybookLink kind={ REACT_COMPONENTS_TITLE.icon } story={ STORY.documentation }>Icon</StorybookLink>, or both would suit better to your Switch controls content</span>,
  ]}
/>
...
It may replace two <StorybookLink kind={ REACT_COMPONENTS_TITLE.radioGroup } story={ STORY.documentation }>Radio</StorybookLink> buttons or a single <StorybookLink kind={ REACT_COMPONENTS_TITLE.checkbox } story={ STORY.documentation }>Checkbox</StorybookLink> to allow users to choose between several states.
