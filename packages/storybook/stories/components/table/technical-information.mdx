...
import SpecificationsTable from '../../../../ods-react/src/components/table/documentation/ods-table.json';
...
<TechnicalSpecification data={ SpecificationsTable } of={ TableStories } />
