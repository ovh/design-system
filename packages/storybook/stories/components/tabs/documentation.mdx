...
<BestPractices
  donts={[
    ...
    <span>- Use external <StorybookLink kind={ ODS_COMPONENTS_TITLE.link } label="Link" story={ STORY.documentation } /> as Tabs</span>,
...
All inner **Tabs** follow the same focusing/keyboard navigation as <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } label="Button" story={ STORY.documentation } />.
