...
<BestPractices
  donts={[
    ...
    <span>- Use external <StorybookLink kind="ODS Components/Link" label="Link" story="Documentation" /> as Tabs</span>,
...
All inner **Tabs** follow the same focusing/keyboard navigation as <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" />.
