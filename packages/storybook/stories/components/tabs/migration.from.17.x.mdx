...
The following component has been removed: <OdsBadge color="critical" size="sm">Removed</OdsBadge>
- `osds-tab-bar`
- `osds-tab-panel`

The following component has been updated: <OdsBadge color="information" size="sm">Updated</OdsBadge>
...
`panel`  <OdsBadge color="critical" size="sm">Removed</OdsBadge>
Has been removed.
...
`active` <OdsBadge color="information" size="sm">Updated</OdsBadge>
