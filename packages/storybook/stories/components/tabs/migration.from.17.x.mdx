...
The following component has been removed: <ods-badge size="sm" color="critical" label="Removed"></ods-badge>
- `osds-tab-bar`
- `osds-tab-panel`

The following component has been updated: <ods-badge size="sm" label="Updated"></ods-badge>
...
`panel` <ods-badge size="sm" color="critical" label="Removed"></ods-badge>
...
`active` <ods-badge size="sm" label="Updated"></ods-badge>
