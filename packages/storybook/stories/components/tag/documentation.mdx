...
- **Default**: highlighting labels or metadata with a strong, full design, providing an important extra information to the user.
...
- **Round** _(default)_: presents a pill element that can be visually stacked along with multiple **Tags**.
