...
<IdentityCard aliases={ ['Chip (previous name)', 'Label', 'Pill'] }
  ...
  **Tags** are removable and can include an <StorybookLink kind="ODS Components/Icon" label="Icon" story="Documentation" /> as
...
**Tags** main content is left-aligned, the closing <StorybookLink kind="ODS Components/Icon" label="Icon" story="Documentation" /> is fixed at the right hand of it.
...
**Tags** follow the same focusing/keyboard navigation as <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" />.
