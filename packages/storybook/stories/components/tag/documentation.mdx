...
<IdentityCard aliases={ ['Chip (previous name)', 'Label', 'Pill'] }
  ...
  **Tags** are removable and can include an <StorybookLink kind={ ODS_COMPONENTS_TITLE.icon } story={ STORY.documentation } >Icon</StorybookLink> as
...
**Tags** main content is left-aligned, the closing <StorybookLink kind={ ODS_COMPONENTS_TITLE.icon } story={ STORY.documentation } >Icon</StorybookLink> is fixed at the right hand of it.
...
**Tags** follow the same focusing/keyboard navigation as <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } story={ STORY.documentation } >Button</StorybookLink>.
