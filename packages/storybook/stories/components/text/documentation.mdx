...
<IdentityCard aliases={ ['Paragraph'] }
              ...
              githubUrl="https://github.com/ovh/design-system/tree/master/packages/ods-react/src/components/text"
              name="Text">
...
This component complies with the <ExternalLink href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/Heading_Elements">h1 to h6</ExternalLink>, <ExternalLink href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/p">p</ExternalLink>, <ExternalLink href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/label">label</ExternalLink>, <ExternalLink href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/small">small</ExternalLink>, <ExternalLink href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/span">span</ExternalLink> and <ExternalLink href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/code">code</ExternalLink> HTML elements.
