...
<BestPractices
  donts={[
    ...
    <span>- Use a placeholder as replacement for a <StorybookLink kind={ ODS_COMPONENTS_TITLE.formField } story={ STORY.documentation }>Form Field</StorybookLink> label</span>,
  ]}
  dos={[
    '- Use Textarea for a text longer than a single line',
    <span>- Use a <StorybookLink kind={ ODS_COMPONENTS_TITLE.formField } story={ STORY.documentation }>Form Field</StorybookLink> label (and/or an helper) to clearly inform what information the user should type</span>,
  ]}
/>
