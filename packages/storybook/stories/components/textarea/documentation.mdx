...
<BestPractices
  donts={[
    ...
    <span>- Use a placeholder as replacement for a <StorybookLink kind="ODS Components/Form elements/Form Field" label="Form Field" story="Documentation" /> label</span>,
  ]}
  dos={[
    '- Use Textarea for a text longer than a single line',
    <span>- Use a <StorybookLink kind="ODS Components/Form elements/Form Field" label="Form Field" story="Documentation" /> label (and/or an helper) to clearly inform what information the user should type</span>,
  ]}
/>
