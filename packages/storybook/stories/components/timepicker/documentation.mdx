...
For some use case, an optional time zone <StorybookLink kind={ REACT_COMPONENTS_TITLE.select } story={ STORY.documentation }>Select</StorybookLink> can be added to allow users to select their desired time zone from a list of options.
...
<BestPractices
  ...
  dos={[
    ...
    <span>- Add label and/or helper to the Timepicker with <StorybookLink kind={ REACT_COMPONENTS_TITLE.formField } story={ STORY.documentation }>Form Field</StorybookLink> component</span>,
