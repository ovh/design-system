...
For some use case, an optional time zone <StorybookLink kind={ ODS_COMPONENTS_TITLE.select } label="Select" story={ STORY.documentation } /> can be added to allow users to select their desired time zone from a list of options.
...
<BestPractices
  ...
  dos={[
    ...
    <span>- Add label and/or helper to the Timepicker with <StorybookLink kind={ ODS_COMPONENTS_TITLE.formField } label="Form Field" story={ STORY.documentation } /> component</span>,
...
It has the same states and behaviors for each inner component (i.e. <StorybookLink kind={ ODS_COMPONENTS_TITLE.input } label="Input" story={ STORY.documentation } /> and <StorybookLink kind={ ODS_COMPONENTS_TITLE.select } label="Select" story={ STORY.documentation } />).
