...
<Meta of={ TimepickerStories } name="Migration v17 to v18" />
...
To learn how to use this component, please check the <StorybookLink kind={ REACT_COMPONENTS_TITLE.timepicker } story={ STORY.documentation }>documentation</StorybookLink>.
