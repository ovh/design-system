...
For further explanation about timezone strategy, see <StorybookLink kind={ ODS_COMPONENTS_TITLE.timepicker } story={ STORY.documentation }>the timezone behavior documentation</StorybookLink>.
