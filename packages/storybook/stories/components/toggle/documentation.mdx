...
A **Toggle** should never require users to press a <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" /> to apply their settings (if a setting requires a <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" />, use a <StorybookLink kind="ODS Components/Form elements/Checkbox" label="Checkbox" story="Documentation" /> instead).

<Heading label="Dos & Don'ts" level={ 3 } />

<BestPractices
  donts={[
    <span>- Use a Toggle when you are not expecting an immediate effect by clicking on it: use a <StorybookLink kind="ODS Components/Form elements/Checkbox" label="Checkbox" story="Documentation" /> component instead</span>,
  ]}
  dos={[
