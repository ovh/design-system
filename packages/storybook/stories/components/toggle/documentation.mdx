...
<BestPractices
  donts={[
    ...
    '- Don’t use Toggles for multi-state or complex options since they are meant for binary (on/off) interactions only',
  ]}
  dos={[
    ...
    '- Use Toggles in mobile-friendly settings where quick, touch-based interactions are expected',
