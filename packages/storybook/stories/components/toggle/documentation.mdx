...
A **Toggle** should never require users to press a <StorybookLink kind={ REACT_COMPONENTS_TITLE.button } story={ STORY.documentation }>Button</StorybookLink> to apply their settings (if a setting requires a <StorybookLink kind={ REACT_COMPONENTS_TITLE.button } story={ STORY.documentation }>Button</StorybookLink>, use a <StorybookLink kind={ REACT_COMPONENTS_TITLE.checkbox } story={ STORY.documentation }>Checkbox</StorybookLink> instead).

<Heading label="Dos & Don'ts" level={ 3 } />

<BestPractices
  donts={[
    <span>- Use a Toggle when you are not expecting an immediate effect by clicking on it: use a <StorybookLink kind={ REACT_COMPONENTS_TITLE.checkbox } story={ STORY.documentation }>Checkbox</StorybookLink> component instead</span>,
  ]}
  dos={[
