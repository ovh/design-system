...
_**Tooltip** component is used to display contextual information when the user hovers over or focus on a UI element in a page._
...
<div>
  <div id='description'>
    The **Tooltip** component is used to display brief, contextual information when users hover over or focus on an
    element.

    It enhances user experience by providing helpful hints, explanations, or descriptions without cluttering the UI.

    **Tooltips** are commonly used for [**Button**](?path=/docs/ods-components-actions-button--documentation),
    [**Icon**](?path=/docs/ods-components-content-icon--documentation), [**Form
    Field**](?path=/docs/ods-components-form-form-field--documentation), and other interactive elements.
  </div>
  <table>
    <tbody>
    <tr>
    ...
    <tr>
      ...
      <td>
        ...
        <a href='https://github.com/ovh/design-system/tree/master/packages/components/src/tooltip'>Github<OdsIcon
          name={ ODS_ICON_NAME.externalLink }
          style={ { fontSize: '.7rem', paddingLeft: '.3rem', paddingRight: '.2rem' } }></OdsIcon></a>
      </td>
    </tr>
...
They are suitable for [**Button**](?path=/docs/ods-components-actions-button--documentation), [**Icon**](?path=/docs/ods-components-content-icon--documentation), [**Form Field**](?path=/docs/ods-components-form-form-field--documentation), [**Link**](?path=/docs/ods-components-actions-link--documentation), and any other elements where additional context would be beneficial.
...
| - Write **Tooltip**'s [**Text**](?path=/docs/ods-components-content-tag--documentation) as full sentences with punctuation except there is not enough space.                   |
` }
</Markdown>
<Markdown>
  { `
...
| - Use interactive elements within a **Tooltip** such as [**Button**](?path=/docs/ods-components-actions-button--documentation) or [**Link**](?path=/docs/ods-components-actions-link--documentation). |
...
It triggers when the user hovers over or focus on the **Tooltip'**s trigger element such as an [**Icon**](?path=/docs/ods-components-content-icon--documentation).
...
On a mobile device, a **Tooltip** is displayed upon tapping, and it will hide when the user taps an area outside the **Tooltip**'s container.
