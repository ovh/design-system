...
<IdentityCard aliases={ ['Info Bubble'] }
  ...
  **Tooltips** are commonly used for <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" />,
  <StorybookLink kind="ODS Components/Icon" label="Icon" story="Documentation" />,
  <StorybookLink kind="ODS Components/Form elements/Form Field" label="Form Field" story="Documentation" />, and other interactive elements.
</IdentityCard>
...
They are suitable for <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" />, <StorybookLink kind="ODS Components/Icon" label="Icon" story="Documentation" />, <StorybookLink kind="ODS Components/Form elements/Form Field" label="Form Field" story="Documentation" />, <StorybookLink kind="ODS Components/Link" label="Link" story="Documentation" />, and any other elements where additional context would be beneficial.
...
<BestPractices
  donts={[
    ...
    <span>- Use interactive elements within a Tooltip such as <StorybookLink kind="ODS Components/Button" label="Button" story="Documentation" /> or <StorybookLink kind="ODS Components/Link" label="Link" story="Documentation" /></span>,
  ...
  dos={[
    ...
    <span>- Write Tooltip's <StorybookLink kind="ODS Components/Text" label="Text" story="Documentation" /> as full sentences with punctuation except there is not enough space</span>,
  ]}
/>
...
It triggers when the user hovers or focuses on the **Tooltip**'s trigger element such as an <StorybookLink kind="ODS Components/Icon" label="Icon" story="Documentation" />.
