...
`position` <ods-badge size="sm" color="success" icon="star" label="New"></ods-badge>
...
`shadowDomTriggerId` <ods-badge size="sm" color="success" icon="star" label="New"></ods-badge>
...
`triggerId` <ods-badge size="sm" color="success" icon="star" label="New"></ods-badge>

New attribute (required).

Id of the HTML element that serves as the tooltip trigger.

`variant` <ods-badge size="sm" color="critical" icon="circle-xmark" label="Removed"></ods-badge>

Has been removed.

You can use the new `with-arrow` attribute to render either the standard or tip previous variant.

`with-arrow` <ods-badge size="sm" color="success" icon="star" label="New"></ods-badge>
