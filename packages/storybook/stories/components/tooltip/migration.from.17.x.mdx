...
<Meta of={ TooltipStories } name="Migration v17 to v18" />
...
`position` <Badge color="success" size="sm">New</Badge>
...
`shadowDomTriggerId` <Badge color="success" size="sm">New</Badge>
