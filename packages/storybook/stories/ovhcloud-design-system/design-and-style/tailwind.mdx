...
<Meta title="OVHcloud Design System/Design and Style/Tailwind CSS Integration" />
...
Technically, you don't need any configuration to make ODS work with Tailwind. These guides are here to add some auto-completion and best practices for Tailwind, but you can directly use the design tokens right out of the box without any additional configuration.

<Heading label="Overview" level={ 2 } />

Tailwind CSS provides utility classes that can be used alongside ODS components to create custom layouts and styling. The OVHcloud Design System provides CSS custom properties (variables) that can be mapped to Tailwind's configuration, ensuring consistency across your application.
...
<Heading label="Combining ODS Components with Tailwind" level={ 3 } />
...
function MyComponent() {
  return (
  <div>
      <p className="font-ods-default">Click on the button!</p>
...
- <ExternalLink href="https://www.figma.com/design/tIKzHa5KvHHyosgIgyBswB/Design-Tokens?m=auto&node-id=0-1&t=s57Qt3pa7WuFWKEh-1">ODS Design Tokens (Figma)</ExternalLink>
