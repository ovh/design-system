...
For detailed instructions on importing ESModule or CommonJS packages, please refer to our <StorybookLink label="Get Started" title="OVHcloud Design System/Get Started" /> documentation.

<Heading label="How can I import ODS CSS-only styling?" level={ 2 } />

To import ODS CSS-only styling, please refer to our <StorybookLink label="Get Started" title="OVHcloud Design System/Get Started" /> documentation.
