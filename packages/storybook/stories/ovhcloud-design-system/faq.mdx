import { Code, MESSAGE_COLOR, Message, MessageBody, MessageIcon } from '@ovhcloud/ods-react';
...
<Meta title="OVHcloud Design System/Resources/F.A.Q." />
...
<Message color={ MESSAGE_COLOR.warning } dismissible={ false } style={{ width: '100%' }}>
  ...
  <MessageBody>
    Web Components and Vue support are deprecated since v19 and in maintenance mode only.
  </MessageBody>
</Message>
...
Ensure you did import the fonts in your application, check the <StorybookLink title={ HOME_TITLE.startHere }>get started</StorybookLink>
