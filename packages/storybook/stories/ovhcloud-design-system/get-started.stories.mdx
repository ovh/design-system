...
If you prefer to use each components directly, you can use import them separately.
...
```typescript
import { OsdsButtton, OsdsText } from '@ovhcloud/ods-components/react';
...
To use a React version of an ODS component, you need to import it from the `vue` sub directory.
...
import { OsdsButtton, OsdsText } from '@ovhcloud/ods-components/vue';
