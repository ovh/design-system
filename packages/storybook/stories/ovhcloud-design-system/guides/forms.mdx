...
<Meta title="OVHcloud Design System/Build/Forms" />

<Heading label="Forms" level={ 1 } />

<Heading label="Usage Guidelines" level={ 2 } />
...
<Heading label="Mandatory and optional fields" level={ 3 } />

<Heading label="How to define mandatory fields" level={ 4 } />
...
<Heading label="Optional fields" level={ 4 } />
...
<Heading label="Submit behavior" level={ 3 } />
...
<Heading label="Standard submit flow" level={ 4 } />
...
<Heading label="Relationship with inline validation" level={ 4 } />
...
<Heading label="Loading & action buttons states" level={ 4 } />
...
<Heading label="Error handling" level={ 3 } />
...
<Heading label="Local errors (field-level)" level={ 4 } />
...
<Heading label="When field-level errors are triggered" level={ 5 } />
...
<Heading label="Examples of field-level errors" level={ 5 } />

- Required field left empty.
- Invalid email format.
- Password does not meet requirements.

<Heading label="Global errors (form-level)" level={ 4 } />
...
<Heading label="Types of Global Errors" level={ 5 } />

<Heading label="Recoverable Failure" level={ 6 } />
...
<Heading label="Critical / Blocking Failure" level={ 6 } />
...
<Heading label="Confirmation page / modal" level={ 4 } />
...
<Heading label="Component selection guidelines" level={ 3 } />
...
<Heading label="When the user needs to provide short, structured information" level={ 4 } />
...
<Heading label="When the user needs to explain, justify, or describe something" level={ 4 } />
...
<Heading label="When the user must create or confirm secure credentials" level={ 4 } />
...
<Heading label="When the user must enter an exact numeric value" level={ 4 } />
...
<Heading label="When the user is selecting an approximate value or a range" level={ 4 } />
...
<Heading label="When users must choose one option and all options should be visible" level={ 4 } />
...
<Heading label="When users must choose one option from a list" level={ 4 } />

<Heading label="Select vs Combobox" level={ 5 } />
...
<Heading label="Use Select" level={ 5 } />
...
<Heading label="Use Combobox" level={ 5 } />
...
<Heading label="When users can select multiple independent options" level={ 4 } />
...
<Heading label="When the user is enabling or disabling a setting" level={ 4 } />
...
<Heading label="When the user must select a specific date" level={ 4 } />
...
<Heading label="When the user must provide supporting material" level={ 4 } />
...
<Heading label="Implementing a Form" level={ 2 } />
...
<Heading label="Uncontrolled Form" level={ 3 } />
...
<Heading label="Controlled Form" level={ 3 } />
...
<Heading label="Using form library" level={ 3 } />

We'll demonstrate here a few form libraries, but you can plug ODS form elements with any library you like.
...
<Heading label="react-hook-form" level={ 4 } />
