...
<Meta title="OVHcloud Design System/Upgrade/Previous Migrations/16.x to 17.x" />
...
You can see more details in the updated <StorybookLink title={ HOME_TITLE.getStarted }>Get Started documentation</StorybookLink>
