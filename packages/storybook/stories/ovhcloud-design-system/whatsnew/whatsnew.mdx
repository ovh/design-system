...
This version aims to moves the library to a full React solution.

More info will be added on future alpha releases.

ODS v19 supports React v18 and v19.
...
We did integrate <OdsLink href="https://testing-library.com/docs/react-testing-library/intro" target="_blank">react-testing-library</OdsLink>
...
This version is focused on implementing <OdsLink href="https://developer.mozilla.org/en-US/docs/Web/API/ValidityState" target="_blank">ValidityState</OdsLink> to our form elements.
...
Though you can of course use a lib on top of that if you want to. We've validated forms using native code (vanilla and React), <OdsLink href="https://formik.org" target="_blank">Formik</OdsLink> and <OdsLink href="https://react-hook-form.com" target="_blank">React Hook Form</OdsLink> on our tests and playgrounds.
...
of the web-component shadow DOM, thanks to the <OdsLink href="https://developer.mozilla.org/en-US/docs/Web/CSS/::part" target="_blank">part selector</OdsLink>.
