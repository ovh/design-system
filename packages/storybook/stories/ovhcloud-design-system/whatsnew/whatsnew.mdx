...
import { HOME_TITLE, ODS_COMPONENTS_TITLE, STORY } from '../../../src/constants/meta';

<Meta title="OVHcloud Design System/What's new?/What's new" />

<Heading label="What's new ?" level={ 1 } />

<Heading label="v19.0.0-alpha.2" level={ 2 } />
...
- Remove `Ods` prefix on all component and constant names.
- Isolate component style in its own layer.
- Add a NextJS example application.
- Add a react-router example application.
- Improve documentation.

<Heading label="Bug fixes:" level={ 3 } />

- Fix webpack tree-shaking.
- Miscellaneous fixes from feedbacks.

<Heading label="v19.0.0-alpha.1" level={ 2 } />
...
- New preset `label` added to OdsText.

<Heading label="Bug fixes:" level={ 3 } />

- Compatibility with React 19.
- Popover/Tooltip className override

<Heading label="v19.0.0-alpha.0" level={ 2 } />

This version aims to start the migration to a full React solution library.
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.combobox } story={ STORY.documentation }>See Documentation</StorybookLink>
...
**Icon**
- `alt` attribute has been removed. This optional attribute was in fact doing nothing at all, it can safely be kept if you were using it, but you should remove it and follow the <StorybookLink kind={ ODS_COMPONENTS_TITLE.icon } story={ STORY.documentation }>accessibility best practices</StorybookLink> instead.
...
- Update the accessibility section of the <StorybookLink kind={ ODS_COMPONENTS_TITLE.icon } story={ STORY.documentation }>Icon</StorybookLink> component, with best practices and examples.
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.drawer } story={ STORY.documentation }>See Documentation</StorybookLink>
...
**Input**
- You can now link a native `datalist` to an `ods-input` using the `list` attribute and the `list` slot. A full example is available in the <StorybookLink kind={ ODS_COMPONENTS_TITLE.input } story={ STORY.technicalInformation }>Technical information</StorybookLink> page.
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.fileUpload } story={ STORY.documentation }>See Documentation</StorybookLink>

**Timepicker**

<StorybookLink kind={ ODS_COMPONENTS_TITLE.timepicker } story={ STORY.documentation }>See Documentation</StorybookLink>
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.table } story={ STORY.documentation }>See Documentation</StorybookLink>
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.medium } story={ STORY.documentation }>See Documentation</StorybookLink>
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.datepicker } story={ STORY.documentation }>See Documentation</StorybookLink>
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.phoneNumber } story={ STORY.documentation }>See Documentation</StorybookLink>
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.clipboard } story={ STORY.documentation }>See Documentation</StorybookLink>
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.modal } story={ STORY.documentation }>See Documentation</StorybookLink>
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.formField } story={ STORY.documentation }>See Documentation</StorybookLink>

**Switch**

<StorybookLink kind={ ODS_COMPONENTS_TITLE.switch } story={ STORY.documentation }>See Documentation</StorybookLink>
...
> For more information, check our documentation <StorybookLink kind={ ODS_COMPONENTS_TITLE.pagination } story={ STORY.documentation }>See Documentation</StorybookLink>
...
* **Progress Bar**: <StorybookLink kind={ ODS_COMPONENTS_TITLE.progressBar } story={ STORY.documentation }>See Documentation</StorybookLink>
* **Popover**: <StorybookLink kind={ ODS_COMPONENTS_TITLE.popover } story={ STORY.documentation }>See Documentation</StorybookLink>
* **Tooltip**: <StorybookLink kind={ ODS_COMPONENTS_TITLE.tooltip } story={ STORY.documentation }>See Documentation</StorybookLink>

Components version 2:

* **Input V2**: <StorybookLink kind={ ODS_COMPONENTS_TITLE.input } story={ STORY.documentation }>See Documentation</StorybookLink>
...
* **Select V2**: it is now connected to our CDK and keyboard navigation has been added <StorybookLink kind={ ODS_COMPONENTS_TITLE.select } story={ STORY.documentation }>See Documentation</StorybookLink>

**Quantity** component accepts four digits in the input field:

<StorybookLink kind={ ODS_COMPONENTS_TITLE.quantity } story={ STORY.documentation }>See Documentation</StorybookLink>
...
* Breadcrumb: <StorybookLink kind={ ODS_COMPONENTS_TITLE.breadcrumb } story={ STORY.documentation }>See Documentation</StorybookLink>
* Collapsible: See Documentation using version selector
* Pagination: <StorybookLink kind={ ODS_COMPONENTS_TITLE.pagination } story={ STORY.documentation }>See Documentation</StorybookLink>
* Spinner: <StorybookLink kind={ ODS_COMPONENTS_TITLE.spinner } story={ STORY.documentation }>See Documentation</StorybookLink>
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.tabs } story={ STORY.documentation }>See Documentation</StorybookLink>
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.select } story={ STORY.documentation }>See Documentation</StorybookLink>
