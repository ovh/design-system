...
Although, we tried to stay as close as possible to previous version behaviour, the way you integrate ODS in your React app should be rethought,
...
**Accordion**
- Update internal logic to use the native behaviour of `details` / `summary` tags.
...
- Consistent behaviour regarding blur and error state.
