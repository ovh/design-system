...
We did integrate <Link href="https://testing-library.com/docs/react-testing-library/intro" target="_blank">react-testing-library</Link>
...
This version is focused on implementing <Link href="https://developer.mozilla.org/en-US/docs/Web/API/ValidityState" target="_blank">ValidityState</Link> to our form elements.
...
Though you can of course use a lib on top of that if you want to. We've validated forms using native code (vanilla and React), <Link href="https://formik.org" target="_blank">Formik</Link> and <Link href="https://react-hook-form.com" target="_blank">React Hook Form</Link> on our tests and playgrounds.
...
of the web-component shadow DOM, thanks to the <Link href="https://developer.mozilla.org/en-US/docs/Web/CSS/::part" target="_blank">part selector</Link>.
