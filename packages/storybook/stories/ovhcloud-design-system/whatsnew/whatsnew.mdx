...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.combobox } label="See Documentation" story={ STORY.documentation } />
...
**Icon**
- `alt` attribute has been removed. This optional attribute was in fact doing nothing at all, it can safely be kept if you were using it, but you should remove it and follow the <StorybookLink kind={ ODS_COMPONENTS_TITLE.icon } label="accessibility best practices" story={ STORY.documentation } /> instead.
...
- Update the accessibility section of the <StorybookLink kind={ ODS_COMPONENTS_TITLE.icon } label="Icon" story={ STORY.documentation } /> component, with best practices and examples.
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.drawer } label="See Documentation" story={ STORY.documentation } />
...
We did integrate <OdsLink href="https://testing-library.com/docs/react-testing-library/intro" label="react-testing-library" target="_blank" />
...
This version is focused on implementing <OdsLink href="https://developer.mozilla.org/en-US/docs/Web/API/ValidityState" label="ValidityState" target="_blank" /> to our form elements.
...
Though you can of course use a lib on top of that if you want to. We've validated forms using native code (vanilla and React), <OdsLink href="https://formik.org" label="Formik" target="_blank" /> and <OdsLink href="https://react-hook-form.com" label="React Hook Form" target="_blank" /> on our tests and playgrounds.
...
**Input**
- You can now link a native `datalist` to an `ods-input` using the `list` attribute and the `list` slot. A full example is available in the <StorybookLink kind={ ODS_COMPONENTS_TITLE.input } label="Technical information" story={ STORY.technicalInformation } /> page.
...
As it is a major version, you'll have to follow the <StorybookLink label="migration guide 17.x to 18.x" title={ HOME_TITLE.migration17to18 } />
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.fileUpload } label="See Documentation" story={ STORY.documentation } />

**Timepicker**

<StorybookLink kind={ ODS_COMPONENTS_TITLE.timepicker } label="See Documentation" story={ STORY.documentation } />

<Heading label="Component changes:" level={ 3 } />

Please check the <StorybookLink label="migration guide" title={ HOME_TITLE.migration17to18 } /> regarding all the component changes.
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.table } label="See Documentation" story={ STORY.documentation } />
...
As it is a major version, you'll have to follow the <StorybookLink label="migration guide 16.x to 17.x" title={ HOME_TITLE.migration16to17 } />
...
* the updated <StorybookLink label="Get Started documentation" title={ HOME_TITLE.getStarted } />
* the 16.x to 17.x <StorybookLink label="Migration guide" title={ HOME_TITLE.migration16to17 } />
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.medium } label="See Documentation" story={ STORY.documentation } />
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.datepicker } label="See Documentation" story={ STORY.documentation } />
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.phoneNumber } label="See Documentation" story={ STORY.documentation } />
...
As it is a major version, you'll have to follow the <StorybookLink label="migration guide 15.x to 16.x" title={ HOME_TITLE.migration15to16 } />
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.clipboard } label="See Documentation" story={ STORY.documentation } />
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.modal } label="See Documentation" story={ STORY.documentation } />
...
As it is a major version, you have to do the <StorybookLink label="migration guide 14.x to 15.x" title={ HOME_TITLE.migration14to15 } />
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.formField } label="See Documentation" story={ STORY.documentation } />

**Switch**

<StorybookLink kind={ ODS_COMPONENTS_TITLE.switch } label="See Documentation" story={ STORY.documentation } />
...
> For more information, check our documentation <StorybookLink kind={ ODS_COMPONENTS_TITLE.pagination } label="See Documentation" story={ STORY.documentation } />
...
As it is a major version, you have to do the <StorybookLink label="migration guide 13.x to 14.x" title={ HOME_TITLE.migration13to14 } />

<Heading label="New features:" level={ 3 } />

We added the following components:

* **Progress Bar**: <StorybookLink kind={ ODS_COMPONENTS_TITLE.progressBar } label="See Documentation" story={ STORY.documentation } />
* **Popover**: <StorybookLink kind={ ODS_COMPONENTS_TITLE.popover } label="See Documentation" story={ STORY.documentation } />
* **Tooltip**: <StorybookLink kind={ ODS_COMPONENTS_TITLE.tooltip } label="See Documentation" story={ STORY.documentation } />

Components version 2:

* **Input V2**: <StorybookLink kind={ ODS_COMPONENTS_TITLE.input } label="See Documentation" story={ STORY.documentation } />
...
* **Select V2**: it is now connected to our CDK and keyboard navigation has been added <StorybookLink kind={ ODS_COMPONENTS_TITLE.select } label="See Documentation" story={ STORY.documentation } />

**Quantity** component accepts four digits in the input field:

<StorybookLink kind={ ODS_COMPONENTS_TITLE.quantity } label="See Documentation" story={ STORY.documentation } />
...
As it is a major version, you have to do the <StorybookLink label="migration guide 12.x to 13.x" title={ HOME_TITLE.migration12to13 } />

<Heading label="New features:" level={ 3 } />

We added the following components:

* Breadcrumb: <StorybookLink kind={ ODS_COMPONENTS_TITLE.breadcrumb } label="See Documentation" story={ STORY.documentation } />
* Collapsible: See Documentation using version selector
* Pagination: <StorybookLink kind={ ODS_COMPONENTS_TITLE.pagination } label="See Documentation" story={ STORY.documentation } />
* Spinner: <StorybookLink kind={ ODS_COMPONENTS_TITLE.spinner } label="See Documentation" story={ STORY.documentation } />
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.tabs } label="See Documentation" story={ STORY.documentation } />
...
For more details about assets, see <StorybookLink label="Installation" title={ HOME_TITLE.getStarted } /> page.
...
<StorybookLink kind={ ODS_COMPONENTS_TITLE.select } label="See Documentation" story={ STORY.documentation } />
...
You can read the updated <StorybookLink label="Getting Started" title={ HOME_TITLE.getStarted } />
