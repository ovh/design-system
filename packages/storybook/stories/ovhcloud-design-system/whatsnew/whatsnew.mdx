...
As it is a major version, you'll have to follow the [migration guide 17.x to 18.x](?path=/docs/ovhcloud-design-system-what-s-new-migration-guide-17-x-to-18-x--docs)
...
**File Upload**
[See Documentation](?path=/docs/ods-components-form-elements-file-upload--documentation)

**Timepicker**
[See Documentation](?path=/docs/ods-components-form-elements-timepicker--documentation)

### Component changes:

Please check the [migration guide](?path=/docs/ovhcloud-design-system-what-s-new-migration-guide-17-x-to-18-x--docs) regarding all the component changes.
