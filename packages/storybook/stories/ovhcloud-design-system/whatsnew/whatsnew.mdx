...
<Meta title="OVHcloud Design System/Upgrade/What's new" />

<Heading label="What's new ?" level={ 1 } />


<Heading label="v19.7.3" level={ 2 } />

<Heading label="Bug fixes:" level={ 3 } />

**Datatable**
- Fix z-index conflicts with sticky header and pinned columns.

**Combobox**
- Allow controlled combobox to be cleared programmatically


<Heading label="v19.7.2" level={ 2 } />

<Heading label="Tooling:" level={ 3 } />

- Package manager migrated from Yarn to **pnpm**.
- CI pipeline optimized.


<Heading label="v19.7.1" level={ 2 } />

<Heading label="Bug fixes:" level={ 3 } />

**PromptInput**
- Browser feature detection no longer throws in jsdom or Node.js environments.



<Heading label="v19.7.0" level={ 2 } />
...
<StorybookLink kind={ REACT_COMPONENTS_TITLE.markdown } story={ STORY.documentation }>See Documentation</StorybookLink>.

**MessageBubble**

<StorybookLink kind={ REACT_COMPONENTS_TITLE.messageBubble } story={ STORY.documentation }>See Documentation</StorybookLink>.

**PromptInput**

<StorybookLink kind={ REACT_COMPONENTS_TITLE.promptInput } story={ STORY.documentation }>See Documentation</StorybookLink>.

**QueryFilter**

<StorybookLink kind={ REACT_COMPONENTS_TITLE.queryFilter } story={ STORY.documentation }>See Documentation</StorybookLink>.
