...
To check how to start with this new version, please follow the <StorybookLink title={ HOME_TITLE.startHere }>Get Started</StorybookLink> documentation.
...
As it is a major version, you'll have to follow the <StorybookLink title={ HOME_TITLE.previousMigrations }>migration guide 17.x to 18.x</StorybookLink>
...
Please check the <StorybookLink title={ HOME_TITLE.previousMigrations }>migration guide</StorybookLink> regarding all the component changes.
...
As it is a major version, you'll have to follow the <StorybookLink title={ HOME_TITLE.previousMigrations }>migration guide 16.x to 17.x</StorybookLink>
...
* the updated <StorybookLink title={ HOME_TITLE.startHere }>Get Started documentation</StorybookLink>
* the 16.x to 17.x <StorybookLink title={ HOME_TITLE.previousMigrations }>Migration guide</StorybookLink>
...
As it is a major version, you'll have to follow the <StorybookLink title={ HOME_TITLE.previousMigrations }>migration guide 15.x to 16.x</StorybookLink>
...
As it is a major version, you have to do the <StorybookLink title={ HOME_TITLE.previousMigrations }>migration guide 14.x to 15.x</StorybookLink>
...
As it is a major version, you have to do the <StorybookLink title={ HOME_TITLE.previousMigrations }>migration guide 13.x to 14.x</StorybookLink>
...
As it is a major version, you have to do the <StorybookLink title={ HOME_TITLE.previousMigrations }>migration guide 12.x to 13.x</StorybookLink>
...
For more details about assets, see <StorybookLink title={ HOME_TITLE.startHere }>Installation</StorybookLink> page.
...
You can read the updated <StorybookLink title={ HOME_TITLE.startHere }>Getting Started</StorybookLink>
