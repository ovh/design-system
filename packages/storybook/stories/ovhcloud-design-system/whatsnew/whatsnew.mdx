...
import { HOME_TITLE, REACT_COMPONENTS_TITLE, RECIPES_TITLE, STORY } from '../../../src/constants/meta';

<Meta title="OVHcloud Design System/What's new?/What's new" />

<Heading label="What's new ?" level={ 1 } />

<Heading label="v19.7.0-alpha.0" level={ 2 } />

<Message color={ MESSAGE_COLOR.information } dismissible={ false } style={{ width: '100%' }}>
...
This release includes two new features that we want to share beforehand so that we can ensure
the final released version will match your expectation and will not cause any unexpected issues:
- The new component `DataTable`.
- New way to import components.

<h4 style={{ margin: 0 }}>
The new component `DataTable`.
</h4>

In this first iteration, we've tried to provide an easy-to-use component with the minimal expected features.

This component does differ from the actual `DataGrid` that you may use in your app today, as it is only focused on the table itself.

To see how you can use it in a more complex use-case, we've also added a new recipe `DataGrid` that demonstrates composition of multiple
ODS components around the table.

Please share your feedbacks about:
- the primary features that may be missing.
- the painpoints you've encournted while using the component.
...
We did test on a bunch of different bundler configuration to ensure that the tree-shaking is still working as expected and that existing
configuration will not be impacted.

We would like to ensure you don't encounter any bundle issue with this new exports.
...
<StorybookLink kind={ REACT_COMPONENTS_TITLE.avatar } story={ STORY.documentation }>See Documentation</StorybookLink>.

**DataTable**

<StorybookLink kind={ REACT_COMPONENTS_TITLE.dataTable } story={ STORY.documentation }>See Documentation</StorybookLink>.

**FileThumbnail**

<StorybookLink kind={ REACT_COMPONENTS_TITLE.fileThumbnail } story={ STORY.documentation }>See Documentation</StorybookLink>.

<Heading label="New recipes:" level={ 3 } />

**DataGrid**

<StorybookLink title={ RECIPES_TITLE.components }>See Recipes</StorybookLink>.

<Heading label="Design updates:" level={ 3 } />

**Breadcrumb**
- Now uses the ODS vertical Divider, which involve a color change.

<Heading label="Feature updates:" level={ 3 } />

**Divider**
- New attribute `orientation` has been added.

<Heading label="Bug fixes:" level={ 3 } />

**Meter**
- Hides gauge overflow on very small values.

**Table**
- Changed `border-collapse` to `separate` to fix rendering when using sticky header

<Heading label="Documentation improvements:" level={ 3 } />

- Update theme, version selector and recipes from using Popover to Menu.

<Heading label="v19.6.1" level={ 2 } />
...
<Heading label="v19.6.0" level={ 2 } />

<Heading label="New components:" level={ 3 } />

**Cart**

<StorybookLink kind={ REACT_COMPONENTS_TITLE.cart } story={ STORY.documentation }>See Documentation</StorybookLink>.

**Menu**

<StorybookLink kind={ REACT_COMPONENTS_TITLE.menu } story={ STORY.documentation }>See Documentation</StorybookLink>.
...
<Heading label="v19.5.0" level={ 2 } />

<Heading label="New components:" level={ 3 } />

**Editable**

<StorybookLink kind={ REACT_COMPONENTS_TITLE.editable } story={ STORY.documentation }>See Documentation</StorybookLink>.

**Logo**

<StorybookLink kind={ REACT_COMPONENTS_TITLE.logo } story={ STORY.documentation }>See Documentation</StorybookLink>.

**Tile**

<StorybookLink kind={ REACT_COMPONENTS_TITLE.tile } story={ STORY.documentation }>See Documentation</StorybookLink>.
...
**Overlays z-index**
In previous version of ODS, `Drawer` and `Modal` z-indexes were set to a lesser value than other overlay elements (popover, select, ...).
...
Starting from this version, `Drawer` and `Modal` z-indexes are now greater than other overlay elements.
This may cause issue with your current usage of overlay elements inside `Modal`.

To use such element correctly, you'll have to set the `createPortal={ false }` on overlay elements inside `Modal`.
You can see some examples on the <StorybookLink kind={ REACT_COMPONENTS_TITLE.modal } story={ STORY.technicalInformation }>Modal Technical Page</StorybookLink>.
...
<Heading label="Recipe changes:" level={ 3 } />
...
A new page `Roadmap` has been added to the documentation.
...
Recipes are ready-to-use UI patterns built with ODS components.
...
We're still iterating on the whole recipe system to ensure it fits integrator needs.
...
<StorybookLink kind={ REACT_COMPONENTS_TITLE.buttonGroup } story={ STORY.documentation }>See Documentation</StorybookLink>.

**Kbd**

<StorybookLink kind={ REACT_COMPONENTS_TITLE.kbd } story={ STORY.documentation }>See Documentation</StorybookLink>.
...
<Heading label="v19.3.0" level={ 2 } />

<Heading label="New components:" level={ 3 } />

**Toaster**

<StorybookLink kind={ REACT_COMPONENTS_TITLE.toaster } story={ STORY.documentation }>See Documentation</StorybookLink>

<Heading label="Design updates:" level={ 3 } />

ODS theme design tokens have been reworked to be more semantic.
...
<StorybookLink kind={ REACT_COMPONENTS_TITLE.meter } story={ STORY.documentation }>See Documentation</StorybookLink>

**TreeView**

<StorybookLink kind={ REACT_COMPONENTS_TITLE.treeView } story={ STORY.documentation }>See Documentation</StorybookLink>

<Heading label="Font changes:" level={ 3 } />

Font files are now accessible as actual files instead of base64 conversion.
This will reduce the size of the ODS style bundle and allow browser resource loading parallelization.

Thanks to <ExternalLink href="https://github.com/ennoriel">Ennoriel</ExternalLink> for the contribution.
...
A new tool has been added to the documentation, the `Code sandbox`.
