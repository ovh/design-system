...
As it is a major version, you'll have to follow the [migration guide 16.x to 17.x](?path=/story/ovhcloud-design-system-what-s-new-migration-guide-16-x-to-17-x--page)
...
- the updated [Get Started documentation](?path=/story/ovhcloud-design-system-get-started--page#how-to-use-ods-components-in-my-project)
- the 16.x to 17.x [Migration guide](?path=/story/ovhcloud-design-system-what-s-new-migration-guide-16-x-to-17-x--page)
...
- [See React Documentation](/?path=/story/ods-components-layout-datagrid-organism-usage-react--page)
...
As it is a major version, you'll have to follow the [migration guide 15.x to 16.x](?path=/story/ovhcloud-design-system-what-s-new-migration-guide-15-x-to-16-x--page)
...
For more details about assets, see [Installation](?path=/story/ovhcloud-design-system-get-started--page) page.
...
[CDK Documentation](?path=/story/cdk-introduction--page)
