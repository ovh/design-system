...
<IdentityCard aliases={ ['Tile (previous name)', 'Content Container', 'Product Card'] }
  ...
  <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } label="Text" story={ STORY.documentation } />,
  <StorybookLink kind={ ODS_COMPONENTS_TITLE.medium } label="Medium" story={ STORY.documentation } /> and other UI components.
...
* display a wide variety of content such as a <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } label="Text" story={ STORY.documentation } />, a <StorybookLink kind={ ODS_COMPONENTS_TITLE.link } label="Link" story={ STORY.documentation } /> or other elements like a <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } label="Button" story={ STORY.documentation } />
...
* A title
* A description
* A <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } label="Button" story={ STORY.documentation } />
* A <StorybookLink kind={ ODS_COMPONENTS_TITLE.medium } label="Medium" story={ STORY.documentation } />
* Extra information
...
<BestPractices
  ...
  dos={[
    ...
    <span>- Use content in a Card, such as <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } label="Text" story={ STORY.documentation } />, <StorybookLink kind={ ODS_COMPONENTS_TITLE.medium } label="Medium" story={ STORY.documentation } /> and <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } label="Button" story={ STORY.documentation } />, that are contextually related</span>,
    <span>- Keep the number of <StorybookLink kind={ ODS_COMPONENTS_TITLE.button } label="Button" story={ STORY.documentation } /> per Card to a minimum</span>,
  ]}
/>
