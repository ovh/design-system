...
<IdentityCard aliases={ ['Progress', 'Progress Loader', 'Preloader', 'Loading Bar', 'Progress Indicator'] }
  ...
  <StorybookLink kind={ ODS_COMPONENTS_TITLE.fileUpload } label="File upload" story={ STORY.documentation } />, downloads, or form submissions.
</IdentityCard>
...
<BestPractices
  ...
  dos={[
    <span>- Use Progress Bar for quantifiable loading; if not, please use <StorybookLink kind={ ODS_COMPONENTS_TITLE.spinner } label="Spinner" story={ STORY.documentation } /> for complex content or <StorybookLink kind={ ODS_COMPONENTS_TITLE.skeleton } label="Skeleton" story={ STORY.documentation } /> for <StorybookLink kind={ ODS_COMPONENTS_TITLE.text } label="Text" story={ STORY.documentation } />-only content</span>,
  ]}
/>
